...
//
// ONE barrel rather than a page-by-page list in `app.ts`, for the reason the
// Data area barrel gives: several pages land at different times, and a per-page
...
// is entirely config, and a page added to the barrel below is served the moment
 ...
 * in this barrel for the barrel's own reason, that a per-page import list makes
