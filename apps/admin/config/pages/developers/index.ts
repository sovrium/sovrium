...
/**
 * The Developers section, as ONE barrel.
 *
 ...
 * and `app.ts` already names it — so this barrel carries the three that landed
 * together, for the reason the data barrel next door records: several
 ...
 * second reason the barrel earns its place: `app.ts` spreads it and never has to
