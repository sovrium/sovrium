...
export const dataDeletion: Record<string, string> = {
  ...
  'dataDeletion.s2.deleteIntro': 'Pour supprimer vos données associées à Facebook Login :',
  ...
  'dataDeletion.s2.step2.title': 'Étape 2 : Contacter l’administrateur de l’application',
  'dataDeletion.s2.step2.item1': '• Contactez l’organisation qui exploite l’application Sovrium',
  ...
  'dataDeletion.s4.item2': '• Nous vous enverrons une confirmation une fois vos données supprimées',
  ...
  'dataDeletion.s5.item2': '• Société : ESSENTIAL SERVICES, SAS au capital de 10 000 €',
