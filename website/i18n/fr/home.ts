...
export const home: Record<string, string> = {
  ...
  'home.hero.subtitle': 'Source-available. Auto-hébergé. Piloté par la configuration.',
  ...
  'home.hero.trust': 'Source-available · BSL 1.1 · Construit avec Bun, Effect.ts, Hono & React 19',
  ...
  'home.features.subtitle': 'Une plateforme complète, pas un énième framework à apprendre.',
  'home.features.data.icon': 'layers',
  'home.features.data.title': 'Couche données complète',
