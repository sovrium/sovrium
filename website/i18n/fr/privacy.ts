...
export const privacy: Record<string, string> = {
  ...
  'privacy.s2.selfHosted.item1': '• Collectons pas de données de vos installations Sovrium',
  'privacy.s2.selfHosted.item2': '• Stockons ni ne traitons les données de vos applications',
  ...
  'privacy.s3.item2': '• Comprendre quelles fonctionnalités intéressent les utilisateurs',
  ...
  'privacy.s4.p1': 'Notre site peut être lié à ou interagir avec des services tiers :',
  ...
  'privacy.s6.item1': '• Accéder à toute donnée personnelle que nous détenons à votre sujet',
