...
export const terms: Record<string, string> = {
  ...
  'terms.s2.prohibited.item2': '❌ Créer une offre SaaS concurrente basée sur Sovrium',
  ...
  'terms.s3.may1': '✓ Indiquer que votre application est « Powered by Sovrium »',
  'terms.s3.may2': '✓ Utiliser le nom Sovrium dans des déclarations factuelles sur le logiciel',
  ...
  'terms.s13.item3': '• Société : ESSENTIAL SERVICES, SAS au capital de 10 000 €',
