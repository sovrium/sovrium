...
export const about: Record<string, string> = {
  ...
  'about.hero.title': 'Software you can call your own',
  'about.hero.subtitle':
  ...
  // CTA
  'about.cta.title': 'Try Sovrium',
  'about.cta.description':
    'Sovrium is source-available and actively developed. Read the docs to get started, or explore the code on GitHub.',
  'about.cta.github': 'View on GitHub',
  'about.cta.docs': 'Read the Docs',
  'about.cta.docs.href': '/en/docs',
}
