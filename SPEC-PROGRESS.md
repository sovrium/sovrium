...
> Generated: 2025-12-27T13:04:28.773Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [███████████████░░░░░] 73% (1870/2570 tests) | 🟢 On Track  |
| **Daily Velocity**       | 28.23 specs/day                              | 🟢 Healthy   |
...
- **Maintain velocity** - Need 28 specs/day to hit ETA (current: 28.23)
- **700 tests remaining** - TDD automation running
...
| `API-AUTH-ORG-DYNAMIC-ROLE-DELETE-005`  | 2025-12-27 13:49 | `6a5ff6f` |
| `API-AUTH-MAGIC-LINK-SEND-005`          | 2025-12-27 13:49 | `175a9c0` |
...
<details>
<summary>View API specs (111 files, 229/929 passing)</summary>
...
#### 🚧 auth > admin > stop-impersonating > post (43%)
...
⏸️ **API-AUTH-ADMIN-STOP-IMPERSONATING-001** `@spec`
...
⏸️ **API-AUTH-ADMIN-STOP-IMPERSONATING-004** `@spec`
