...
> Generated: 2026-01-30T22:51:08.907Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 91% (2045/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 0.03 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2042-06-05 (~199 months)                     | 🟡 Needs Attention |
...
- **199 tests remaining** - TDD automation running
...
| ----------------------------- | ---------------- | --------- | ------ |
| `API-TABLES-RECORDS-LIST-010` | 2026-01-30 23:42 | `fc394a1` | 🤖 TDD |
...
<details>
<summary>View API specs (69 files, 418/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (58%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**15/26** passing | 11 fixme | 25 @spec | 1 @regression
