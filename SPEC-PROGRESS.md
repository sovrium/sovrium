...
> Generated: 2026-01-23T17:48:57.438Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1961/2252 tests) | 🟡 Needs Attention |
...
- **Maintain velocity** - Need 7 specs/day to hit ETA (current: 6.07)
- **291 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 334/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (56%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**10/18** passing | 8 fixme | 17 @spec | 1 @regression
