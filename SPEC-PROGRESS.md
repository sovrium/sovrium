...
> Generated: 2026-01-23T15:31:05.277Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1959/2252 tests) | 🟡 Needs Attention |
...
- **293 tests remaining** - TDD automation running
...
| Spec ID                                  | Date             | Commit    |
| ---------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-008`          | 2026-01-23 16:30 | `37b1351` |
...
<details>
<summary>View API specs (67 files, 332/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (44%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**8/18** passing | 10 fixme | 17 @spec | 1 @regression
