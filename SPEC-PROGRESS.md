...
> Generated: 2026-02-12T09:11:20.402Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 94% (2112/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.37 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 12.37)
- **137 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 235                   |
| 🤖 Fixed by TDD Pipeline | 155                   |
| 👤 Fixed Manually        | 80                    |
| Fixed Last 24h           | 17                    |
| Fixed Last 7d            | 25                    |
| Fixed Last 30d           | 235                   |
...
<details>
<summary>View API specs (67 files, 498/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > post (18%)
