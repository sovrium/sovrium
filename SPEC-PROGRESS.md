...
> Generated: 2026-01-23T17:03:42.020Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1960/2252 tests) | 🟡 Needs Attention |
...
- **292 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 333/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (50%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**9/18** passing | 9 fixme | 17 @spec | 1 @regression
