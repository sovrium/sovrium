...
> Generated: 2026-01-23T18:05:38.793Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1962/2252 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 6.1 specs/day                                | 🔴 Slow            |
...
- **Maintain velocity** - Need 7 specs/day to hit ETA (current: 6.1)
- **290 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 335/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (61%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**11/18** passing | 7 fixme | 17 @spec | 1 @regression
