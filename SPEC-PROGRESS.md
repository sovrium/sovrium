...
> Generated: 2026-02-01T10:06:35.125Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 92% (2067/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 4.5 specs/day                                | 🔴 Slow            |
...
- **Maintain velocity** - Need 5 specs/day to hit ETA (current: 4.5)
- **177 tests remaining** - TDD automation running
...
| Metric                   | Value                  |
| ------------------------ | ---------------------- |
| Tests Fixed (90 days)    | 1813                   |
| 🤖 Fixed by TDD Pipeline | 32                     |
| 👤 Fixed Manually        | 1781                   |
| Fixed Last 24h           | 20                     |
| Fixed Last 7d            | 79                     |
| Fixed Last 30d           | 135                    |
...
| -------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-RECORDS-UPSERT-003`  | 2026-02-01 10:05 | `bd7c116` | 👤 Manual |
| `API-TABLES-RECORDS-UPSERT-003`  | 2026-02-01 09:02 | `458c1fb` | 👤 Manual |
| `API-TABLES-RECORDS-UPSERT-003`  | 2026-02-01 08:49 | `08acd57` | 👤 Manual |
| `API-TABLES-RECORDS-UPSERT-003`  | 2026-02-01 08:25 | `6df2f3f` | 👤 Manual |
| `API-TABLES-RECORDS-UPSERT-003`  | 2026-02-01 08:23 | `f721f86` | 👤 Manual |
| `API-TABLES-RECORDS-UPSERT-003`  | 2026-02-01 07:50 | `b243a2d` | 👤 Manual |
| `API-TABLES-RECORDS-UPSERT-002`  | 2026-02-01 08:42 | `878cd19` | 👤 Manual |
| `API-TABLES-RECORDS-UPSERT-001`  | 2026-02-01 08:33 | `2b4a450` | 🤖 TDD    |
| `API-TABLES-TRASH-001`           | 2026-02-01 08:20 | `67c99a0` | 🤖 TDD    |
| `API-TABLES-RECORDS-UPDATE-001`  | 2026-02-01 05:11 | `a371c9c` | 🤖 TDD    |
| `API-TABLES-RECORDS-RESTORE-008` | 2026-02-01 04:32 | `a5c3cce` | 🤖 TDD    |
| `API-TABLES-RECORDS-RESTORE-007` | 2026-02-01 03:53 | `d6e69bf` | 👤 Manual |
| `API-TABLES-RECORDS-RESTORE-005` | 2026-02-01 03:38 | `4b03508` | 🤖 TDD    |
| `API-TABLES-RECORDS-RESTORE-001` | 2026-02-01 03:06 | `17855fd` | 🤖 TDD    |
| `API-TABLES-RECORDS-LIST-020`    | 2026-02-01 01:23 | `b916d0f` | 🤖 TDD    |
| `API-TABLES-RECORDS-LIST-019`    | 2026-01-31 23:59 | `6f9062e` | 🤖 TDD    |
| `API-TABLES-RECORDS-LIST-017`    | 2026-01-31 19:58 | `828fac0` | 🤖 TDD    |
| `API-TABLES-RECORDS-LIST-016`    | 2026-01-31 19:15 | `579847d` | 🤖 TDD    |
| `API-TABLES-RECORDS-LIST-015`    | 2026-01-31 16:09 | `d40cea1` | 🤖 TDD    |
| `API-TABLES-RECORDS-LIST-014`    | 2026-01-31 11:07 | `4cbba0a` | 🤖 TDD    |
...
🟡 **69 files** | **617 tests** | [██████████████░░░░░░] 71% | In Progress

<details>
<summary>View API specs (69 files, 440/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > upsert > post (29%)
...
#### 🚧 tables > {tableId} > records > {recordId} > patch (19%)

📁 `api/tables/{tableId}/records/{recordId}/patch.spec.ts`

**Update record**

**3/16** passing | 13 fixme | 15 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > {recordId} > restore > post (89%)
