...
> Generated: 2026-01-31T19:07:17.317Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 91% (2049/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 0.03 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2042-02-06 (~195 months)                     | 🟡 Needs Attention |
...
- **195 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (69 files, 422/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (73%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**19/26** passing | 7 fixme | 25 @spec | 1 @regression
