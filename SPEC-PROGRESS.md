...
> Generated: 2026-02-02T10:12:18.453Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 93% (2088/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 5.2 specs/day                                | 🔴 Slow            |
...
- **Maintain velocity** - Need 6 specs/day to hit ETA (current: 5.2)
- **156 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (69 files, 461/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > patch (81%)

📁 `api/tables/{tableId}/records/{recordId}/patch.spec.ts`

**Update record**

**13/16** passing | 3 fixme | 15 @spec | 1 @regression
