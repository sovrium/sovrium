...
> Generated: 2026-01-23T14:54:29.393Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1957/2252 tests) | 🟡 Needs Attention |
...
- **295 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 330/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (33%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**6/18** passing | 12 fixme | 17 @spec | 1 @regression
