...
> Generated: 2026-01-12T12:27:11.199Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [███████████████░░░░░] 74% (1906/2568 tests) | 🔴 Blocked   |
| **Daily Velocity**       | 11.5 specs/day                               | 🔴 Slow      |
| **Quality Score**        | 94%                                          | 🟢 Excellent |
| **Estimated Completion** | 2026-03-11 (~2 months)                       | 🔴 Blocked   |
...
- ❌ **HEADER_COUNT_MISMATCH** in `cli/start/yaml-config.spec.ts`

### 📋 Priority 3 - Ongoing

- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 11.5)
- **662 tests remaining** - TDD automation running
...
- **HEADER_COUNT_MISMATCH** in `cli/start/yaml-config.spec.ts`
  Header "Spec Count: 8" does not match actual @spec count: 7

## 📁 Feature Breakdown

### API

🟡 **111 files** | **927 tests** | [██████░░░░░░░░░░░░░░] 29% | Early Stage

<details>
<summary>View API specs (111 files, 265/927 passing)</summary>
