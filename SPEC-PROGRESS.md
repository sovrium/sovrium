...
> Generated: 2026-02-16T11:58:25.759Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 97% (2188/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 13.95 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 13.95)
...
| Metric                   | Value                |
| ------------------------ | -------------------- |
| Tests Fixed (30 days)    | 279                  |
| 🤖 Fixed by TDD Pipeline | 222                  |
| 👤 Fixed Manually        | 57                   |
| Fixed Last 24h           | 28                   |
| Fixed Last 7d            | 92                   |
| Fixed Last 30d           | 279                  |
...
<details>
<summary>View API specs (67 files, 567/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > {commentId} > patch (9%)
