...
> Generated: 2026-02-14T16:27:36.418Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 95% (2139/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.35 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 12.35)
- **110 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 247                   |
| 🤖 Fixed by TDD Pipeline | 180                   |
| 👤 Fixed Manually        | 67                    |
| Fixed Last 24h           | 5                     |
| Fixed Last 7d            | 50                    |
| Fixed Last 30d           | 247                   |
...
<details>
<summary>View API specs (67 files, 525/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > authorship-metadata (13%)

📁 `api/tables/{tableId}/records/authorship-metadata.spec.ts`

**Record Authorship Metadata**

**3/24** passing | 21 fixme | 23 @spec | 1 @regression
