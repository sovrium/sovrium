...
> Generated: 2026-02-15T06:14:42.139Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2155/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.24 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 12.24)
- **94 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 257                   |
| 🤖 Fixed by TDD Pipeline | 190                   |
| 👤 Fixed Manually        | 67                    |
| Fixed Last 24h           | 15                    |
| Fixed Last 7d            | 60                    |
| Fixed Last 30d           | 257                   |
...
<details>
<summary>View API specs (67 files, 541/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > post (43%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**6/14** passing | 8 fixme | 13 @spec | 1 @regression
