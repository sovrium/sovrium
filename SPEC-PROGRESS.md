...
> Generated: 2026-01-24T00:07:34.198Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1966/2252 tests) | 🟡 Needs Attention |
...
- **286 tests remaining** - TDD automation running
...
| Spec ID                               | Date             | Commit    |
| ------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-015`       | 2026-01-24 01:07 | `65dc0de` |
...
<details>
<summary>View API specs (67 files, 339/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (83%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**15/18** passing | 3 fixme | 17 @spec | 1 @regression
