...
> Generated: 2026-02-15T19:39:04.927Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2166/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 13.1 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 13.1)
- **83 tests remaining** - TDD automation running
...
| 🟢 Specified & Implemented    | 253   | 93%        |
| 🟡 Specified, Not Implemented | 15    | 6%         |
...
<details>
<summary>🟡 Stories Specified but Not Implemented (15)</summary>
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 262                   |
| 🤖 Fixed by TDD Pipeline | 202                   |
| 👤 Fixed Manually        | 60                    |
| Fixed Last 24h           | 20                    |
| Fixed Last 7d            | 72                    |
| Fixed Last 30d           | 262                   |
...
| ----------------------------------------- | ---------------- | --------- | ------ |
| `API-TABLES-RECORDS-UPSERT-010`           | 2026-02-15 20:29 | `ceba995` | 🤖 TDD |
| `APP-TABLES-FIELD-TYPES-RELATIONSHIP-023` | 2026-02-15 16:34 | `351fcb1` | 🤖 TDD |
...
<details>
<summary>View API specs (67 files, 545/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > upsert > post (86%)

📁 `api/tables/{tableId}/records/upsert/post.spec.ts`

**Upsert records (create or update)**

**12/14** passing | 2 fixme | 13 @spec | 1 @regression
...
✅ **API-TABLES-RECORDS-UPSERT-010** `@spec`
...
<details>
<summary>View APP specs (128 files, 1451/1451 passing)</summary>
...
✅ **APP-TABLES-FIELD-TYPES-RELATIONSHIP-023** `@spec`
