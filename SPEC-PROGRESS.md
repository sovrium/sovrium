...
> Generated: 2026-01-24T09:55:21.557Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 88% (1972/2252 tests) | 🟡 Needs Attention |
...
- **280 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 345/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > delete (47%)

📁 `api/tables/{tableId}/records/{recordId}/delete.spec.ts`

**Delete record**

**9/19** passing | 10 fixme | 18 @spec | 1 @regression
