...
> Generated: 2026-02-15T21:56:48.258Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2169/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 13.25 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 13.25)
- **80 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 265                   |
| 🤖 Fixed by TDD Pipeline | 205                   |
| 👤 Fixed Manually        | 60                    |
| Fixed Last 24h           | 23                    |
| Fixed Last 7d            | 75                    |
| Fixed Last 30d           | 265                   |
...
| ----------------------------------------- | ---------------- | --------- | ------ |
| `API-TABLES-RECORDS-BATCH-POST-008`       | 2026-02-15 22:47 | `b230a82` | 🤖 TDD |
...
<details>
<summary>View API specs (67 files, 548/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > post (57%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**8/14** passing | 6 fixme | 13 @spec | 1 @regression
