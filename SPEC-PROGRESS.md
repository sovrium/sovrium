...
> Generated: 2026-01-23T12:13:51.970Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1955/2252 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 6 specs/day                                  | 🔴 Slow            |
...
- **Maintain velocity** - Need 6 specs/day to hit ETA (current: 6)
- **297 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 328/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (22%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**4/18** passing | 14 fixme | 17 @spec | 1 @regression
