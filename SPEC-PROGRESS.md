...
> Generated: 2026-02-04T14:35:46.173Z
>
...
| 💡 Suggestions       | 0     |
| 🔄 Duplicate IDs     | 0     |
| 🔗 Orphaned Spec IDs | 2173  |

## 📋 User Stories Metrics

| Category                      | Count | Percentage |
| ----------------------------- | ----- | ---------- |
| **Total User Stories**        | 315   | -          |
| **Total Acceptance Criteria** | 1194  | -          |
| 🟢 Specified & Implemented    | 15    | 5%         |
| 🟡 Specified, Not Implemented | 0     | 0%         |
| 🔴 Needs Specification        | 300   | 95%        |

**User Story Coverage**: [█░░░░░░░░░░░░░░░░░░░] 5%

### By Domain

| Domain       | Stories | Specified | Implemented | Coverage |
| ------------ | ------- | --------- | ----------- | -------- |
| ADMIN-SPACE  | 31      | 31        | 0           | 0%       |
| ANALYTICS    | 30      | 30        | 0           | 0%       |
| API          | 37      | 37        | 0           | 0%       |
| AUTH         | 40      | 40        | 14          | 35%      |
| AUTOMATIONS  | 29      | 29        | 0           | 0%       |
| FORMS        | 32      | 32        | 0           | 0%       |
| INTEGRATIONS | 26      | 26        | 0           | 0%       |
| PAGES        | 26      | 26        | 0           | 0%       |
| TABLES       | 33      | 33        | 0           | 0%       |
| THEME        | 31      | 31        | 1           | 3%       |

<details>
<summary>🔴 Stories Needing Specification (300)</summary>

- **US-ADMIN-EDITOR-ANY-001**: AI Agent Mode
  - File: `docs/specification/admin-space/app-editor/as-any-user.md`
  - Domain: admin-space > app-editor > Any User
...
- **US-ADMIN-EDITOR-BIZ-001**: Visual Form Editor
  - File: `docs/specification/admin-space/app-editor/as-business-user.md`
  - Domain: admin-space > app-editor > Business User
...
- **US-ADMIN-EDITOR-001**: JSON/YAML Editor
  - File: `docs/specification/admin-space/app-editor/as-developer.md`
  - Domain: admin-space > app-editor > Developer
...
- **US-ADMIN-DASH-001**: App Health Overview
  - File: `docs/specification/admin-space/dashboard/as-app-administrator.md`
  - Domain: admin-space > dashboard > App Administrator
...
- **US-ADMIN-VERSION-001**: Version History
  - File: `docs/specification/admin-space/schema-versioning/as-app-administrator.md`
  - Domain: admin-space > schema-versioning > App Administrator
...
> Every spec should trace back to a user requirement in `docs/specification/`.

| Spec ID                                  | File                                                          | Line | Test Name                                          |
| ---------------------------------------- | ------------------------------------------------------------- | ---- | -------------------------------------------------- |
| `API-ACTIVITY-DETAILS-001`               | `api/activity/{activityId}/get.spec.ts`                       | 27   | API-ACTIVITY-DETAILS-001: should return 200 wit... |
| `API-ACTIVITY-DETAILS-002`               | `api/activity/{activityId}/get.spec.ts`                       | 75   | API-ACTIVITY-DETAILS-002: should return 401 whe... |
| `API-ACTIVITY-DETAILS-003`               | `api/activity/{activityId}/get.spec.ts`                       | 98   | API-ACTIVITY-DETAILS-003: should return 404 whe... |
| `API-ACTIVITY-DETAILS-004`               | `api/activity/{activityId}/get.spec.ts`                       | 123  | API-ACTIVITY-DETAILS-004: should include user m... |
| `API-ACTIVITY-DETAILS-005`               | `api/activity/{activityId}/get.spec.ts`                       | 166  | API-ACTIVITY-DETAILS-005: should return activit... |
| `API-ACTIVITY-DETAILS-006`               | `api/activity/{activityId}/get.spec.ts`                       | 208  | API-ACTIVITY-DETAILS-006: should return 400 whe... |
| `API-ACTIVITY-DETAILS-007`               | `api/activity/{activityId}/get.spec.ts`                       | 233  | API-ACTIVITY-DETAILS-007: should return 401 Una... |
| `API-ACTIVITY-DETAILS-REGRESSION`        | `api/activity/{activityId}/get.spec.ts`                       | 266  | API-ACTIVITY-DETAILS-REGRESSION: user can retri... |
| `API-ACTIVITY-LIST-001`                  | `api/activity/get.spec.ts`                                    | 27   | API-ACTIVITY-LIST-001: should return 200 with p... |
| `API-ACTIVITY-LIST-002`                  | `api/activity/get.spec.ts`                                    | 75   | API-ACTIVITY-LIST-002: should return 401 when u... |
| `API-ACTIVITY-LIST-003`                  | `api/activity/get.spec.ts`                                    | 98   | API-ACTIVITY-LIST-003: should return activities... |
| `API-ACTIVITY-LIST-004`                  | `api/activity/get.spec.ts`                                    | 150  | API-ACTIVITY-LIST-004: should return activities... |
| `API-ACTIVITY-LIST-005`                  | `api/activity/get.spec.ts`                                    | 194  | API-ACTIVITY-LIST-005: should return activities... |
| `API-ACTIVITY-LIST-006`                  | `api/activity/get.spec.ts`                                    | 238  | API-ACTIVITY-LIST-006: should return activities... |
| `API-ACTIVITY-LIST-007`                  | `api/activity/get.spec.ts`                                    | 281  | API-ACTIVITY-LIST-007: should return activities... |
| `API-ACTIVITY-LIST-008`                  | `api/activity/get.spec.ts`                                    | 329  | API-ACTIVITY-LIST-008: should support paginatio... |
| `API-ACTIVITY-LIST-009`                  | `api/activity/get.spec.ts`                                    | 376  | API-ACTIVITY-LIST-009: should return empty arra... |
| `API-ACTIVITY-LIST-010`                  | `api/activity/get.spec.ts`                                    | 401  | API-ACTIVITY-LIST-010: should return 400 when p... |
| `API-ACTIVITY-LIST-011`                  | `api/activity/get.spec.ts`                                    | 426  | API-ACTIVITY-LIST-011: should return 400 when p... |
| `API-ACTIVITY-LIST-012`                  | `api/activity/get.spec.ts`                                    | 451  | API-ACTIVITY-LIST-012: should include user meta... |
| `API-ACTIVITY-LIST-013`                  | `api/activity/get.spec.ts`                                    | 493  | API-ACTIVITY-LIST-013: should exclude activitie... |
| `API-ACTIVITY-LIST-014`                  | `api/activity/get.spec.ts`                                    | 536  | API-ACTIVITY-LIST-014: should return 400 when a... |
| `API-ACTIVITY-LIST-015`                  | `api/activity/get.spec.ts`                                    | 561  | API-ACTIVITY-LIST-015: should return 401 Unauth... |
| `API-ACTIVITY-LIST-016`                  | `api/activity/get.spec.ts`                                    | 590  | API-ACTIVITY-LIST-016: should include null user... |
| `API-ACTIVITY-LIST-017`                  | `api/activity/get.spec.ts`                                    | 635  | API-ACTIVITY-LIST-017: should allow non-admin u... |
| `API-ACTIVITY-LIST-018`                  | `api/activity/get.spec.ts`                                    | 677  | API-ACTIVITY-LIST-018: should return 403 when n... |
| `API-ACTIVITY-LIST-019`                  | `api/activity/get.spec.ts`                                    | 724  | API-ACTIVITY-LIST-019: should allow admin to fi... |
| `API-ACTIVITY-LIST-REGRESSION`           | `api/activity/get.spec.ts`                                    | 778  | API-ACTIVITY-LIST-REGRESSION: user can retrieve... |
| `API-ACTIVITY-RATE-001`                  | `api/activity/rate-limiting.spec.ts`                          | 50   | API-ACTIVITY-RATE-001: should return 429 after ... |
| `API-ACTIVITY-RATE-002`                  | `api/activity/rate-limiting.spec.ts`                          | 92   | API-ACTIVITY-RATE-002: should return 429 after ... |
| `API-ACTIVITY-RATE-003`                  | `api/activity/rate-limiting.spec.ts`                          | 144  | API-ACTIVITY-RATE-003: should reset activity ra... |
| `API-ACTIVITY-RATE-004`                  | `api/activity/rate-limiting.spec.ts`                          | 192  | API-ACTIVITY-RATE-004: should include Retry-Aft... |
| `API-ACTIVITY-RATE-005`                  | `api/activity/rate-limiting.spec.ts`                          | 230  | API-ACTIVITY-RATE-005: should rate limit by IP ... |
| `API-ACTIVITY-RATE-006`                  | `api/activity/rate-limiting.spec.ts`                          | 280  | API-ACTIVITY-RATE-006: should apply rate limit ... |
| `API-ACTIVITY-RATE-REGRESSION`           | `api/activity/rate-limiting.spec.ts`                          | 335  | API-ACTIVITY-RATE-REGRESSION: rate limiting pro... |
| `API-ACTIVITY-RECORD-HISTORY-001`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 27   | API-ACTIVITY-RECORD-HISTORY-001: should return ... |
| `API-ACTIVITY-RECORD-HISTORY-002`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 79   | API-ACTIVITY-RECORD-HISTORY-002: should return ... |
| `API-ACTIVITY-RECORD-HISTORY-003`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 113  | API-ACTIVITY-RECORD-HISTORY-003: should return ... |
| `API-ACTIVITY-RECORD-HISTORY-004`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 138  | API-ACTIVITY-RECORD-HISTORY-004: should return ... |
| `API-ACTIVITY-RECORD-HISTORY-005`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 174  | API-ACTIVITY-RECORD-HISTORY-005: should return ... |
| `API-ACTIVITY-RECORD-HISTORY-006`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 209  | API-ACTIVITY-RECORD-HISTORY-006: should include... |
| `API-ACTIVITY-RECORD-HISTORY-007`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 254  | API-ACTIVITY-RECORD-HISTORY-007: should exclude... |
| `API-ACTIVITY-RECORD-HISTORY-008`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 298  | API-ACTIVITY-RECORD-HISTORY-008: should support... |
| `API-ACTIVITY-RECORD-HISTORY-009`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 347  | API-ACTIVITY-RECORD-HISTORY-009: should show co... |
| `API-ACTIVITY-RECORD-HISTORY-010`        | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 394  | API-ACTIVITY-RECORD-HISTORY-010: should return ... |
| `API-ACTIVITY-RECORD-HISTORY-REGRESSION` | `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` | 427  | API-ACTIVITY-RECORD-HISTORY-REGRESSION: user ca... |
| `API-AUTH-ADMIN-BOOTSTRAP-007`           | `api/auth/admin/bootstrap/admin-bootstrap.spec.ts`            | 288  | API-AUTH-ADMIN-BOOTSTRAP-007: should not create... |
| `API-AUTH-ADMIN-BOOTSTRAP-008`           | `api/auth/admin/bootstrap/admin-bootstrap.spec.ts`            | 320  | API-AUTH-ADMIN-BOOTSTRAP-008: should create adm... |
| `API-AUTH-ADMIN-BOOTSTRAP-009`           | `api/auth/admin/bootstrap/admin-bootstrap.spec.ts`            | 360  | API-AUTH-ADMIN-BOOTSTRAP-009: should not create... |
| `API-AUTH-ADMIN-BOOTSTRAP-010`           | `api/auth/admin/bootstrap/admin-bootstrap.spec.ts`            | 392  | API-AUTH-ADMIN-BOOTSTRAP-010: should not create... |

... and 2123 more orphaned spec IDs

## 🤖 TDD Automation

| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (90 days)    | 1737                  |
