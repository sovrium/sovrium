...
> Generated: 2026-02-16T16:03:18.033Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 97% (2198/2270 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 14.4 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 96%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2026-02-21 (~5 days)                         | 🟡 Needs Attention |
...
- **Maintain velocity** - Need 15 specs/day to hit ETA (current: 14.4)
...
| 🟢 Specified & Implemented    | 259   | 96%        |
| 🟡 Specified, Not Implemented | 12    | 4%         |
| 🔴 Needs Specification        | 0     | 0%         |

**User Story Coverage**: [███████████████████░] 96%

### By Domain

| Domain  | Stories | Specified | Implemented | Coverage |
| ------- | ------- | --------- | ----------- | -------- |
| UNKNOWN | 271     | 271       | 259         | 96%      |

<details>
<summary>🟡 Stories Specified but Not Implemented (12)</summary>
...
- **US-AUTH-STRATEGIES-001**: Configure Authentication Strategies
  - Spec IDs: `APP-AUTH-STRATEGIES-001`, `APP-AUTH-STRATEGIES-002`, `APP-AUTH-STRATEGIES-003`, `APP-AUTH-STRATEGIES-004`, `APP-AUTH-STRATEGIES-005`, `APP-AUTH-STRATEGIES-006`, `APP-AUTH-STRATEGIES-007`, `APP-AUTH-STRATEGIES-008`
  - File: `docs/user-stories/as-developer/authentication/auth-strategies.md`
- **US-AUTH-ROLES-001**: Define Custom Roles
  - Spec IDs: `APP-AUTH-ROLES-001`, `APP-AUTH-ROLES-002`, `APP-AUTH-ROLES-003`, `APP-AUTH-ROLES-004`, `APP-AUTH-ROLES-005`, `APP-AUTH-ROLES-006`, `APP-AUTH-ROLES-007`, `APP-AUTH-ROLES-008`
  - File: `docs/user-stories/as-developer/authentication/role-definitions.md`
- **US-AUTH-ROLES-002**: Default Role Assignment
  - Spec IDs: `APP-AUTH-ROLES-009`, `APP-AUTH-ROLES-010`, `APP-AUTH-ROLES-011`, `APP-AUTH-ROLES-012`
  - File: `docs/user-stories/as-developer/authentication/role-definitions.md`
...
| -------------------------------- | ----------------------------- | ---- | -------------------------------------------------- |
| `APP-AUTH-ROLES-REGRESSION`      | `app/auth/roles.spec.ts`      | 390  | APP-AUTH-ROLES-REGRESSION: developer can config... |
| `APP-AUTH-STRATEGIES-REGRESSION` | `app/auth/strategies.spec.ts` | 242  | APP-AUTH-STRATEGIES-REGRESSION: developer can c... |
...
| ---------------------------------------- | ---------------- | --------- | ------ |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-010` | 2026-02-16 15:32 | `fe2efb8` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-009` | 2026-02-16 15:17 | `3d966a4` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-008` | 2026-02-16 15:02 | `820f707` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-007` | 2026-02-16 14:47 | `b569565` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-006` | 2026-02-16 14:31 | `59080eb` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-005` | 2026-02-16 14:16 | `dcbf543` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-004` | 2026-02-16 13:33 | `13ffbba` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-003` | 2026-02-16 13:17 | `23d0492` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-002` | 2026-02-16 13:03 | `d53704c` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-UPDATE-001` | 2026-02-16 12:49 | `1cd69da` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-RESTORE-009`   | 2026-02-16 11:02 | `3026474` | 🤖 TDD |
| `API-TABLES-RECORDS-AUTHORSHIP-006`      | 2026-02-16 08:41 | `f35ba3b` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-RESTORE-008`   | 2026-02-16 07:54 | `83b2f05` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-RESTORE-007`   | 2026-02-16 06:25 | `4ceeda8` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-RESTORE-006`   | 2026-02-16 05:29 | `9d9e5a9` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-RESTORE-005`   | 2026-02-16 04:58 | `77fc4b0` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-RESTORE-003`   | 2026-02-16 04:43 | `2c8677f` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-RESTORE-002`   | 2026-02-16 04:29 | `cd699ae` | 🤖 TDD |
...
🟡 **67 files** | **627 tests** | [██████████████████░░] 92% | Almost Done

<details>
<summary>View API specs (67 files, 577/627 passing)</summary>
...
#### 🚧 tables > {tableId} > records > authorship-metadata (26%)

📁 `api/tables/{tableId}/records/authorship-metadata.spec.ts`

**Record Authorship Metadata**

**6/23** passing | 17 fixme | 22 @spec | 1 @regression
...
🟡 **130 files** | **1473 tests** | [████████████████████] 99% | Almost Done

<details>
<summary>View APP specs (130 files, 1451/1473 passing)</summary>
