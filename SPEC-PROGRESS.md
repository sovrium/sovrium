...
> Generated: 2026-02-16T10:12:08.299Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 97% (2186/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 13.9 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 13.9)
...
| Metric                   | Value                |
| ------------------------ | -------------------- |
| Tests Fixed (30 days)    | 278                  |
| 🤖 Fixed by TDD Pipeline | 221                  |
| 👤 Fixed Manually        | 57                   |
| Fixed Last 24h           | 28                   |
| Fixed Last 7d            | 91                   |
| Fixed Last 30d           | 278                  |
...
<details>
<summary>View API specs (67 files, 565/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > authorship-metadata (25%)

📁 `api/tables/{tableId}/records/authorship-metadata.spec.ts`

**Record Authorship Metadata**

**6/24** passing | 18 fixme | 23 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > batch > restore > post (90%)
