...
> Generated: 2025-12-24T10:38:36.862Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [████████████░░░░░░░░] 61% (1793/2925 tests) | 🟢 On Track  |
| **Daily Velocity**       | 26.53 specs/day                              | 🟢 Healthy   |
| **Quality Score**        | 91%                                          | 🟢 Excellent |
| **Estimated Completion** | 2026-02-05 (~2 months)                       | 🟢 On Track  |
...
- [Feature Breakdown](#-feature-breakdown)
  - [API](#api) • 🟡 12% (162 files)
  - [APP](#app) • 🟡 99% (131 files)
  - [CLI](#cli) • 🟢 100% (9 files)
...
- **Maintain velocity** - Need 27 specs/day to hit ETA (current: 26.53)
- **1132 tests remaining** - TDD automation running
- **Quality gate** - Keep quality score above 85% (current: 91%)
...
| Metric                | Value                  |
| --------------------- | ---------------------- |
| Tests Fixed (90 days) | 1587                   |
| Fixed Last 24h        | 12                     |
| Fixed Last 7d         | 138                    |
| Fixed Last 30d        | 796                    |
| Avg Fixes/Day         | 26.53                  |
| Remaining             | 1132                   |
| ETA                   | ~2 months (2026-02-05) |
...
| Spec ID                        | Date             | Commit    |
| ------------------------------ | ---------------- | --------- |
| `API-AUTH-API-KEYS-CREATE-005` | 2025-12-23 16:26 | `e4b92fc` |
| `API-AUTH-API-KEYS-CREATE-004` | 2025-12-23 15:22 | `c979c10` |
| `API-AUTH-API-KEYS-CREATE-003` | 2025-12-23 15:13 | `90b6fe4` |
| `API-AUTH-API-KEYS-CREATE-002` | 2025-12-23 14:53 | `9a90d37` |
| `API-AUTH-API-KEYS-CREATE-001` | 2025-12-23 14:34 | `8d2e7f6` |
| `API-AUTH-DISABLED-005`        | 2025-12-23 14:19 | `52b2a67` |
| `API-AUTH-DISABLED-004`        | 2025-12-23 13:43 | `2b6bed5` |
| `API-AUTH-DISABLED-003`        | 2025-12-23 13:26 | `e37f137` |
| `API-AUTH-DISABLED-002`        | 2025-12-23 13:01 | `39145bc` |
| `API-AUTH-DISABLED-001`        | 2025-12-23 12:46 | `3735a61` |
| `API-ACTIVITY-AUTH-005`        | 2025-12-23 11:56 | `7674def` |
| `MIGRATION-VIEW-006`           | 2025-12-23 11:47 | `3cc7c3d` |
| `API-ACTIVITY-AUTH-003`        | 2025-12-23 10:39 | `731b88a` |
| `API-ACTIVITY-AUTH-004`        | 2025-12-23 09:56 | `7327629` |
| `MIGRATION-VIEW-006`           | 2025-12-23 09:34 | `993f906` |
| `MIGRATION-VIEW-006`           | 2025-12-23 09:18 | `9e02178` |
| `API-ACTIVITY-AUTH-002`        | 2025-12-23 08:31 | `1c7d7fb` |
| `API-ACTIVITY-AUTH-001`        | 2025-12-23 07:38 | `dbef11e` |
| `MIGRATION-VIEW-005`           | 2025-12-23 06:04 | `8b15b1f` |
| `MIGRATION-VIEW-004`           | 2025-12-23 05:34 | `510e552` |
...
🟡 **162 files** | **1284 tests** | [██░░░░░░░░░░░░░░░░░░] 12% | Early Stage

<details>
<summary>View API specs (162 files, 160/1284 passing)</summary>

#### 🚧 activity > api-key-auth (60%)

📁 `api/activity/api-key-auth.spec.ts`

**API Key Authentication - Activity Listing**
...
**0/21** passing | 21 fixme | 20 @spec | 1 @regression
...
⏸️ **API-ACTIVITY-LIST-021** `@regression`
API-ACTIVITY-LIST-021: user can retrieve and filter activity logs
`~G~/~W~/~T~` Line 814

</details>

#### 🚧 activity > {activityId} > api-key-auth (0%)

📁 `api/activity/{activityId}/api-key-auth.spec.ts`

**API Key Authentication - Single Activity**
...
#### 🚧 auth > admin > custom-permissions > resource-action (0%)

📁 `api/auth/admin/custom-permissions/resource-action.spec.ts`

**Admin Custom Resource:Action Permissions**
...
#### 🚧 auth > admin > has-permission > post (0%)

📁 `api/auth/admin/has-permission/post.spec.ts`
...
#### 🚧 auth > admin > impersonation > start (0%)

📁 `api/auth/admin/impersonation/start.spec.ts`
...
#### 🚧 auth > admin > options > ban-user (0%)

📁 `api/auth/admin/options/ban-user.spec.ts`
...
#### 🚧 auth > admin > role-management > assign-admin (0%)

📁 `api/auth/admin/role-management/assign-admin.spec.ts`
...
#### 🚧 auth > admin > set-user-password > post (0%)
...
#### 🚧 auth > api-key > delete-expired > delete (0%)
...
#### 🚧 auth > api-key > expiration > auto-rotate (0%)

📁 `api/auth/api-key/expiration/auto-rotate.spec.ts`
...
#### 🚧 auth > api-key > permissions > resource-permissions (0%)

📁 `api/auth/api-key/permissions/resource-permissions.spec.ts`
...
✅ **API-AUTH-CHANGE-EMAIL-008** `@regression`
...
#### 🚧 auth > enforcement > admin-enforcement (18%)
...
✅ **API-AUTH-ENFORCE-ADMIN-001** `@spec`
...
#### 🚧 auth > organization > accept-invitation > post (0%)
...
⏸️ **API-AUTH-ORG-DYNAMIC-ROLE-ASSIGN-007** `@regression`
...
⏸️ **API-AUTH-ORG-DYNAMIC-ROLE-CHECK-PERM-007** `@regression`
...
⏸️ **API-AUTH-ORG-DYNAMIC-ROLE-DELETE-005** `@spec`
...
⏸️ **API-AUTH-ORG-DYNAMIC-ROLE-DELETE-007** `@regression`
...
⏸️ **API-AUTH-ORG-DYNAMIC-ROLE-LIST-007** `@regression`
API-AUTH-ORG-DYNAMIC-ROLE-LIST-007: member can view all available roles with permissions
`G/W/T` Line 290

</details>

#### 🚧 auth > organization > dynamic-roles > update-role > patch (0%)
...
⏸️ **API-AUTH-ORG-DYNAMIC-ROLE-UPDATE-005** `@spec`
...
⏸️ **API-AUTH-ORG-DYNAMIC-ROLE-UPDATE-007** `@regression`
API-AUTH-ORG-DYNAMIC-ROLE-UPDATE-007: owner can update role permissions and verify changes
`G/W/T` Line 301

</details>

#### 🚧 auth > organization > get-organization > get (0%)
...
#### 🚧 auth > organization > invite-member > post (10%)
...
#### 🚧 auth > organization > list-invitations > get (0%)
...
#### 🚧 auth > organization > list-members > get (0%)
...
#### 🚧 auth > organization > list-organizations > get (0%)
...
#### 🚧 auth > organization > options > allowed-domains (0%)

📁 `api/auth/organization/options/allowed-domains.spec.ts`

**Organization Allowed Email Domains**
...
#### 🚧 auth > organization > set-active-organization > post (0%)
...
⏸️ **API-AUTH-ORG-TEAMS-ADD-MEMBER-007** `@regression`
...
⏸️ **API-AUTH-ORG-TEAMS-CREATE-007** `@regression`
...
⏸️ **API-AUTH-ORG-TEAMS-DELETE-007** `@regression`
API-AUTH-ORG-TEAMS-DELETE-007: owner can delete team with members and verify cleanup
`G/W/T` Line 362

</details>

#### 🚧 auth > organization > teams > get-active-team > get (0%)
...
⏸️ **API-AUTH-ORG-TEAMS-GET-ACTIVE-005** `@spec`
API-AUTH-ORG-TEAMS-GET-ACTIVE-005: placeholder
`G/W/T` Line 147

⏸️ **API-AUTH-ORG-TEAMS-GET-ACTIVE-006** `@spec`
API-AUTH-ORG-TEAMS-GET-ACTIVE-006: placeholder
`G/W/T` Line 160

⏸️ **API-AUTH-ORG-TEAMS-GET-ACTIVE-007** `@regression`
...
⏸️ **API-AUTH-ORG-TEAMS-GET-007** `@regression`
...
⏸️ **API-AUTH-ORG-TEAMS-LIST-MEMBERS-007** `@regression`
...
⏸️ **API-AUTH-ORG-TEAMS-LIST-007** `@regression`
...
⏸️ **API-AUTH-ORG-TEAMS-REMOVE-MEMBER-007** `@regression`
...
⏸️ **API-AUTH-ORG-TEAMS-SET-ACTIVE-007** `@regression`
...
⏸️ **API-AUTH-ORG-TEAMS-UPDATE-007** `@regression`
...
✅ **API-AUTH-REQUEST-PASSWORD-RESET-008** `@regression`
...
✅ **API-AUTH-RESET-PASSWORD-009** `@regression`
...
#### 🚧 auth > sign-up > email > post (88%)

📁 `api/auth/sign-up/email/post.spec.ts`

**Sign up with email and password**

**14/16** passing | 2 fixme | 15 @spec | 1 @regression
...
#### 🚧 security > account-enumeration (0%)

📁 `api/security/account-enumeration.spec.ts`

**Account Enumeration Prevention - User Existence Protection**
...
⏸️ **API-SECURITY-REDIRECT-003** `@regression`
...
⏸️ **API-SECURITY-HASH-004** `@regression`
API-SECURITY-HASH-004: user can complete full password hashing workflow
`G/W/T` Line 158

</details>

#### 🚧 security > payload-limits (0%)

📁 `api/security/payload-limits.spec.ts`

**Payload Limits - Request Body Size Protection**
...
⏸️ **API-SECURITY-SESSION-001** `@spec`
...
⏸️ **API-SECURITY-SQLI-009** `@regression`
API-SECURITY-SQLI-009: SQL injection protection across all attack vectors
`~G~/~W~/T` Line 468

</details>

#### 🚧 security > tls-enforcement (0%)

📁 `api/security/tls-enforcement.spec.ts`

**TLS Enforcement - Transport Layer Security**
...
⏸️ **API-SECURITY-XSS-009** `@spec`
API-SECURITY-XSS-009: should prevent XSS in update-user endpoint
`G/W/T` Line 452

⏸️ **API-SECURITY-XSS-010** `@regression`
API-SECURITY-XSS-010: XSS protection is enforced across all content types
`~G~/~W~/~T~` Line 514

</details>

#### 🚧 tables > api-key-auth (0%)

📁 `api/tables/api-key-auth.spec.ts`

**API Key Authentication - Table Listing**
...
⏸️ **API-TABLES-PERMISSIONS-FIELD-006** `@regression`
API-TABLES-PERMISSIONS-FIELD-006: complete field permission workflow via API
`~G~/~W~/~T~` Line 385

</details>

#### 🚧 tables > permissions > api-organization-isolation (0%)
...
⏸️ **API-TABLES-PERMISSIONS-ORG-002** `@spec`
...
⏸️ **API-TABLES-PERMISSIONS-INHERIT-005** `@spec`
...
⏸️ **API-TABLES-PERMISSIONS-INHERIT-007** `@regression`
...
⏸️ **API-TABLES-PERMISSIONS-RECORD-008** `@regression`
API-TABLES-PERMISSIONS-RECORD-008: complete owner-based access workflow
`~G~/~W~/~T~` Line 468

</details>

#### 🚧 tables > session-context-integration (0%)
...
#### 🚧 tables > {tableId} > api-key-auth (0%)

📁 `api/tables/{tableId}/api-key-auth.spec.ts`

**API Key Authentication - Single Table**
...
#### 🚧 tables > {tableId} > records > api-key-auth (0%)

📁 `api/tables/{tableId}/records/api-key-auth.spec.ts`

**API Key Authentication - Record CRUD**
...
⏸️ **API-TABLES-RECORDS-BATCH-POST-017** `@regression`
...
#### 🚧 tables > {tableId} > records > {recordId} > api-key-auth (0%)

📁 `api/tables/{tableId}/records/{recordId}/api-key-auth.spec.ts`

**API Key Authentication - Single Record Operations**
...
⏸️ **API-TABLES-RECORDS-COMMENTS-LIST-012** `@regression`
...
⏸️ **API-TABLES-RECORDS-COMMENTS-CREATE-012** `@regression`
...
⏸️ **API-TABLES-RECORDS-COMMENTS-DELETE-010** `@regression`
...
⏸️ **API-TABLES-RECORDS-COMMENTS-GET-008** `@regression`
...
⏸️ **API-TABLES-RECORDS-DELETE-019** `@regression`
API-TABLES-RECORDS-DELETE-019: user can complete full soft delete workflow
`~G~/~W~/~T~` Line 846

</details>

#### 🚧 tables > {tableId} > records > {recordId} > get (0%)

📁 `api/tables/{tableId}/records/{recordId}/get.spec.ts`

**Get record by ID**

**0/13** passing | 13 fixme | 12 @spec | 1 @regression
...
⏸️ **API-TABLES-RECORDS-UPDATE-018** `@regression`
API-TABLES-RECORDS-UPDATE-018: user can complete full record update workflow
`~G~/~W~/~T~` Line 895

</details>

#### 🚧 tables > {tableId} > records > {recordId} > restore > post (0%)
...
⏸️ **API-TABLES-RECORDS-RESTORE-010** `@regression`
...
⏸️ **API-TABLES-TRASH-006** `@regression`
...
🟡 **131 files** | **1471 tests** | [████████████████████] 99% | Almost Done

<details>
<summary>View APP specs (131 files, 1463/1471 passing)</summary>
...
✅ **APP-TABLES-FIELD-TYPES-BUTTON-008** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-COUNT-008** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-DELETED-AT-006** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-DELETED-BY-006** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-MULTI-SELECT-009** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-MULTIPLE-ATTACHMENTS-008** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-ROLLUP-014** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-SINGLE-ATTACHMENT-008** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-SINGLE-SELECT-008** `@regression`
...
✅ **APP-TABLES-SPECIAL-FIELDS-007** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-STATUS-009** `@regression`
...
✅ **APP-TABLES-TIMEZONE-010** `@regression`
...
✅ **APP-TABLES-FIELD-TYPES-UPDATED-AT-006** `@regression`
...
✅ **APP-TABLES-FIELDS-017** `@regression`
...
#### 🚧 tables > permissions > field-permissions (70%)

📁 `app/tables/permissions/field-permissions.spec.ts`

**Field-Level Permissions**

**7/10** passing | 3 fixme | 9 @spec | 1 @regression
...
⏸️ **APP-TABLES-ORG-ISOLATION-010** `@spec`
...
✅ **APP-TABLES-PERMISSIONS-011** `@regression`
...
✅ **APP-TABLES-RLS-ENFORCEMENT-015** `@regression`
...
✅ **APP-TABLES-TABLE-PERMISSIONS-006** `@regression`
...
✅ **APP-TABLES-UNIQUECONSTRAINTS-NULL-008** `@regression`
...
✅ **APP-TABLES-VIEW-FILTERS-007** `@regression`
...
✅ **APP-TABLES-VIEWS-009** `@regression`
...
✅ **CLI-BUILD-ASSETS-005** `@regression`
...
✅ **CLI-BUILD-DEPLOY-007** `@regression`
...
✅ **CLI-BUILD-GENERATION-007** `@regression`
...
✅ **CLI-START-FORMAT-006** `@regression`
...
✅ **CLI-START-WATCH-008** `@regression`
...
✅ **MIGRATION-AUDIT-007** `@regression`
...
✅ **MIGRATION-CHECKSUM-005** `@regression`
...
✅ **MIGRATION-ERROR-011** `@regression`
...
✅ **MIGRATION-ROLLBACK-009** `@regression`
...
✅ **MIGRATION-ALTER-ADD-007** `@regression`
...
✅ **MIGRATION-MODIFY-CONSTRAINTS-005** `@regression`
...
✅ **MIGRATION-MODIFY-DEFAULT-004** `@regression`
...
✅ **MIGRATION-MODIFY-OPTIONS-005** `@regression`
...
✅ **MIGRATION-MODIFY-REQUIRED-005** `@regression`
...
✅ **MIGRATION-MODIFY-TYPE-007** `@regression`
...
✅ **MIGRATION-MODIFY-FIELD-UNIQUE-004** `@regression`
...
✅ **MIGRATION-MODIFY-INDEX-007** `@regression`
...
✅ **MIGRATION-MODIFY-UNIQUE-006** `@regression`
...
✅ **MIGRATION-ALTER-REMOVE-005** `@regression`
...
✅ **MIGRATION-ALTER-RENAME-005** `@regression`
...
✅ **MIGRATION-RENAME-TABLE-005** `@regression`
