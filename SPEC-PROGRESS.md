...
> Generated: 2026-01-30T08:10:39.222Z
>
...
| -------------------- | -------------------------------------------- | ------------------ |
| **Overall Progress** | [██████████████████░░] 91% (2040/2237 tests) | 🟡 Needs Attention |
...
<details>
<summary>View API specs (69 files, 413/610 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (42%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**11/26** passing | 15 fixme | 25 @spec | 1 @regression
