...
> Generated: 2026-01-23T14:29:24.926Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1956/2252 tests) | 🟡 Needs Attention |
...
- **296 tests remaining** - TDD automation running
...
| Spec ID                                  | Date             | Commit    |
| ---------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-004`          | 2026-01-23 15:28 | `74ec82f` |
| `API-TABLES-RECORDS-CREATE-003`          | 2026-01-23 13:13 | `9754875` |
...
🟡 **67 files** | **625 tests** | [███████████░░░░░░░░░] 53% | In Progress

<details>
<summary>View API specs (67 files, 329/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (28%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**5/18** passing | 13 fixme | 17 @spec | 1 @regression
