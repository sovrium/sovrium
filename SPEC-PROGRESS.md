...
> Generated: 2026-02-15T04:16:46.868Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2152/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.1 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 11 specs/day to hit ETA (current: 12.1)
- **97 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 254                   |
| 🤖 Fixed by TDD Pipeline | 187                   |
| 👤 Fixed Manually        | 67                    |
| Fixed Last 24h           | 12                    |
| Fixed Last 7d            | 57                    |
| Fixed Last 30d           | 254                   |
...
<details>
<summary>View API specs (67 files, 538/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > post (21%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**3/14** passing | 11 fixme | 13 @spec | 1 @regression
