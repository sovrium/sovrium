...
> Generated: 2026-01-23T10:37:58.977Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1953/2252 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 5.97 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2026-03-15 (~2 months)                       | 🟡 Needs Attention |
...
- **Maintain velocity** - Need 6 specs/day to hit ETA (current: 5.97)
- **299 tests remaining** - TDD automation running
...
| Metric                | Value                  |
| --------------------- | ---------------------- |
| Tests Fixed (90 days) | 1779                   |
| Fixed Last 24h        | 1                      |
| Fixed Last 7d         | 17                     |
| Fixed Last 30d        | 179                    |
| Avg Fixes/Day         | 5.97                   |
| Remaining             | 299                    |
| ETA                   | ~2 months (2026-03-15) |
...
| Spec ID                                  | Date             | Commit    |
| ---------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-001`          | 2026-01-23 11:37 | `44f5111` |
...
🟡 **67 files** | **625 tests** | [██████████░░░░░░░░░░] 52% | In Progress

<details>
<summary>View API specs (67 files, 326/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (11%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**2/18** passing | 16 fixme | 17 @spec | 1 @regression
