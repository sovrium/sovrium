...
> Generated: 2025-12-27T00:44:26.732Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [██████████████░░░░░░] 69% (1788/2598 tests) | 🔴 Blocked   |
| **Daily Velocity**       | 26.77 specs/day                              | 🟢 Healthy   |
...
- ❌ **HEADER_COUNT_MISMATCH** in `api/auth/tables/role-based-access.spec.ts`

### 📋 Priority 3 - Ongoing

- **Maintain velocity** - Need 27 specs/day to hit ETA (current: 26.77)
- **810 tests remaining** - TDD automation running
...
- **HEADER_COUNT_MISMATCH** in `api/auth/tables/role-based-access.spec.ts`
  Header "Spec Count: 13" does not match actual @spec count: 12

## 📁 Feature Breakdown

### API

🔴 **113 files** | **957 tests** | [███░░░░░░░░░░░░░░░░░] 15% | Early Stage

<details>
<summary>View API specs (113 files, 147/957 passing)</summary>
