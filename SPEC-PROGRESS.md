...
> Generated: 2026-01-24T05:20:59.326Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1969/2252 tests) | 🟡 Needs Attention |
...
- **283 tests remaining** - TDD automation running
...
| Spec ID                               | Date             | Commit    |
| ------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-DELETE-005`       | 2026-01-24 06:20 | `df3acdc` |
...
<details>
<summary>View API specs (67 files, 342/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > delete (32%)

📁 `api/tables/{tableId}/records/{recordId}/delete.spec.ts`

**Delete record**

**6/19** passing | 13 fixme | 18 @spec | 1 @regression
