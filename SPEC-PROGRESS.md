...
> Generated: 2026-01-31T10:16:27.254Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 91% (2046/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 0.03 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2042-05-07 (~198 months)                     | 🟡 Needs Attention |
...
- **198 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (69 files, 419/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (62%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**16/26** passing | 10 fixme | 25 @spec | 1 @regression
