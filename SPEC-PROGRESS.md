...
> Generated: 2026-02-16T21:15:27.423Z
>
...
| ------------------------ | -------------------------------------------- | -------------- |
| **Overall Progress**     | [████████████████████] 99% (2236/2270 tests) | 🟡 Progressing |
| **Daily Velocity**       | 15.1 specs/day                               | 🟡 Moderate    |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 15.1)
- **34 tests remaining** - TDD automation running
...
| Metric                   | Value                |
| ------------------------ | -------------------- |
| Tests Fixed (30 days)    | 302                  |
| 🤖 Fixed by TDD Pipeline | 238                  |
| 👤 Fixed Manually        | 64                   |
| Fixed Last 24h           | 41                   |
| Fixed Last 7d            | 115                  |
| Fixed Last 30d           | 302                  |
...
| ---------------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-RECORDS-AUTHORSHIP-018`      | 2026-02-16 22:05 | `a5f96f9` | 🤖 TDD    |
...
🟡 **67 files** | **627 tests** | [███████████████████░] 95% | Almost Done

<details>
<summary>View API specs (67 files, 593/627 passing)</summary>
...
#### 🚧 tables > {tableId} > records > authorship-metadata (91%)

📁 `api/tables/{tableId}/records/authorship-metadata.spec.ts`

**Record Authorship Metadata**

**21/23** passing | 2 fixme | 22 @spec | 1 @regression
