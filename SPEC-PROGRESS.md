...
> Generated: 2026-02-03T21:57:19.766Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 95% (2127/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 6.3 specs/day                                | 🔴 Slow            |
...
- **Maintain velocity** - Need 7 specs/day to hit ETA (current: 6.3)
- **117 tests remaining** - TDD automation running
...
| ---------------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-VIEW-RECORDS-002`            | 2026-02-03 22:47 | `81dae8c` | 🤖 TDD    |
...
<details>
<summary>View API specs (69 files, 500/617 passing)</summary>
...
#### 🚧 tables > {tableId} > views > {viewId} > records > get (25%)
