...
> Generated: 2026-01-24T08:38:03.579Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1970/2252 tests) | 🟡 Needs Attention |
...
- **282 tests remaining** - TDD automation running
...
| Spec ID                             | Date             | Commit    |
| ----------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-DELETE-007`     | 2026-01-24 09:37 | `b029938` |
...
<details>
<summary>View API specs (67 files, 343/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > delete (37%)

📁 `api/tables/{tableId}/records/{recordId}/delete.spec.ts`

**Delete record**

**7/19** passing | 12 fixme | 18 @spec | 1 @regression
