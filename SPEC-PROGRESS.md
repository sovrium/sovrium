...
> Generated: 2026-01-25T11:47:35.699Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 89% (1973/2225 tests) | 🟡 Needs Attention |
...
- **252 tests remaining** - TDD automation running
...
| Spec ID                               | Date             | Commit    |
| ------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-BATCH-DELETE-002` | 2026-01-25 12:39 | `0fbd99d` |
| `API-TABLES-RECORDS-LIST-001`         | 2026-01-25 12:39 | `910e4ce` |
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/delete.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-DELETE-005 and API-TABLES-RECORDS-DELETE-007)
...
🟡 **67 files** | **598 tests** | [████████████░░░░░░░░] 58% | In Progress

<details>
<summary>View API specs (67 files, 346/598 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (8%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**2/26** passing | 24 fixme | 25 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > {recordId} > delete (50%)

📁 `api/tables/{tableId}/records/{recordId}/delete.spec.ts`

**Delete record**

**8/16** passing | 8 fixme | 15 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > {recordId} > get (9%)
...
#### 🚧 tables > {tableId} > records > {recordId} > restore > post (11%)
