...
> Generated: 2026-01-23T15:15:48.628Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1958/2252 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 6.03 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 6 specs/day to hit ETA (current: 6.03)
- **294 tests remaining** - TDD automation running
...
| Spec ID                                  | Date             | Commit    |
| ---------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-007`          | 2026-01-23 16:15 | `aa6847f` |
| `API-TABLES-RECORDS-CREATE-006`          | 2026-01-23 15:53 | `bd03154` |
...
<details>
<summary>View API specs (67 files, 331/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (39%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**7/18** passing | 11 fixme | 17 @spec | 1 @regression
