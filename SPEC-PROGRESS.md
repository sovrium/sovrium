...
> Generated: 2025-12-27T14:46:57.301Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [███████████████░░░░░] 73% (1873/2570 tests) | 🟢 On Track  |
| **Daily Velocity**       | 28.33 specs/day                              | 🟢 Healthy   |
| **Quality Score**        | 92%                                          | 🟢 Excellent |
| **Estimated Completion** | 2026-01-21 (~4 weeks)                        | 🟢 On Track  |
...
- **Maintain velocity** - Need 28 specs/day to hit ETA (current: 28.33)
- **697 tests remaining** - TDD automation running
...
| Metric                | Value                 |
| --------------------- | --------------------- |
| Tests Fixed (90 days) | 1705                  |
| Fixed Last 24h        | 64                    |
| Fixed Last 7d         | 151                   |
| Fixed Last 30d        | 850                   |
| Avg Fixes/Day         | 28.33                 |
| Remaining             | 697                   |
| ETA                   | ~4 weeks (2026-01-21) |
...
| Spec ID                                 | Date             | Commit    |
| --------------------------------------- | ---------------- | --------- |
| `API-AUTH-ADMIN-STOP-IMPERSONATING-005` | 2025-12-27 15:46 | `03c16bd` |
| `API-AUTH-ADMIN-STOP-IMPERSONATING-004` | 2025-12-27 14:35 | `91b62f3` |
| `API-AUTH-ADMIN-STOP-IMPERSONATING-001` | 2025-12-27 14:25 | `8d2d8c8` |
| `API-AUTH-ADMIN-STOP-IMPERSONATING-003` | 2025-12-27 13:54 | `90911db` |
| `API-SECURITY-XSS-003`                  | 2025-12-27 13:49 | `b6c3be6` |
| `API-SECURITY-SESSION-001`              | 2025-12-27 13:49 | `c68dda5` |
| `API-SECURITY-SQLI-001`                 | 2025-12-27 13:49 | `28b96ce` |
| `API-SECURITY-HEADERS-006`              | 2025-12-27 13:49 | `c375ba8` |
| `API-ACTIVITY-LIST-002`                 | 2025-12-27 13:49 | `a1ab5af` |
| `API-TABLES-SESSION-CTX-INT-001`        | 2025-12-27 13:49 | `38971d2` |
| `API-TABLES-RECORDS-UPDATE-003`         | 2025-12-27 13:49 | `0f0e110` |
| `API-TABLES-RECORDS-RESTORE-004`        | 2025-12-27 13:49 | `39f3868` |
| `API-TABLES-RECORDS-LIST-013`           | 2025-12-27 13:49 | `5e0a744` |
| `API-TABLES-RECORDS-GET-003`            | 2025-12-27 13:49 | `287bceb` |
| `API-TABLES-RECORDS-CREATE-005`         | 2025-12-27 13:49 | `6330293` |
| `API-TABLES-PERMISSIONS-ORG-002`        | 2025-12-27 13:49 | `9104dff` |
| `API-TABLES-PERMISSIONS-INHERIT-005`    | 2025-12-27 13:49 | `dc9f991` |
| `API-TABLES-PERMISSIONS-CHECK-003`      | 2025-12-27 13:49 | `8cb291f` |
| `API-AUTH-ORG-TEAMS-SET-ACTIVE-004`     | 2025-12-27 13:49 | `dd517b3` |
| `API-AUTH-ORG-TEAMS-REMOVE-MEMBER-004`  | 2025-12-27 13:49 | `b0b4554` |
...
🟡 **111 files** | **929 tests** | [█████░░░░░░░░░░░░░░░] 25% | Early Stage

<details>
<summary>View API specs (111 files, 232/929 passing)</summary>
...
#### 🚧 auth > admin > impersonate-user > post (38%)
...
#### 🚧 auth > admin > stop-impersonating > post (86%)
...
✅ **API-AUTH-ADMIN-STOP-IMPERSONATING-006** `@spec`
API-AUTH-ADMIN-STOP-IMPERSONATING-006: should return 401 when not authenticated
`G/W/T` Line 250

⏸️ **API-AUTH-ADMIN-STOP-IMPERSONATING-007** `@regression`
...
#### 🚧 auth > organization > set-active-organization > post (50%)
...
✅ **API-AUTH-ORG-TEAMS-LIST-MEMBERS-004** `@spec`
...
#### 🚧 auth > organization > teams > remove-team-member > delete (14%)
...
✅ **API-AUTH-ORG-TEAMS-REMOVE-MEMBER-004** `@spec`
...
✅ **API-AUTH-ORG-TEAMS-SET-ACTIVE-004** `@spec`
