...
> Generated: 2026-01-25T18:15:56.636Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 90% (1992/2225 tests) | 🟡 Needs Attention |
...
- **233 tests remaining** - TDD automation running
...
| Spec ID                               | Date             | Commit    |
| ------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-DELETE-014`       | 2026-01-25 19:15 | `cc0114b` |
...
<details>
<summary>View API specs (67 files, 365/598 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > delete (94%)
