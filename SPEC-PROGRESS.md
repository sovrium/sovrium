...
> Generated: 2026-01-30T09:26:32.503Z
>
...
| -------------------- | -------------------------------------------- | ------------------ |
| **Overall Progress** | [██████████████████░░] 91% (2041/2237 tests) | 🟡 Needs Attention |
...
<details>
<summary>View API specs (69 files, 414/610 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (46%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**12/26** passing | 14 fixme | 25 @spec | 1 @regression
