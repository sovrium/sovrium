...
> Generated: 2025-12-24T16:02:56.450Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [█████████████░░░░░░░] 67% (1782/2661 tests) | 🔴 Blocked   |
| **Daily Velocity**       | 26.07 specs/day                              | 🟢 Healthy   |
| **Quality Score**        | 92%                                          | 🟢 Excellent |
| **Estimated Completion** | 2026-01-27 (~2 months)                       | 🔴 Blocked   |
| **Blockers**             | 1 errors, 0 warnings                         | 🔴 Blocked   |
...
- ❌ **HEADER_COUNT_MISMATCH** in `api/auth/enforcement/admin-enforcement.spec.ts`
...
- **HEADER_COUNT_MISMATCH** in `api/auth/enforcement/admin-enforcement.spec.ts`
  Header "Spec Count: 10" does not match actual @spec count: 8
