...
> Generated: 2026-02-15T15:28:42.140Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2164/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 13 specs/day                                 | 🔴 Slow            |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 13)
- **85 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 260                   |
| 🤖 Fixed by TDD Pipeline | 200                   |
| 👤 Fixed Manually        | 60                    |
| Fixed Last 24h           | 22                    |
| Fixed Last 7d            | 70                    |
| Fixed Last 30d           | 260                   |
...
| ----------------------------------------- | ---------------- | --------- | ------ |
| `APP-TABLES-FIELD-TYPES-RELATIONSHIP-022` | 2026-02-15 16:24 | `97d2e0d` | 🤖 TDD |
...
<details>
<summary>View APP specs (128 files, 1450/1451 passing)</summary>
...
#### 🚧 tables > field-types > relationship-field (96%)

📁 `app/tables/field-types/relationship-field.spec.ts`

**Relationship Field**

**23/24** passing | 1 fixme | 23 @spec | 1 @regression
...
✅ **APP-TABLES-FIELD-TYPES-RELATIONSHIP-022** `@spec`
