...
> Generated: 2026-01-31T18:24:43.847Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 91% (2048/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 0.03 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2042-03-08 (~196 months)                     | 🟡 Needs Attention |
...
- **196 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (69 files, 421/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (69%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**18/26** passing | 8 fixme | 25 @spec | 1 @regression
