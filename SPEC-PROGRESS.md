...
> Generated: 2026-02-12T09:26:15.202Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 94% (2113/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.42 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 12.42)
- **136 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 236                   |
| 🤖 Fixed by TDD Pipeline | 156                   |
| 👤 Fixed Manually        | 80                    |
| Fixed Last 24h           | 18                    |
| Fixed Last 7d            | 26                    |
| Fixed Last 30d           | 236                   |
...
<details>
<summary>View API specs (67 files, 499/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > post (27%)
