...
> Generated: 2026-02-01T18:44:44.769Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 92% (2071/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 0.03 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2040-04-18 (~173 months)                     | 🟡 Needs Attention |
...
- **173 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (69 files, 444/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > patch (31%)

📁 `api/tables/{tableId}/records/{recordId}/patch.spec.ts`

**Update record**

**5/16** passing | 11 fixme | 15 @spec | 1 @regression
