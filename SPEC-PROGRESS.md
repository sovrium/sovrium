...
> Generated: 2026-01-19T11:30:45.448Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████░░░░░] 75% (1948/2582 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 7.53 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 94%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2026-04-14 (~3 months)                       | 🟡 Needs Attention |
...
- **Maintain velocity** - Need 8 specs/day to hit ETA (current: 7.53)
- **634 tests remaining** - TDD automation running
- **Quality gate** - Keep quality score above 85% (current: 94%)
...
| Metric                | Value                  |
| --------------------- | ---------------------- |
| Tests Fixed (90 days) | 1778                   |
| Fixed Last 24h        | 11                     |
| Fixed Last 7d         | 36                     |
| Fixed Last 30d        | 226                    |
| Avg Fixes/Day         | 7.53                   |
| Remaining             | 634                    |
| ETA                   | ~3 months (2026-04-14) |
...
| Spec ID                                  | Date             | Commit    |
| ---------------------------------------- | ---------------- | --------- |
| `API-AUTH-MAGIC-LINK-VERIFY-005`         | 2026-01-19 09:30 | `bc77ee7` |
| `API-AUTH-ORG-TEAMS-SET-ACTIVE-006`      | 2026-01-19 09:30 | `9089cb5` |
| `API-AUTH-ORG-TEAMS-LIST-MEMBERS-006`    | 2026-01-19 09:30 | `a38fb17` |
| `API-ACTIVITY-RECORD-HISTORY-002`        | 2026-01-19 09:30 | `78a6cd6` |
| `API-TABLES-RECORDS-BATCH-PATCH-004`     | 2026-01-19 09:30 | `ed76c34` |
| `API-TABLES-RECORDS-BATCH-POST-004`      | 2026-01-19 09:30 | `14ce48d` |
| `API-TABLES-RECORDS-COMMENTS-LIST-003`   | 2026-01-19 09:30 | `8513958` |
| `API-TABLES-RECORDS-BATCH-DELETE-004`    | 2026-01-19 09:30 | `5edac3a` |
| `API-TABLES-RECORDS-COMMENTS-CREATE-005` | 2026-01-19 09:30 | `a54e44f` |
| `API-TABLES-RECORDS-UPSERT-004`          | 2026-01-19 09:30 | `30a9ccb` |
| `API-TABLES-TRASH-002`                   | 2026-01-19 09:30 | `4d6e894` |
| `API-TABLES-PERMISSIONS-RECORD-003`      | 2026-01-17 09:37 | `be4bbc8` |
| `API-TABLES-PERMISSIONS-RECORD-002`      | 2026-01-17 02:49 | `398e1e2` |
| `API-TABLES-PERMISSIONS-RECORD-001`      | 2026-01-17 01:17 | `f4a3981` |
| `API-TABLES-PERMISSIONS-ORG-006`         | 2026-01-16 15:38 | `34928ed` |
| `API-TABLES-PERMISSIONS-ORG-005`         | 2026-01-16 12:13 | `b03564f` |
| `API-TABLES-PERMISSIONS-ORG-003`         | 2026-01-16 11:05 | `bdcd27a` |
| `API-TABLES-PERMISSIONS-CHECK-006`       | 2026-01-16 10:23 | `1ab0be2` |
| `API-TABLES-PERMISSIONS-CHECK-005`       | 2026-01-16 09:37 | `1e7285a` |
| `API-TABLES-PERMISSIONS-CHECK-004`       | 2026-01-16 09:17 | `d1d87ca` |
...
🟡 **112 files** | **941 tests** | [███████░░░░░░░░░░░░░] 33% | Early Stage

<details>
<summary>View API specs (112 files, 307/941 passing)</summary>
...
#### 🚧 auth > admin > bootstrap > admin-bootstrap (0%)
...
#### 🚧 auth > organization > teams > list-team-members > get (14%)
...
✅ **API-AUTH-ORG-TEAMS-LIST-MEMBERS-006** `@spec`
...
#### 🚧 auth > organization > teams > set-active-team > post (14%)
...
✅ **API-AUTH-ORG-TEAMS-SET-ACTIVE-006** `@spec`
...
#### ✅ tables > permissions > api-complex-conditions (100%)
...
#### ✅ tables > permissions > api-organization-isolation (100%)
...
✅ **API-TABLES-PERMISSIONS-ORG-001** `@spec`
...
✅ **API-TABLES-PERMISSIONS-ORG-REGRESSION** `@regression`
...
#### 🚧 tables > permissions > api-record-permissions (38%)
...
#### 🚧 tables > session-context-integration (38%)
...
#### 🚧 tables > {tableId} > records > batch > delete (7%)
...
#### 🚧 tables > {tableId} > records > batch > patch (6%)

📁 `api/tables/{tableId}/records/batch/patch.spec.ts`

**Batch update records**

**1/16** passing | 15 fixme | 15 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > batch > post (6%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**1/17** passing | 16 fixme | 16 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > upsert > post (6%)
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > get (8%)

📁 `api/tables/{tableId}/records/{recordId}/comments/get.spec.ts`

**List comments on a record**

**1/12** passing | 11 fixme | 11 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > post (8%)
...
#### 🚧 tables > {tableId} > records > {recordId} > history > get (25%)
...
**3/12** passing | 9 fixme | 11 @spec | 1 @regression
...
✅ **API-ACTIVITY-RECORD-HISTORY-011** `@spec`
