...
> Generated: 2026-02-03T21:13:58.428Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 95% (2126/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 6.27 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 7 specs/day to hit ETA (current: 6.27)
- **118 tests remaining** - TDD automation running
...
| ---------------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-VIEW-RECORDS-001`            | 2026-02-03 22:04 | `4de059e` | 🤖 TDD    |
...
<details>
<summary>View API specs (69 files, 499/617 passing)</summary>
...
#### 🚧 tables > {tableId} > views > {viewId} > records > get (13%)
