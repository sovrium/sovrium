...
> Generated: 2026-01-30T22:06:20.941Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 91% (2043/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 3.77 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2026-03-25 (~2 months)                       | 🟡 Needs Attention |
...
- **Maintain velocity** - Need 4 specs/day to hit ETA (current: 3.77)
- **201 tests remaining** - TDD automation running
...
| Metric                   | Value                  |
| ------------------------ | ---------------------- |
| Tests Fixed (90 days)    | 1843                   |
| 🤖 Fixed by TDD Pipeline | 18                     |
| 👤 Fixed Manually        | 1825                   |
| Fixed Last 24h           | 11                     |
| Fixed Last 7d            | 66                     |
| Fixed Last 30d           | 113                    |
...
| ------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-RECORDS-LIST-006`   | 2026-01-30 10:31 | `06c4f91` | 👤 Manual |
| `API-TABLES-RECORDS-LIST-005`   | 2026-01-30 10:17 | `d0fcd20` | 🤖 TDD    |
| `API-TABLES-RECORDS-LIST-004`   | 2026-01-30 09:01 | `42ab322` | 🤖 TDD    |
| `API-TABLES-RECORDS-LIST-002`   | 2026-01-30 08:24 | `8b83f7a` | 🤖 TDD    |
| `API-TABLES-RECORDS-GET-010`    | 2026-01-30 06:11 | `f4050fb` | 👤 Manual |
| `API-TABLES-RECORDS-GET-009`    | 2026-01-30 05:56 | `fa353f7` | 🤖 TDD    |
| `API-TABLES-RECORDS-GET-008`    | 2026-01-30 03:04 | `211f6c2` | 🤖 TDD    |
| `API-TABLES-RECORDS-GET-007`    | 2026-01-30 02:26 | `7c90598` | 🤖 TDD    |
| `API-TABLES-RECORDS-GET-006`    | 2026-01-30 01:38 | `3cd16b9` | 🤖 TDD    |
| `API-TABLES-RECORDS-GET-005`    | 2026-01-30 01:08 | `ab33b42` | 🤖 TDD    |
| `API-TABLES-RECORDS-GET-005`    | 2026-01-29 23:48 | `e11295c` | 👤 Manual |
| `API-TABLES-RECORDS-GET-005`    | 2026-01-29 17:49 | `a806c77` | 👤 Manual |
| `API-TABLES-RECORDS-GET-005`    | 2026-01-29 17:21 | `e0f6b9f` | 👤 Manual |
| `API-TABLES-RECORDS-GET-005`    | 2026-01-29 17:03 | `01b995a` | 👤 Manual |
| `API-TABLES-RECORDS-GET-004`    | 2026-01-29 04:42 | `97062c0` | 🤖 TDD    |
| `API-TABLES-RECORDS-GET-001`    | 2026-01-29 04:00 | `85da594` | 🤖 TDD    |
| `API-TABLES-RECORDS-FORMAT-024` | 2026-01-29 02:25 | `03d600f` | 👤 Manual |
| `API-TABLES-RECORDS-FORMAT-023` | 2026-01-29 02:11 | `a222c4f` | 🤖 TDD    |
| `API-TABLES-RECORDS-FORMAT-022` | 2026-01-29 01:29 | `155050d` | 👤 Manual |
| `API-TABLES-RECORDS-FORMAT-021` | 2026-01-29 01:16 | `2b68413` | 🤖 TDD    |
...
🟡 **69 files** | **617 tests** | [█████████████░░░░░░░] 67% | In Progress

<details>
<summary>View API specs (69 files, 416/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > format (96%)

📁 `api/tables/{tableId}/records/format.spec.ts`

**Record Display Formatting**

**24/25** passing | 1 fixme | 24 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > get (50%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**13/26** passing | 13 fixme | 25 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > {recordId} > get (91%)
...
#### 🚧 tables > {tableId} > records > {recordId} > restore > post (44%)
