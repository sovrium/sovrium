...
> Generated: 2026-02-12T09:41:03.228Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 94% (2114/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.47 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 12.47)
- **135 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 237                   |
| 🤖 Fixed by TDD Pipeline | 157                   |
| 👤 Fixed Manually        | 80                    |
| Fixed Last 24h           | 19                    |
| Fixed Last 7d            | 27                    |
| Fixed Last 30d           | 237                   |
...
<details>
<summary>View API specs (67 files, 500/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > post (36%)
