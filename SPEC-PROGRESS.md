...
> Generated: 2026-02-15T20:58:16.050Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2167/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 13.15 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 13.15)
- **82 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 263                   |
| 🤖 Fixed by TDD Pipeline | 203                   |
| 👤 Fixed Manually        | 60                    |
| Fixed Last 24h           | 21                    |
| Fixed Last 7d            | 73                    |
| Fixed Last 30d           | 263                   |
...
| ----------------------------------------- | ---------------- | --------- | ------ |
| `API-TABLES-RECORDS-UPSERT-011`           | 2026-02-15 21:48 | `7d3f979` | 🤖 TDD |
...
<details>
<summary>View API specs (67 files, 546/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > upsert > post (93%)

📁 `api/tables/{tableId}/records/upsert/post.spec.ts`

**Upsert records (create or update)**

**13/14** passing | 1 fixme | 13 @spec | 1 @regression
...
✅ **API-TABLES-RECORDS-UPSERT-011** `@spec`
