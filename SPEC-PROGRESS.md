...
> Generated: 2026-02-15T08:23:26.660Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2157/2249 tests) | 🟡 Needs Attention |
...
- **92 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 543/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > patch (71%)

📁 `api/tables/{tableId}/records/batch/patch.spec.ts`

**Batch update records**

**10/14** passing | 4 fixme | 13 @spec | 1 @regression
