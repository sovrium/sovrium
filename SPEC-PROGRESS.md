...
> Generated: 2026-01-25T09:54:34.728Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 89% (1971/2225 tests) | 🟡 Needs Attention |
...
- **254 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 344/598 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > delete (9%)
...
#### 🚧 tables > {tableId} > records > get (4%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**1/26** passing | 25 fixme | 25 @spec | 1 @regression
