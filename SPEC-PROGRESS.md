...
> Generated: 2026-01-30T07:33:48.335Z
>
...
| -------------------- | -------------------------------------------- | ------------------ |
| **Overall Progress** | [██████████████████░░] 91% (2039/2237 tests) | 🟡 Needs Attention |
...
<details>
<summary>View API specs (69 files, 412/610 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (38%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**10/26** passing | 16 fixme | 25 @spec | 1 @regression
