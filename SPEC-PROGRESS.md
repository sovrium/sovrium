...
> Generated: 2026-02-14T23:07:58.286Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 95% (2142/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.5 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 12.5)
- **107 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 250                   |
| 🤖 Fixed by TDD Pipeline | 183                   |
| 👤 Fixed Manually        | 67                    |
| Fixed Last 24h           | 8                     |
| Fixed Last 7d            | 53                    |
| Fixed Last 30d           | 250                   |
...
| ---------------------------------------- | ---------------- | --------- | ------ |
| `API-TABLES-RECORDS-BATCH-DELETE-005`    | 2026-02-14 23:58 | `ab746df` | 🤖 TDD |
...
<details>
<summary>View API specs (67 files, 528/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > delete (55%)
...
✅ **API-TABLES-RECORDS-BATCH-DELETE-005** `@spec`
