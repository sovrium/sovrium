...
> Generated: 2026-01-23T10:58:03.460Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1954/2252 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 5.97 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2026-03-14 (~2 months)                       | 🟡 Needs Attention |
...
- **298 tests remaining** - TDD automation running
...
| Metric                | Value                  |
| --------------------- | ---------------------- |
| Tests Fixed (90 days) | 1780                   |
| Fixed Last 24h        | 2                      |
| Fixed Last 7d         | 18                     |
| Fixed Last 30d        | 179                    |
| Avg Fixes/Day         | 5.97                   |
| Remaining             | 298                    |
| ETA                   | ~2 months (2026-03-14) |
...
| Spec ID                                  | Date             | Commit    |
| ---------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-002`          | 2026-01-23 11:57 | `93fa720` |
...
<details>
<summary>View API specs (67 files, 327/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (17%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**3/18** passing | 15 fixme | 17 @spec | 1 @regression
