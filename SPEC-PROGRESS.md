...
> Generated: 2026-02-02T08:13:41.490Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 93% (2084/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 5.07 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2026-03-06 (~2 months)                       | 🟡 Needs Attention |
...
- **Maintain velocity** - Need 5 specs/day to hit ETA (current: 5.07)
...
🟡 **69 files** | **617 tests** | [███████████████░░░░░] 74% | In Progress

<details>
<summary>View API specs (69 files, 457/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > patch (69%)

📁 `api/tables/{tableId}/records/{recordId}/patch.spec.ts`

**Update record**

**11/16** passing | 5 fixme | 15 @spec | 1 @regression
