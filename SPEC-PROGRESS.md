...
> Generated: 2026-02-01T23:38:49.182Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 92% (2073/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 4.7 specs/day                                | 🔴 Slow            |
...
- **Maintain velocity** - Need 5 specs/day to hit ETA (current: 4.7)
- **171 tests remaining** - TDD automation running
...
| -------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-RECORDS-UPDATE-006`  | 2026-02-02 00:29 | `51cdcfd` | 🤖 TDD    |
| `API-TABLES-RECORDS-UPSERT-005`  | 2026-02-01 22:58 | `a194879` | 🤖 TDD    |
| `API-TABLES-RECORDS-UPDATE-005`  | 2026-02-01 19:35 | `663c332` | 🤖 TDD    |
| `API-TABLES-TRASH-004`           | 2026-02-01 18:48 | `1dc4f77` | 🤖 TDD    |
| `API-TABLES-RECORDS-UPDATE-004`  | 2026-02-01 17:42 | `6bdf36f` | 🤖 TDD    |
| `API-TABLES-TRASH-003`           | 2026-02-01 16:03 | `8c24056` | 🤖 TDD    |
...
🟡 **69 files** | **617 tests** | [██████████████░░░░░░] 72% | In Progress

<details>
<summary>View API specs (69 files, 446/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > upsert > post (36%)
...
#### 🚧 tables > {tableId} > records > {recordId} > patch (38%)

📁 `api/tables/{tableId}/records/{recordId}/patch.spec.ts`

**Update record**

**6/16** passing | 10 fixme | 15 @spec | 1 @regression
