...
> Generated: 2026-02-12T09:56:06.663Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 94% (2115/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.53 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 12.53)
- **134 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 238                   |
| 🤖 Fixed by TDD Pipeline | 158                   |
| 👤 Fixed Manually        | 80                    |
| Fixed Last 24h           | 20                    |
| Fixed Last 7d            | 28                    |
| Fixed Last 30d           | 238                   |
...
🟡 **67 files** | **628 tests** | [████████████████░░░░] 80% | Almost Done

<details>
<summary>View API specs (67 files, 501/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > post (45%)
