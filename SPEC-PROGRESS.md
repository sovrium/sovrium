...
> Generated: 2025-12-27T08:42:03.277Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [██████████████░░░░░░] 69% (1784/2577 tests) | 🔴 Blocked   |
| **Daily Velocity**       | 26.73 specs/day                              | 🟢 Healthy   |
| **Quality Score**        | 92%                                          | 🟢 Excellent |
| **Estimated Completion** | 2026-01-26 (~1 months)                       | 🔴 Blocked   |
| **Blockers**             | 4 errors, 0 warnings                         | 🔴 Blocked   |
...
- ❌ **HEADER_COUNT_MISMATCH** in `api/auth/admin/options/default-role.spec.ts`
...
- **Maintain velocity** - Need 27 specs/day to hit ETA (current: 26.73)
- **793 tests remaining** - TDD automation running
...
| Metric                | Value                  |
| --------------------- | ---------------------- |
| Tests Fixed (90 days) | 1656                   |
| Fixed Last 24h        | 21                     |
| Fixed Last 7d         | 107                    |
| Fixed Last 30d        | 802                    |
| Avg Fixes/Day         | 26.73                  |
| Remaining             | 793                    |
| ETA                   | ~1 months (2026-01-26) |
...
| Spec ID                               | Date             | Commit    |
| ------------------------------------- | ---------------- | --------- |
| `API-AUTH-ADMIN-OPT-LIST-001`         | 2025-12-27 03:21 | `74c611c` |
| `API-AUTH-ADMIN-OPT-FIRST-USER-003`   | 2025-12-27 00:56 | `c0f7983` |
...
| `APP-TABLES-FIELD-PERMISSIONS-009`    | 2025-12-26 22:43 | `4d14222` |
| `API-AUTH-ENFORCE-SESSION-007`        | 2025-12-26 22:23 | `033c5fb` |
| `API-AUTH-ENFORCE-AUTHZ-008`          | 2025-12-26 22:10 | `5400995` |
...
- **HEADER_COUNT_MISMATCH** in `api/auth/admin/options/default-role.spec.ts`
  Header "Spec Count: 3" does not match actual @spec count: 2
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/creator-role.spec.ts`
  Header "Spec Count: 3" does not match actual @spec count: 2
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/leave-organization.spec.ts`
  Header "Spec Count: 4" does not match actual @spec count: 3
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/org-slug.spec.ts`
  Header "Spec Count: 4" does not match actual @spec count: 3
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/options/default-role.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-OPT-DEFAULT-ROLE-001 and API-AUTH-ADMIN-OPT-DEFAULT-ROLE-004)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/options/creator-role.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-OPT-CREATOR-001 and API-AUTH-ORG-OPT-CREATOR-003)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/options/leave-organization.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-OPT-LEAVE-001 and API-AUTH-ORG-OPT-LEAVE-003)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/options/org-slug.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-OPT-SLUG-001 and API-AUTH-ORG-OPT-SLUG-003)
...
🔴 **112 files** | **936 tests** | [███░░░░░░░░░░░░░░░░░] 15% | Early Stage

<details>
<summary>View API specs (112 files, 143/936 passing)</summary>
...
✅ **API-AUTH-REVOKE-SESSION-006** `@regression`
...
#### 🚧 auth > tables > role-based-access (0%)
...
⏸️ **API-AUTH-TABLES-ROLE-005** `@spec`
...
⏸️ **API-AUTH-TABLES-ROLE-010** `@spec`
...
⏸️ **API-AUTH-TABLES-ROLE-013** `@regression`
