...
> Generated: 2026-01-23T22:35:08.137Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1964/2252 tests) | 🟡 Needs Attention |
...
- **288 tests remaining** - TDD automation running
...
| Spec ID                                | Date             | Commit    |
| -------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-013`        | 2026-01-23 23:34 | `277df52` |
...
<details>
<summary>View API specs (67 files, 337/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (72%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**13/18** passing | 5 fixme | 17 @spec | 1 @regression
