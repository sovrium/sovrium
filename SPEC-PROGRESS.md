...
> Generated: 2026-02-14T16:11:32.314Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 95% (2138/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.3 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 12.3)
- **111 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 246                   |
| 🤖 Fixed by TDD Pipeline | 179                   |
| 👤 Fixed Manually        | 67                    |
| Fixed Last 24h           | 4                     |
| Fixed Last 7d            | 49                    |
| Fixed Last 30d           | 246                   |
...
<details>
<summary>View API specs (67 files, 524/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > authorship-metadata (8%)

📁 `api/tables/{tableId}/records/authorship-metadata.spec.ts`

**Record Authorship Metadata**

**2/24** passing | 22 fixme | 23 @spec | 1 @regression
