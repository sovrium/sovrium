...
> Generated: 2026-02-14T18:11:34.214Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 95% (2140/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.4 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 96%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2026-02-23 (~2 weeks)                        | 🟡 Needs Attention |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 12.4)
- **109 tests remaining** - TDD automation running
- **Quality gate** - Keep quality score above 85% (current: 96%)
...
| 🟢 Specified & Implemented    | 246   | 91%        |
| 🟡 Specified, Not Implemented | 22    | 8%         |
...
- **US-RECORDS-UPSERT-001**: Upsert Single Record
  ...
  - File: `docs/user-stories/as-developer/records-api/upsert-records.md`
- **US-TABLES-RELATIONSHIPS-004**: Self-Referencing Relationships
  - Spec IDs: `APP-TABLES-FIELD-TYPES-RELATIONSHIP-014`, `APP-TABLES-FIELD-TYPES-RELATIONSHIP-015`, `APP-TABLES-FIELD-TYPES-RELATIONSHIP-016`, `APP-TABLES-FIELD-TYPES-RELATIONSHIP-017`, `APP-TABLES-FIELD-TYPES-RELATIONSHIP-018`
  - File: `docs/user-stories/as-developer/tables/relationships.md`
- ... and 2 more
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 248                   |
| 🤖 Fixed by TDD Pipeline | 181                   |
| 👤 Fixed Manually        | 67                    |
| Fixed Last 24h           | 6                     |
| Fixed Last 7d            | 51                    |
| Fixed Last 30d           | 248                   |
...
| ---------------------------------------- | ---------------- | --------- | ------ |
| `API-TABLES-RECORDS-AUTHORSHIP-004`      | 2026-02-14 19:02 | `a2e6243` | 🤖 TDD |
| `API-TABLES-RECORDS-AUTHORSHIP-003`      | 2026-02-14 17:17 | `9804092` | 🤖 TDD |
| `API-TABLES-RECORDS-AUTHORSHIP-002`      | 2026-02-14 17:01 | `e2c4284` | 🤖 TDD |
| `API-ACTIVITY-RECORD-HISTORY-001`        | 2026-02-14 14:07 | `b81369c` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-POST-001`      | 2026-02-14 13:32 | `3060aae` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-LIST-008`   | 2026-02-14 13:14 | `4919041` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-LIST-007`   | 2026-02-13 00:14 | `1785c5e` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-LIST-006`   | 2026-02-12 23:43 | `cd2447b` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-009` | 2026-02-12 18:12 | `cfe4cd9` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-008` | 2026-02-12 17:58 | `ef5b3da` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-007` | 2026-02-12 17:46 | `0baabce` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-006` | 2026-02-12 17:35 | `dca8af3` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-005` | 2026-02-12 17:18 | `81cc019` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-004` | 2026-02-12 17:06 | `41586e9` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-003` | 2026-02-12 16:57 | `06485c2` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-002` | 2026-02-12 16:16 | `174e006` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-DELETE-001` | 2026-02-12 15:59 | `7c7c772` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-DELETE-003`    | 2026-02-12 13:41 | `0ebc5e6` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-CREATE-010` | 2026-02-12 12:55 | `a7d1e0a` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-CREATE-009` | 2026-02-12 12:39 | `11d9bb3` | 🤖 TDD |
...
🟡 **67 files** | **628 tests** | [█████████████████░░░] 84% | Almost Done

<details>
<summary>View API specs (67 files, 526/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > delete (45%)

📁 `api/tables/{tableId}/records/batch/delete.spec.ts`

**Batch delete records**

**5/11** passing | 6 fixme | 10 @spec | 1 @regression
...
✅ **API-TABLES-RECORDS-BATCH-DELETE-003** `@spec`
...
#### 🚧 tables > {tableId} > records > batch > post (14%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**2/14** passing | 12 fixme | 13 @spec | 1 @regression

<details>
<summary>Tests</summary>

✅ **API-TABLES-RECORDS-BATCH-POST-001** `@spec`
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > get (82%)

📁 `api/tables/{tableId}/records/{recordId}/comments/get.spec.ts`

**List comments on a record**

**9/11** passing | 2 fixme | 10 @spec | 1 @regression
...
#### ✅ tables > {tableId} > records > {recordId} > comments > post (100%)
...
#### 🚧 tables > {tableId} > records > {recordId} > history > get (36%)
...
✅ **API-ACTIVITY-RECORD-HISTORY-001** `@spec`
...
✅ **API-TABLES-TRASH-REGRESSION** `@regression`
...
🟢 **128 files** | **1451 tests** | [████████████████████] 100% | Complete

<details>
<summary>View APP specs (128 files, 1444/1451 passing)</summary>
...
#### 🚧 tables > field-types > relationship-field (71%)

📁 `app/tables/field-types/relationship-field.spec.ts`

**Relationship Field**

**17/24** passing | 7 fixme | 23 @spec | 1 @regression
...
#### ✅ tables > permissions > permission-inheritance (100%)
