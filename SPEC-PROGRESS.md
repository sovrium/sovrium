...
> Generated: 2026-01-31T15:18:56.146Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 91% (2047/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 0.03 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2042-04-07 (~197 months)                     | 🟡 Needs Attention |
...
- **197 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (69 files, 420/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > get (65%)

📁 `api/tables/{tableId}/records/get.spec.ts`

**List records in table**

**17/26** passing | 9 fixme | 25 @spec | 1 @regression
