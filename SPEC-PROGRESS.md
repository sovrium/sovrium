...
> Generated: 2025-12-28T22:27:50.109Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [███████████████░░░░░] 73% (1875/2568 tests) | 🟢 On Track  |
| **Daily Velocity**       | 27.23 specs/day                              | 🟢 Healthy   |
...
- **Maintain velocity** - Need 27 specs/day to hit ETA (current: 27.23)
- **693 tests remaining** - TDD automation running
...
| Spec ID                                    | Date             | Commit    |
| ------------------------------------------ | ---------------- | --------- |
| `API-TABLES-DISABLED-002`                  | 2025-12-28 23:27 | `5bffa29` |
...
<details>
<summary>View API specs (111 files, 234/927 passing)</summary>
...
#### 🚧 tables > disabled-tables (40%)

📁 `api/tables/disabled-tables.spec.ts`

**Disabled Tables Endpoints**

**2/5** passing | 3 fixme | 4 @spec | 1 @regression
