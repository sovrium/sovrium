...
> Generated: 2026-02-14T18:51:08.833Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 95% (2141/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.45 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 12.45)
- **108 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 249                   |
| 🤖 Fixed by TDD Pipeline | 182                   |
| 👤 Fixed Manually        | 67                    |
| Fixed Last 24h           | 7                     |
| Fixed Last 7d            | 52                    |
| Fixed Last 30d           | 249                   |
...
| ---------------------------------------- | ---------------- | --------- | ------ |
| `API-TABLES-RECORDS-AUTHORSHIP-005`      | 2026-02-14 19:41 | `6fdfb8f` | 🤖 TDD |
...
<details>
<summary>View API specs (67 files, 527/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > authorship-metadata (21%)

📁 `api/tables/{tableId}/records/authorship-metadata.spec.ts`

**Record Authorship Metadata**

**5/24** passing | 19 fixme | 23 @spec | 1 @regression
...
✅ **API-TABLES-RECORDS-AUTHORSHIP-005** `@spec`
