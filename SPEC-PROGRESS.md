...
> Generated: 2026-01-25T13:42:40.626Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 89% (1975/2225 tests) | 🟡 Needs Attention |
...
- **250 tests remaining** - TDD automation running
...
| Spec ID                               | Date             | Commit    |
| ------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-DELETE-011`       | 2026-01-25 14:42 | `53ce37c` |
| `API-TABLES-RECORDS-DELETE-010`       | 2026-01-25 14:04 | `0d8bedb` |
...
<details>
<summary>View API specs (67 files, 348/598 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > delete (63%)

📁 `api/tables/{tableId}/records/{recordId}/delete.spec.ts`

**Delete record**

**10/16** passing | 6 fixme | 15 @spec | 1 @regression
