...
> Generated: 2026-01-24T04:31:16.984Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1967/2252 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 5.93 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 6 specs/day to hit ETA (current: 5.93)
- **285 tests remaining** - TDD automation running
...
| Spec ID                               | Date             | Commit    |
| ------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-017`       | 2026-01-24 05:30 | `0ca087a` |
...
<details>
<summary>View API specs (67 files, 340/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (89%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**16/18** passing | 2 fixme | 17 @spec | 1 @regression
...
✅ **API-TABLES-RECORDS-CREATE-017** `@spec`
