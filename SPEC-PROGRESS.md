...
> Generated: 2026-02-04T18:46:01.401Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [███████████████████░] 95% (2089/2197 tests) | 🔴 Blocked   |
| **Daily Velocity**       | 6.07 specs/day                               | 🔴 Slow      |
| **Quality Score**        | 96%                                          | 🟢 Excellent |
| **Estimated Completion** | 2026-02-22 (~3 weeks)                        | 🔴 Blocked   |
...
- ❌ **HEADER_COUNT_MISMATCH** in `api/tables/{tableId}/records/{recordId}/comments/get.spec.ts`
...
| `API-AUTH-ADMIN-BOOTSTRAP-001`           | `api/auth/admin/bootstrap/admin-bootstrap.spec.ts`            | 54   | API-AUTH-ADMIN-BOOTSTRAP-001: should create adm... |
| `API-AUTH-ADMIN-BOOTSTRAP-002`           | `api/auth/admin/bootstrap/admin-bootstrap.spec.ts`            | 93   | API-AUTH-ADMIN-BOOTSTRAP-002: should create adm... |
| `API-AUTH-ADMIN-BOOTSTRAP-003`           | `api/auth/admin/bootstrap/admin-bootstrap.spec.ts`            | 129  | API-AUTH-ADMIN-BOOTSTRAP-003: should allow admi... |
| `API-AUTH-ADMIN-BOOTSTRAP-004`           | `api/auth/admin/bootstrap/admin-bootstrap.spec.ts`            | 172  | API-AUTH-ADMIN-BOOTSTRAP-004: should not create... |

... and 2147 more orphaned spec IDs
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/comments/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-COMMENTS-LIST-005 and API-TABLES-RECORDS-COMMENTS-LIST-007)
...
**6/11** passing | 5 fixme | 9 @spec | 1 @regression
...
⏸️ **API-TABLES-RECORDS-COMMENTS-LIST-006**
