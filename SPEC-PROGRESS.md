...
> Generated: 2025-12-23T21:48:23.672Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [████████████░░░░░░░░] 62% (1799/2891 tests) | 🔴 Blocked   |
| **Daily Velocity**       | 26.67 specs/day                              | 🟢 Healthy   |
| **Quality Score**        | 91%                                          | 🟢 Excellent |
| **Estimated Completion** | 2026-02-02 (~2 months)                       | 🔴 Blocked   |
| **Blockers**             | 13 errors, 0 warnings                        | 🔴 Blocked   |
...
- [Feature Breakdown](#-feature-breakdown)
  - [API](#api) • 🔴 13% (151 files)
  - [APP](#app) • 🟢 100% (132 files)
  - [CLI](#cli) • 🟢 100% (9 files)
...
- ❌ **HEADER_COUNT_MISMATCH** in `api/auth/admin/impersonation/start.spec.ts`
- ❌ **HEADER_COUNT_MISMATCH** in `api/auth/admin/impersonation/stop.spec.ts`
- ❌ **HEADER_COUNT_MISMATCH** in `api/auth/admin/role-management/revoke-admin.spec.ts`
- ❌ **HEADER_COUNT_MISMATCH** in `api/auth/organization/dynamic-roles/delete-role/delete.spec.ts`
- ❌ **HEADER_COUNT_MISMATCH** in `api/auth/organization/dynamic-roles/list-roles/get.spec.ts`

### 📋 Priority 3 - Ongoing

- **Maintain velocity** - Need 27 specs/day to hit ETA (current: 26.67)
- **1092 tests remaining** - TDD automation running
...
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/dynamic-roles/list-roles/get.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/dynamic-roles/update-role/patch.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/allowed-domains.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/creator-role.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/invitation-expiry.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/leave-organization.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/member-limits.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/org-metadata.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
- **HEADER_COUNT_MISMATCH** in `api/auth/organization/options/org-slug.spec.ts`
  Header "Spec Count: 7" does not match actual @spec count: 6
...
🔴 **151 files** | **1249 tests** | [███░░░░░░░░░░░░░░░░░] 13% | Early Stage

<details>
<summary>View API specs (151 files, 157/1249 passing)</summary>
...
#### 🚧 auth > enforcement > admin-enforcement (22%)

📁 `api/auth/enforcement/admin-enforcement.spec.ts`

**Admin Permission Enforcement**

**2/9** passing | 7 fixme | 8 @spec | 1 @regression
...
⏸️ **API-AUTH-ENFORCE-AUTHZ-008** `@regression`
...
🟢 **132 files** | **1472 tests** | [████████████████████] 100% | Complete

<details>
<summary>View APP specs (132 files, 1472/1472 passing)</summary>
...
✅ **APP-TABLES-ORG-ISOLATION-010** `@regression`
...
✅ **APP-TABLES-RLS-ENFORCEMENT-012** `@regression`
