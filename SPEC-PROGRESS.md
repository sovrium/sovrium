...
> Generated: 2026-02-12T10:11:44.023Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 94% (2116/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.58 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 13 specs/day to hit ETA (current: 12.58)
- **133 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 239                   |
| 🤖 Fixed by TDD Pipeline | 159                   |
| 👤 Fixed Manually        | 80                    |
| Fixed Last 24h           | 21                    |
| Fixed Last 7d            | 29                    |
| Fixed Last 30d           | 239                   |
...
<details>
<summary>View API specs (67 files, 502/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > post (55%)
