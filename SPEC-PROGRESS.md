...
> Generated: 2026-01-24T09:02:34.184Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 88% (1971/2252 tests) | 🟡 Needs Attention |
...
- **281 tests remaining** - TDD automation running
...
| Spec ID                          | Date             | Commit    |
| -------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-DELETE-008`  | 2026-01-24 10:01 | `b80f516` |
...
<details>
<summary>View API specs (67 files, 344/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > delete (42%)

📁 `api/tables/{tableId}/records/{recordId}/delete.spec.ts`

**Delete record**

**8/19** passing | 11 fixme | 18 @spec | 1 @regression
