...
> Generated: 2026-01-13T19:36:18.219Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████░░░░░] 75% (1917/2568 tests) | 🟡 Needs Attention |
...
- **651 tests remaining** - TDD automation running
...
| Spec ID                                 | Date             | Commit    |
| --------------------------------------- | ---------------- | --------- |
| `API-TABLES-GET-002`                    | 2026-01-13 20:35 | `eac0b24` |
...
<details>
<summary>View API specs (111 files, 276/927 passing)</summary>
...
#### 🚧 tables > {tableId} > get (83%)

📁 `api/tables/{tableId}/get.spec.ts`

**Get table by ID**

**5/6** passing | 1 fixme | 5 @spec | 1 @regression
