...
> Generated: 2026-02-15T05:33:44.212Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2154/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.19 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 12.19)
- **95 tests remaining** - TDD automation running
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 256                   |
| 🤖 Fixed by TDD Pipeline | 189                   |
| 👤 Fixed Manually        | 67                    |
| Fixed Last 24h           | 14                    |
| Fixed Last 7d            | 59                    |
| Fixed Last 30d           | 256                   |
...
<details>
<summary>View API specs (67 files, 540/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > post (36%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**5/14** passing | 9 fixme | 13 @spec | 1 @regression
