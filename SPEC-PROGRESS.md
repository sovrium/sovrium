...
> Generated: 2026-02-02T00:21:32.137Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 92% (2074/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 4.73 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 5 specs/day to hit ETA (current: 4.73)
- **170 tests remaining** - TDD automation running
...
| -------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-RECORDS-UPSERT-006`  | 2026-02-02 01:11 | `8ae9d31` | 🤖 TDD    |
...
<details>
<summary>View API specs (69 files, 447/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > upsert > post (43%)
