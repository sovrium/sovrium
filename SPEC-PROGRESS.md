...
> Generated: 2026-01-23T23:02:24.218Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1965/2252 tests) | 🟡 Needs Attention |
...
- **287 tests remaining** - TDD automation running
...
| Spec ID                                | Date             | Commit    |
| -------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-014`        | 2026-01-24 00:01 | `ffebfb1` |
...
<details>
<summary>View API specs (67 files, 338/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (78%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**14/18** passing | 4 fixme | 17 @spec | 1 @regression
