...
> Generated: 2026-02-15T05:05:41.550Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2153/2249 tests) | 🟡 Needs Attention |
...
- **96 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (67 files, 539/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > post (29%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**4/14** passing | 10 fixme | 13 @spec | 1 @regression
