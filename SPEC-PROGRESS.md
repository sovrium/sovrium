...
> Generated: 2026-02-04T16:16:46.919Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 93% (2096/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 6.07 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2026-03-01 (~4 weeks)                        | 🟡 Needs Attention |
...
- [User Stories Metrics](#-user-stories-metrics)
...
- **Maintain velocity** - Need 6 specs/day to hit ETA (current: 6.07)
- **148 tests remaining** - TDD automation running
...
| ----------------------------- | ----- | ---------- |
| **Total User Stories**        | 251   | -          |
| **Total Acceptance Criteria** | 2490  | -          |
| 🟢 Specified & Implemented    | 229   | 91%        |
| 🟡 Specified, Not Implemented | 22    | 9%         |
| 🔴 Needs Specification        | 0     | 0%         |

**User Story Coverage**: [██████████████████░░] 91%

### By Domain

| Domain     | Stories | Specified | Implemented | Coverage |
| ---------- | ------- | --------- | ----------- | -------- |
| API        | 69      | 69        | 48          | 70%      |
| APP        | 151     | 151       | 150         | 99%      |
| CLI        | 11      | 11        | 11          | 100%     |
| MIGRATIONS | 19      | 19        | 19          | 100%     |
| TEMPLATES  | 1       | 1         | 1           | 100%     |

<details>
<summary>🟡 Stories Specified but Not Implemented (22)</summary>

- **US-API-ACTIVITY-001**: Activity
  - Spec IDs: `API-ACTIVITY-LIST-001`, `API-ACTIVITY-LIST-002`, `API-ACTIVITY-LIST-003`, `API-ACTIVITY-LIST-004`, `API-ACTIVITY-LIST-005`, `API-ACTIVITY-LIST-006`, `API-ACTIVITY-LIST-007`, `API-ACTIVITY-LIST-008`, `API-ACTIVITY-LIST-009`, `API-ACTIVITY-LIST-010`, `API-ACTIVITY-LIST-011`, `API-ACTIVITY-LIST-012`, `API-ACTIVITY-LIST-013`, `API-ACTIVITY-LIST-014`, `API-ACTIVITY-LIST-015`, `API-ACTIVITY-LIST-016`, `API-ACTIVITY-LIST-017`, `API-ACTIVITY-LIST-018`, `API-ACTIVITY-LIST-019`, `API-ACTIVITY-LIST-REGRESSION`
  - File: `docs/specification/api/activity/get/as-developer.md`
- **US-API-ACTIVITY-ID-001**: {activityId}
  - Spec IDs: `API-ACTIVITY-DETAILS-001`, `API-ACTIVITY-DETAILS-002`, `API-ACTIVITY-DETAILS-003`, `API-ACTIVITY-DETAILS-004`, `API-ACTIVITY-DETAILS-005`, `API-ACTIVITY-DETAILS-006`, `API-ACTIVITY-DETAILS-007`, `API-ACTIVITY-DETAILS-REGRESSION`
  - File: `docs/specification/api/activity/{activityId}/get/as-developer.md`
- **US-API-TABLES-PERMISSIONS-001**: Permissions
  - Spec IDs: `API-TABLES-PERMISSIONS-FIELD-001`, `API-TABLES-PERMISSIONS-FIELD-002`, `API-TABLES-PERMISSIONS-FIELD-003`, `API-TABLES-PERMISSIONS-FIELD-004`, `API-TABLES-PERMISSIONS-FIELD-005`, `API-TABLES-PERMISSIONS-FIELD-REGRESSION`
  - File: `docs/specification/api/tables/permissions/api-field-permissions/as-developer.md`
- **US-API-TABLES-PERMISSIONS-001**: Permissions
  - Spec IDs: `API-TABLES-PERMISSIONS-RECORD-001`, `API-TABLES-PERMISSIONS-RECORD-002`, `API-TABLES-PERMISSIONS-RECORD-003`, `API-TABLES-PERMISSIONS-RECORD-004`, `API-TABLES-PERMISSIONS-RECORD-005`, `API-TABLES-PERMISSIONS-RECORD-006`, `API-TABLES-PERMISSIONS-RECORD-007`, `API-TABLES-PERMISSIONS-RECORD-REGRESSION`
  - File: `docs/specification/api/tables/permissions/api-record-permissions/as-developer.md`
- **US-API-TABLES-001**: Tables
  - Spec IDs: `API-TABLES-SESSION-CTX-INT-001`, `API-TABLES-SESSION-CTX-INT-002`, `API-TABLES-SESSION-CTX-INT-003`, `API-TABLES-SESSION-CTX-INT-004`, `API-TABLES-SESSION-CTX-INT-005`, `API-TABLES-SESSION-CTX-INT-006`, `API-TABLES-SESSION-CTX-INT-REGRESSION`
  - File: `docs/specification/api/tables/session-context-integration/as-developer.md`
- **US-API-TABLES-ID-RECORDS-BATCH-001**: Batch
  - Spec IDs: `API-TABLES-RECORDS-BATCH-DELETE-001`, `API-TABLES-RECORDS-BATCH-DELETE-002`, `API-TABLES-RECORDS-BATCH-DELETE-003`, `API-TABLES-RECORDS-BATCH-DELETE-004`, `API-TABLES-RECORDS-BATCH-DELETE-005`, `API-TABLES-RECORDS-BATCH-DELETE-006`, `API-TABLES-RECORDS-BATCH-DELETE-007`, `API-TABLES-RECORDS-BATCH-DELETE-008`, `API-TABLES-RECORDS-BATCH-DELETE-009`, `API-TABLES-RECORDS-BATCH-DELETE-010`, `API-TABLES-RECORDS-BATCH-DELETE-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/batch/delete/as-developer.md`
- **US-API-TABLES-ID-RECORDS-BATCH-001**: Batch
  - Spec IDs: `API-TABLES-RECORDS-BATCH-PATCH-001`, `API-TABLES-RECORDS-BATCH-PATCH-002`, `API-TABLES-RECORDS-BATCH-PATCH-003`, `API-TABLES-RECORDS-BATCH-PATCH-004`, `API-TABLES-RECORDS-BATCH-PATCH-005`, `API-TABLES-RECORDS-BATCH-PATCH-006`, `API-TABLES-RECORDS-BATCH-PATCH-007`, `API-TABLES-RECORDS-BATCH-PATCH-008`, `API-TABLES-RECORDS-BATCH-PATCH-009`, `API-TABLES-RECORDS-BATCH-PATCH-010`, `API-TABLES-RECORDS-BATCH-PATCH-011`, `API-TABLES-RECORDS-BATCH-PATCH-012`, `API-TABLES-RECORDS-BATCH-PATCH-013`, `API-TABLES-RECORDS-BATCH-PATCH-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/batch/patch/as-developer.md`
- **US-API-TABLES-ID-RECORDS-BATCH-001**: Batch
  - Spec IDs: `API-TABLES-RECORDS-BATCH-POST-001`, `API-TABLES-RECORDS-BATCH-POST-002`, `API-TABLES-RECORDS-BATCH-POST-003`, `API-TABLES-RECORDS-BATCH-POST-004`, `API-TABLES-RECORDS-BATCH-POST-005`, `API-TABLES-RECORDS-BATCH-POST-006`, `API-TABLES-RECORDS-BATCH-POST-007`, `API-TABLES-RECORDS-BATCH-POST-008`, `API-TABLES-RECORDS-BATCH-POST-009`, `API-TABLES-RECORDS-BATCH-POST-010`, `API-TABLES-RECORDS-BATCH-POST-011`, `API-TABLES-RECORDS-BATCH-POST-012`, `API-TABLES-RECORDS-BATCH-POST-013`, `API-TABLES-RECORDS-BATCH-POST-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/batch/post/as-developer.md`
- **US-API-TABLES-ID-RECORDS-BATCH-RESTOR-001**: Restore
  - Spec IDs: `API-TABLES-RECORDS-BATCH-RESTORE-001`, `API-TABLES-RECORDS-BATCH-RESTORE-002`, `API-TABLES-RECORDS-BATCH-RESTORE-003`, `API-TABLES-RECORDS-BATCH-RESTORE-004`, `API-TABLES-RECORDS-BATCH-RESTORE-005`, `API-TABLES-RECORDS-BATCH-RESTORE-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/batch/restore/post/as-developer.md`
- **US-API-TABLES-ID-RECORDS-001**: Records
  - Spec IDs: `API-TABLES-RECORDS-INCLUDE-DELETED-001`, `API-TABLES-RECORDS-INCLUDE-DELETED-002`, `API-TABLES-RECORDS-INCLUDE-DELETED-003`, `API-TABLES-RECORDS-INCLUDE-DELETED-004`, `API-TABLES-RECORDS-INCLUDE-DELETED-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/include-deleted/as-developer.md`
- **US-API-TABLES-ID-RECORDS-UPSERT-001**: Upsert
  - Spec IDs: `API-TABLES-RECORDS-UPSERT-001`, `API-TABLES-RECORDS-UPSERT-002`, `API-TABLES-RECORDS-UPSERT-003`, `API-TABLES-RECORDS-UPSERT-004`, `API-TABLES-RECORDS-UPSERT-005`, `API-TABLES-RECORDS-UPSERT-006`, `API-TABLES-RECORDS-UPSERT-007`, `API-TABLES-RECORDS-UPSERT-008`, `API-TABLES-RECORDS-UPSERT-009`, `API-TABLES-RECORDS-UPSERT-010`, `API-TABLES-RECORDS-UPSERT-011`, `API-TABLES-RECORDS-UPSERT-012`, `API-TABLES-RECORDS-UPSERT-013`, `API-TABLES-RECORDS-UPSERT-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/upsert/post/as-developer.md`
- **US-API-TABLES-ID-RECORDS-ID-COMMENTS-001**: Comments
  - Spec IDs: `API-TABLES-RECORDS-COMMENTS-LIST-001`, `API-TABLES-RECORDS-COMMENTS-LIST-002`, `API-TABLES-RECORDS-COMMENTS-LIST-003`, `API-TABLES-RECORDS-COMMENTS-LIST-004`, `API-TABLES-RECORDS-COMMENTS-LIST-005`, `API-TABLES-RECORDS-COMMENTS-LIST-006`, `API-TABLES-RECORDS-COMMENTS-LIST-007`, `API-TABLES-RECORDS-COMMENTS-LIST-008`, `API-TABLES-RECORDS-COMMENTS-LIST-009`, `API-TABLES-RECORDS-COMMENTS-LIST-010`, `API-TABLES-RECORDS-COMMENTS-LIST-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/{recordId}/comments/get/as-developer.md`
- **US-API-TABLES-ID-RECORDS-ID-COMMENTS-001**: Comments
  - Spec IDs: `API-TABLES-RECORDS-COMMENTS-CREATE-001`, `API-TABLES-RECORDS-COMMENTS-CREATE-002`, `API-TABLES-RECORDS-COMMENTS-CREATE-003`, `API-TABLES-RECORDS-COMMENTS-CREATE-004`, `API-TABLES-RECORDS-COMMENTS-CREATE-005`, `API-TABLES-RECORDS-COMMENTS-CREATE-006`, `API-TABLES-RECORDS-COMMENTS-CREATE-007`, `API-TABLES-RECORDS-COMMENTS-CREATE-008`, `API-TABLES-RECORDS-COMMENTS-CREATE-009`, `API-TABLES-RECORDS-COMMENTS-CREATE-010`, `API-TABLES-RECORDS-COMMENTS-CREATE-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/{recordId}/comments/post/as-developer.md`
- **US-API-TABLES-ID-RECORDS-ID-COMMENTS--001**: {commentId}
  - Spec IDs: `API-TABLES-RECORDS-COMMENTS-DELETE-001`, `API-TABLES-RECORDS-COMMENTS-DELETE-002`, `API-TABLES-RECORDS-COMMENTS-DELETE-003`, `API-TABLES-RECORDS-COMMENTS-DELETE-004`, `API-TABLES-RECORDS-COMMENTS-DELETE-005`, `API-TABLES-RECORDS-COMMENTS-DELETE-006`, `API-TABLES-RECORDS-COMMENTS-DELETE-007`, `API-TABLES-RECORDS-COMMENTS-DELETE-008`, `API-TABLES-RECORDS-COMMENTS-DELETE-009`, `API-TABLES-RECORDS-COMMENTS-DELETE-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/{recordId}/comments/{commentId}/delete/as-developer.md`
- **US-API-TABLES-ID-RECORDS-ID-COMMENTS--001**: {commentId}
  - Spec IDs: `API-TABLES-RECORDS-COMMENTS-GET-001`, `API-TABLES-RECORDS-COMMENTS-GET-002`, `API-TABLES-RECORDS-COMMENTS-GET-003`, `API-TABLES-RECORDS-COMMENTS-GET-004`, `API-TABLES-RECORDS-COMMENTS-GET-005`, `API-TABLES-RECORDS-COMMENTS-GET-006`, `API-TABLES-RECORDS-COMMENTS-GET-007`, `API-TABLES-RECORDS-COMMENTS-GET-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/{recordId}/comments/{commentId}/get/as-developer.md`
- **US-API-TABLES-ID-RECORDS-ID-COMMENTS--001**: {commentId}
  - Spec IDs: `API-TABLES-RECORDS-COMMENTS-UPDATE-001`, `API-TABLES-RECORDS-COMMENTS-UPDATE-002`, `API-TABLES-RECORDS-COMMENTS-UPDATE-003`, `API-TABLES-RECORDS-COMMENTS-UPDATE-004`, `API-TABLES-RECORDS-COMMENTS-UPDATE-005`, `API-TABLES-RECORDS-COMMENTS-UPDATE-006`, `API-TABLES-RECORDS-COMMENTS-UPDATE-007`, `API-TABLES-RECORDS-COMMENTS-UPDATE-008`, `API-TABLES-RECORDS-COMMENTS-UPDATE-009`, `API-TABLES-RECORDS-COMMENTS-UPDATE-010`, `API-TABLES-RECORDS-COMMENTS-UPDATE-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/{recordId}/comments/{commentId}/patch/as-developer.md`
- **US-API-TABLES-ID-RECORDS-ID-HISTORY-001**: History
  - Spec IDs: `API-ACTIVITY-RECORD-HISTORY-001`, `API-ACTIVITY-RECORD-HISTORY-002`, `API-ACTIVITY-RECORD-HISTORY-003`, `API-ACTIVITY-RECORD-HISTORY-004`, `API-ACTIVITY-RECORD-HISTORY-005`, `API-ACTIVITY-RECORD-HISTORY-006`, `API-ACTIVITY-RECORD-HISTORY-007`, `API-ACTIVITY-RECORD-HISTORY-008`, `API-ACTIVITY-RECORD-HISTORY-009`, `API-ACTIVITY-RECORD-HISTORY-010`, `API-ACTIVITY-RECORD-HISTORY-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/records/{recordId}/history/get/as-developer.md`
- **US-API-TABLES-ID-TRASH-001**: Trash
  - Spec IDs: `API-TABLES-TRASH-001`, `API-TABLES-TRASH-002`, `API-TABLES-TRASH-003`, `API-TABLES-TRASH-004`, `API-TABLES-TRASH-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/trash/get/as-developer.md`
- **US-API-TABLES-ID-VIEWS-001**: Views
  - Spec IDs: `API-TABLES-VIEWS-LIST-001`, `API-TABLES-VIEWS-LIST-002`, `API-TABLES-VIEWS-LIST-003`, `API-TABLES-VIEWS-LIST-004`, `API-TABLES-VIEWS-LIST-005`, `API-TABLES-VIEWS-LIST-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/views/get/as-developer.md`
- **US-API-TABLES-ID-VIEWS-ID-001**: {viewId}
  - Spec IDs: `API-TABLES-VIEWS-GET-001`, `API-TABLES-VIEWS-GET-002`, `API-TABLES-VIEWS-GET-003`, `API-TABLES-VIEWS-GET-004`, `API-TABLES-VIEWS-GET-005`, `API-TABLES-VIEWS-GET-006`, `API-TABLES-VIEWS-GET-007`, `API-TABLES-VIEWS-GET-008`, `API-TABLES-VIEWS-GET-REGRESSION`
  - File: `docs/specification/api/tables/{tableId}/views/{viewId}/get/as-developer.md`
- ... and 2 more
...
| ---------------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-VIEWS-GET-008`               | 2026-02-03 16:26 | `b691fd6` | 👤 Manual |
| `API-TABLES-VIEWS-GET-007`               | 2026-02-03 16:08 | `e5cb883` | 👤 Manual |
| `API-TABLES-VIEWS-GET-006`               | 2026-02-03 15:57 | `3590365` | 👤 Manual |
| `API-TABLES-VIEWS-GET-005`               | 2026-02-03 15:47 | `c790d28` | 👤 Manual |
| `API-TABLES-VIEWS-GET-004`               | 2026-02-03 15:30 | `2ae49af` | 👤 Manual |
| `API-TABLES-VIEWS-GET-003`               | 2026-02-03 15:13 | `924cfb1` | 👤 Manual |
| `API-TABLES-VIEWS-GET-002`               | 2026-02-03 14:06 | `eec787c` | 👤 Manual |
| `API-TABLES-VIEWS-GET-001`               | 2026-02-03 13:50 | `00bf6db` | 🤖 TDD    |
| `API-TABLES-RECORDS-INCLUDE-DELETED-004` | 2026-02-03 11:03 | `32534a0` | 👤 Manual |
| `API-TABLES-RECORDS-INCLUDE-DELETED-003` | 2026-02-03 10:57 | `f4a57e5` | 👤 Manual |
| `API-TABLES-RECORDS-INCLUDE-DELETED-002` | 2026-02-03 10:47 | `92e8ab7` | 👤 Manual |
| `API-TABLES-RECORDS-INCLUDE-DELETED-001` | 2026-02-03 10:32 | `895f02a` | 🤖 TDD    |
| `API-TABLES-RECORDS-COMMENTS-DELETE-009` | 2026-02-03 09:52 | `c6bacdc` | 🤖 TDD    |
| `API-TABLES-RECORDS-COMMENTS-DELETE-008` | 2026-02-03 09:03 | `ee48d29` | 🤖 TDD    |
| `API-TABLES-RECORDS-COMMENTS-DELETE-007` | 2026-02-03 08:15 | `6133d51` | 🤖 TDD    |
| `API-TABLES-RECORDS-COMMENTS-DELETE-006` | 2026-02-03 07:39 | `e96384d` | 🤖 TDD    |
| `API-TABLES-RECORDS-COMMENTS-DELETE-005` | 2026-02-03 07:04 | `2fece12` | 👤 Manual |
| `API-TABLES-RECORDS-COMMENTS-DELETE-004` | 2026-02-03 06:51 | `fec835a` | 🤖 TDD    |
| `API-TABLES-RECORDS-COMMENTS-DELETE-003` | 2026-02-03 06:15 | `65a7c1e` | 🤖 TDD    |
| `API-TABLES-RECORDS-COMMENTS-DELETE-002` | 2026-02-03 04:58 | `d21a409` | 🤖 TDD    |
...
🟡 **69 files** | **617 tests** | [███████████████░░░░░] 76% | In Progress

<details>
<summary>View API specs (69 files, 470/617 passing)</summary>
...
#### 🚧 tables > permissions > api-record-permissions (75%)
...
#### 🚧 tables > session-context-integration (86%)
...
API-TABLES-SESSION-CTX-INT-002: should enforce owner filtering via API
`G/W/T` Line 69
...
#### 🚧 tables > {tableId} > records > batch > delete (36%)

📁 `api/tables/{tableId}/records/batch/delete.spec.ts`

**Batch delete records**

**4/11** passing | 7 fixme | 10 @spec | 1 @regression

<details>
<summary>Tests</summary>

✅ **API-TABLES-RECORDS-BATCH-DELETE-001** `@spec`
...
✅ **API-TABLES-RECORDS-BATCH-DELETE-REGRESSION** `@regression`
...
#### 🚧 tables > {tableId} > records > batch > restore > post (17%)
...
#### 🚧 tables > {tableId} > records > include-deleted (80%)
...
✅ **API-TABLES-RECORDS-UPSERT-012** `@spec`
...
✅ **API-TABLES-RECORDS-UPSERT-REGRESSION** `@regression`
...
#### ✅ tables > {tableId} > records > {recordId} > patch (100%)
...
✅ **API-TABLES-RECORDS-UPDATE-001** `@spec`
...
#### 🚧 tables > {tableId} > views > {viewId} > get (89%)
...
<details>
<summary>View APP specs (130 files, 1456/1457 passing)</summary>
...
APP-TABLES-FIELD-PERMISSIONS-007: should demonstrate field filtering at API layer
`G/W/T` Line 468

⏸️ **APP-TABLES-FIELD-PERMISSIONS-008** `@spec`
APP-TABLES-FIELD-PERMISSIONS-008: should prevent field modification at API layer
`G/W/T` Line 569

✅ **APP-TABLES-FIELD-PERMISSIONS-009** `@spec`
APP-TABLES-FIELD-PERMISSIONS-009: should apply field permissions with row filtering
`G/W/T` Line 663
...
APP-TABLES-SESSION-CTX-002: should enable permission filtering with session context
`G/W/T` Line 77
...
APP-TABLES-TABLE-PERMISSIONS-002: should allow SELECT when table has public read permission
`G/W/T` Line 108
