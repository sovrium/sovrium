...
> Generated: 2026-01-23T19:36:07.467Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [█████████████████░░░] 87% (1963/2252 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 6.13 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 7 specs/day to hit ETA (current: 6.13)
- **289 tests remaining** - TDD automation running
...
| Spec ID                                  | Date             | Commit    |
| ---------------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-012`          | 2026-01-23 20:35 | `f19e21c` |
| `API-TABLES-RECORDS-CREATE-011`          | 2026-01-23 19:04 | `fe1447d` |
| `API-TABLES-RECORDS-CREATE-010`          | 2026-01-23 18:48 | `c559b81` |
| `API-TABLES-RECORDS-CREATE-009`          | 2026-01-23 18:03 | `4075a6a` |
...
🟡 **67 files** | **625 tests** | [███████████░░░░░░░░░] 54% | In Progress

<details>
<summary>View API specs (67 files, 336/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (67%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**12/18** passing | 6 fixme | 17 @spec | 1 @regression
