...
> Generated: 2026-02-01T16:51:45.651Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 92% (2069/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 0.03 specs/day                               | 🔴 Slow            |
| **Quality Score**        | 95%                                          | 🟢 Excellent       |
| **Estimated Completion** | 2040-06-17 (~175 months)                     | 🟡 Needs Attention |
...
- **175 tests remaining** - TDD automation running
...
<details>
<summary>View API specs (69 files, 442/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > patch (25%)

📁 `api/tables/{tableId}/records/{recordId}/patch.spec.ts`

**Update record**

**4/16** passing | 12 fixme | 15 @spec | 1 @regression
