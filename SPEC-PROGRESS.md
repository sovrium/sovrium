...
> Generated: 2026-02-15T11:54:01.221Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [███████████████████░] 96% (2158/2249 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 12.14 specs/day                              | 🔴 Slow            |
...
- **Maintain velocity** - Need 12 specs/day to hit ETA (current: 12.14)
- **91 tests remaining** - TDD automation running
...
- **US-TABLES-DEFINITION-005**: Define Table Fields
  - Spec IDs: `APP-TABLES-FIELDS-001`, `APP-TABLES-FIELDS-002`, `APP-TABLES-FIELDS-003`, `APP-TABLES-FIELDS-004`, `APP-TABLES-FIELDS-005`, `APP-TABLES-FIELDS-006`, `APP-TABLES-FIELDS-007`, `APP-TABLES-FIELDS-008`, `APP-TABLES-FIELDS-009`, `APP-TABLES-FIELDS-010`, `APP-TABLES-FIELDS-011`, `APP-TABLES-FIELDS-012`, `APP-TABLES-FIELDS-013`, `APP-TABLES-FIELDS-014`, `APP-TABLES-FIELDS-015`, `APP-TABLES-FIELDS-016`, `APP-TABLES-FIELDS-REGRESSION`
  - File: `docs/user-stories/as-developer/tables/creating-tables.md`
...
| Metric                   | Value                 |
| ------------------------ | --------------------- |
| Tests Fixed (30 days)    | 255                   |
| 🤖 Fixed by TDD Pipeline | 194                   |
| 👤 Fixed Manually        | 61                    |
| Fixed Last 24h           | 19                    |
| Fixed Last 7d            | 64                    |
| Fixed Last 30d           | 255                   |
...
| ----------------------------------------- | ---------------- | --------- | ------ |
| `APP-TABLES-FIELD-TYPES-RELATIONSHIP-017` | 2026-02-15 12:44 | `89fb42e` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-PATCH-010`      | 2026-02-15 09:58 | `6b847d3` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-PATCH-009`      | 2026-02-15 09:13 | `07b1f45` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-POST-007`       | 2026-02-15 07:20 | `98c14f1` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-POST-006`       | 2026-02-15 07:05 | `d36649f` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-POST-005`       | 2026-02-15 06:24 | `a1d9ddd` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-POST-003`       | 2026-02-15 05:55 | `7f39284` | 🤖 TDD |
| `API-TABLES-RECORDS-BATCH-POST-002`       | 2026-02-15 05:07 | `a61823a` | 🤖 TDD |
| `API-TABLES-RECORDS-COMMENTS-LIST-010`    | 2026-02-15 04:52 | `7075b44` | 🤖 TDD |
...
🟡 **67 files** | **628 tests** | [█████████████████░░░] 87% | Almost Done

<details>
<summary>View API specs (67 files, 544/628 passing)</summary>
...
#### 🚧 tables > {tableId} > records > batch > patch (79%)
...
#### 🚧 tables > {tableId} > records > batch > post (50%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**7/14** passing | 7 fixme | 13 @spec | 1 @regression
...
#### ✅ tables > {tableId} > records > {recordId} > comments > get (100%)
...
✅ **API-TABLES-RECORDS-COMMENTS-LIST-010** `@spec`
...
#### 🚧 tables > field-types > relationship-field (75%)

📁 `app/tables/field-types/relationship-field.spec.ts`

**Relationship Field**

**18/24** passing | 6 fixme | 23 @spec | 1 @regression
...
✅ **APP-TABLES-FIELD-TYPES-RELATIONSHIP-017** `@spec`
...
**16/17** passing | 1 fixme | 16 @spec | 1 @regression
