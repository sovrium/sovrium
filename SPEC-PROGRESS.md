...
> Generated: 2026-01-24T11:11:20.545Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 88% (1973/2252 tests) | 🟡 Needs Attention |
...
- **279 tests remaining** - TDD automation running
...
| Spec ID                         | Date             | Commit    |
| ------------------------------- | ---------------- | --------- |
| `API-TABLES-RECORDS-CREATE-016` | 2026-01-24 12:10 | `0598e4b` |
...
<details>
<summary>View API specs (67 files, 346/625 passing)</summary>
...
#### 🚧 tables > {tableId} > records > post (94%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**17/18** passing | 1 fixme | 17 @spec | 1 @regression
...
✅ **API-TABLES-RECORDS-CREATE-016** `@spec`
