...
> Generated: 2026-01-09T18:00:19.498Z
>
...
| ------------------------ | -------------------------------------------- | ------------ |
| **Overall Progress**     | [███████████████░░░░░] 74% (1905/2568 tests) | 🔴 Blocked   |
| **Daily Velocity**       | 14.1 specs/day                               | 🔴 Slow      |
| **Quality Score**        | 93%                                          | 🟢 Excellent |
| **Estimated Completion** | 2026-02-26 (~2 months)                       | 🔴 Blocked   |
| **Blockers**             | 2 errors, 1 warnings                         | 🔴 Blocked   |
...
- [Feature Breakdown](#-feature-breakdown)
  - [API](#api) • 🟡 28% (111 files)
  - [APP](#app) • 🔴 100% (131 files)
  - [CLI](#cli) • 🟢 100% (9 files)
...
- ❌ **MISSING_TAG** in `app/pages/scripts/inline-scripts.spec.ts:155`
- ❌ **HEADER_COUNT_MISMATCH** in `app/pages/scripts/inline-scripts.spec.ts`

### ⚠️ Priority 2 - This Week

- **Fix warning** in `api/tables/permissions/api-complex-conditions.spec.ts:291` (MISSING_THEN)

### 📋 Priority 3 - Ongoing

- **Maintain velocity** - Need 14 specs/day to hit ETA (current: 14.1)
- **663 tests remaining** - TDD automation running
- **Quality gate** - Keep quality score above 85% (current: 93%)
...
| Metric                | Value                  |
| --------------------- | ---------------------- |
| Tests Fixed (90 days) | 1742                   |
| Fixed Last 24h        | 0                      |
| Fixed Last 7d         | 0                      |
| Fixed Last 30d        | 423                    |
| Avg Fixes/Day         | 14.1                   |
| Remaining             | 663                    |
| ETA                   | ~2 months (2026-02-26) |
...
| Spec ID                                 | Date             | Commit    |
| --------------------------------------- | ---------------- | --------- |
| `API-TABLES-PERMISSIONS-FIELD-003`      | 2025-12-29 19:17 | `72cf892` |
| `API-TABLES-PERMISSIONS-FIELD-002`      | 2025-12-29 18:46 | `a34da69` |
| `API-TABLES-PERMISSIONS-FIELD-001`      | 2025-12-29 18:03 | `cb956a1` |
| `API-TABLES-PERMISSIONS-CONDITIONS-001` | 2025-12-29 17:17 | `392e3f7` |
| `API-TABLES-PERMISSIONS-CONDITIONS-007` | 2025-12-29 16:57 | `cac2f04` |
| `API-TABLES-PERMISSIONS-CONDITIONS-006` | 2025-12-29 15:46 | `5a06432` |
| `API-TABLES-PERMISSIONS-CONDITIONS-005` | 2025-12-29 15:17 | `4550cf4` |
| `API-TABLES-PERMISSIONS-CONDITIONS-004` | 2025-12-29 14:42 | `1213260` |
| `API-TABLES-PERMISSIONS-CONDITIONS-003` | 2025-12-29 13:48 | `95e753c` |
| `API-TABLES-PERMISSIONS-CONDITIONS-002` | 2025-12-29 13:20 | `2d7335b` |
| `API-TABLES-PERMISSIONS-BULK-006`       | 2025-12-29 12:16 | `42fb697` |
| `API-TABLES-PERMISSIONS-BULK-004`       | 2025-12-29 12:00 | `26ed048` |
| `API-TABLES-PERMISSIONS-BULK-007`       | 2025-12-29 10:47 | `50f752c` |
| `API-TABLES-PERMISSIONS-BULK-005`       | 2025-12-29 09:06 | `24a1ef3` |
| `API-TABLES-PERMISSIONS-BULK-001`       | 2025-12-29 08:46 | `1272199` |
| `API-TABLES-PERMISSIONS-BULK-003`       | 2025-12-29 08:26 | `566c709` |
| `API-TABLES-PERMISSIONS-BULK-002`       | 2025-12-29 06:58 | `177d288` |
| `API-TABLES-LIST-006`                   | 2025-12-29 06:00 | `43b2ff1` |
| `API-TABLES-LIST-005`                   | 2025-12-29 05:21 | `5664d95` |
| `API-TABLES-LIST-004`                   | 2025-12-29 04:33 | `f56dfe8` |
...
- **MISSING_TAG** in `app/pages/scripts/inline-scripts.spec.ts:155`
  Test missing tag (@spec or @regression)
- **HEADER_COUNT_MISMATCH** in `app/pages/scripts/inline-scripts.spec.ts`
  Header "Spec Count: 10" does not match actual @spec count: 9

### ⚠️ Warnings

- **MISSING_THEN** in `api/tables/permissions/api-complex-conditions.spec.ts:291`
  Test missing THEN comment (assertion)

<details>
<summary>💡 Suggestions</summary>

- **NON_SEQUENTIAL_IDS** in `api/activity/get.spec.ts` - Spec IDs are not sequential (gap between API-ACTIVITY-LIST-020 and API-ACTIVITY-LIST-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/activity/{activityId}/get.spec.ts` - Spec IDs are not sequential (gap between API-ACTIVITY-DETAILS-008 and API-ACTIVITY-DETAILS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/create-user/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-CREATE-USER-010 and API-AUTH-ADMIN-CREATE-USER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/get-user/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-GET-USER-006 and API-AUTH-ADMIN-GET-USER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/impersonate-user/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-IMPERSONATE-USER-006 and API-AUTH-ADMIN-IMPERSONATE-USER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/list-user-sessions/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-LIST-USER-SESSIONS-007 and API-AUTH-ADMIN-LIST-USER-SESSIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/list-users/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-LIST-USERS-007 and API-AUTH-ADMIN-LIST-USERS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/options/default-role.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-OPT-DEFAULT-ROLE-002 and API-AUTH-ADMIN-OPT-DEFAULT-ROLE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/plugin-disabled.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-PLUGIN-004 and API-AUTH-ADMIN-PLUGIN-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/revoke-user-session/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-REVOKE-USER-SESSION-008 and API-AUTH-ADMIN-REVOKE-USER-SESSION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/set-role/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-SET-ROLE-008 and API-AUTH-ADMIN-SET-ROLE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/set-user-password/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-SET-USER-PASSWORD-007 and API-AUTH-ADMIN-SET-USER-PASSWORD-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/stop-impersonating/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ADMIN-STOP-IMPERSONATING-005 and API-AUTH-ADMIN-STOP-IMPERSONATING-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/change-email/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-CHANGE-EMAIL-007 and API-AUTH-CHANGE-EMAIL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/change-password/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-CHANGE-PASSWORD-008 and API-AUTH-CHANGE-PASSWORD-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/enforcement/disabled-auth.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-DISABLED-004 and API-AUTH-DISABLED-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/get-session/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-GET-SESSION-005 and API-AUTH-GET-SESSION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/list-sessions/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-LIST-SESSIONS-007 and API-AUTH-LIST-SESSIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/magic-link/send/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-MAGIC-LINK-SEND-005 and API-AUTH-MAGIC-LINK-SEND-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/magic-link/verify/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-MAGIC-LINK-VERIFY-005 and API-AUTH-MAGIC-LINK-VERIFY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/accept-invitation/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-ACCEPT-INVITATION-008 and API-AUTH-ORG-ACCEPT-INVITATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/cancel-invitation/delete.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-CANCEL-INVITATION-008 and API-AUTH-ORG-CANCEL-INVITATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/create-organization/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-CREATE-ORGANIZATION-005 and API-AUTH-ORG-CREATE-ORGANIZATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/delete-organization/delete.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-DELETE-ORGANIZATION-006 and API-AUTH-ORG-DELETE-ORGANIZATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/dynamic-roles/assign-role/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-DYNAMIC-ROLE-ASSIGN-006 and API-AUTH-ORG-DYNAMIC-ROLE-ASSIGN-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/dynamic-roles/check-permission/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-DYNAMIC-ROLE-CHECK-PERM-006 and API-AUTH-ORG-DYNAMIC-ROLE-CHECK-PERM-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/dynamic-roles/create-role/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-DYNAMIC-ROLE-CREATE-006 and API-AUTH-ORG-DYNAMIC-ROLE-CREATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/dynamic-roles/delete-role/delete.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-DYNAMIC-ROLE-DELETE-006 and API-AUTH-ORG-DYNAMIC-ROLE-DELETE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/dynamic-roles/list-roles/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-DYNAMIC-ROLE-LIST-006 and API-AUTH-ORG-DYNAMIC-ROLE-LIST-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/dynamic-roles/update-role/patch.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-DYNAMIC-ROLE-UPDATE-006 and API-AUTH-ORG-DYNAMIC-ROLE-UPDATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/get-organization/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-GET-ORGANIZATION-005 and API-AUTH-ORG-GET-ORGANIZATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/invite-member/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-INVITE-MEMBER-009 and API-AUTH-ORG-INVITE-MEMBER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/list-invitations/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-LIST-INVITATIONS-008 and API-AUTH-ORG-LIST-INVITATIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/list-members/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-LIST-MEMBERS-006 and API-AUTH-ORG-LIST-MEMBERS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/list-organizations/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-LIST-ORGANIZATIONS-005 and API-AUTH-ORG-LIST-ORGANIZATIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/options/creator-role.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-OPT-CREATOR-002 and API-AUTH-ORG-OPT-CREATOR-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/options/leave-organization.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-OPT-LEAVE-003 and API-AUTH-ORG-OPT-LEAVE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/options/org-slug.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-OPT-SLUG-003 and API-AUTH-ORG-OPT-SLUG-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/plugin-disabled.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-PLUGIN-004 and API-AUTH-ORG-PLUGIN-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/reject-invitation/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-REJECT-INVITATION-007 and API-AUTH-ORG-REJECT-INVITATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/remove-member/delete.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-REMOVE-MEMBER-008 and API-AUTH-ORG-REMOVE-MEMBER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/set-active-organization/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-SET-ACTIVE-ORGANIZATION-005 and API-AUTH-ORG-SET-ACTIVE-ORGANIZATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/add-team-member/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-ADD-MEMBER-006 and API-AUTH-ORG-TEAMS-ADD-MEMBER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/create-team/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-CREATE-006 and API-AUTH-ORG-TEAMS-CREATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/delete-team/delete.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-DELETE-006 and API-AUTH-ORG-TEAMS-DELETE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/get-active-team/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-GET-ACTIVE-006 and API-AUTH-ORG-TEAMS-GET-ACTIVE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/get-team/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-GET-006 and API-AUTH-ORG-TEAMS-GET-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/list-team-members/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-LIST-MEMBERS-006 and API-AUTH-ORG-TEAMS-LIST-MEMBERS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/list-teams/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-LIST-006 and API-AUTH-ORG-TEAMS-LIST-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/remove-team-member/delete.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-REMOVE-MEMBER-006 and API-AUTH-ORG-TEAMS-REMOVE-MEMBER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/set-active-team/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-SET-ACTIVE-006 and API-AUTH-ORG-TEAMS-SET-ACTIVE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/teams/update-team/patch.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-TEAMS-UPDATE-006 and API-AUTH-ORG-TEAMS-UPDATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/update-member-role/patch.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-UPDATE-MEMBER-ROLE-006 and API-AUTH-ORG-UPDATE-MEMBER-ROLE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/update-organization/patch.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-ORG-UPDATE-ORGANIZATION-007 and API-AUTH-ORG-UPDATE-ORGANIZATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/rate-limiting.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-RATE-006 and API-AUTH-RATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/request-password-reset/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-REQUEST-PASSWORD-RESET-007 and API-AUTH-REQUEST-PASSWORD-RESET-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/reset-password/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-RESET-PASSWORD-008 and API-AUTH-RESET-PASSWORD-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/revoke-other-sessions/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-REVOKE-OTHER-SESSIONS-005 and API-AUTH-REVOKE-OTHER-SESSIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/revoke-session/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-REVOKE-SESSION-005 and API-AUTH-REVOKE-SESSION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/send-verification-email/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-SEND-VERIFICATION-EMAIL-006 and API-AUTH-SEND-VERIFICATION-EMAIL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/sign-in/email/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-SIGN-IN-EMAIL-008 and API-AUTH-SIGN-IN-EMAIL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/sign-out/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-SIGN-OUT-005 and API-AUTH-SIGN-OUT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/sign-up/email/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-SIGN-UP-EMAIL-015 and API-AUTH-SIGN-UP-EMAIL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/tables/role-based-access.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-TABLES-ROLE-012 and API-AUTH-TABLES-ROLE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/two-factor/disable/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-TWO-FACTOR-DISABLE-005 and API-AUTH-TWO-FACTOR-DISABLE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/two-factor/enable/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-TWO-FACTOR-ENABLE-005 and API-AUTH-TWO-FACTOR-ENABLE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/two-factor/verify/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-TWO-FACTOR-VERIFY-006 and API-AUTH-TWO-FACTOR-VERIFY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/update-user/post.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-UPDATE-USER-006 and API-AUTH-UPDATE-USER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/auth/verify-email/get.spec.ts` - Spec IDs are not sequential (gap between API-AUTH-VERIFY-EMAIL-006 and API-AUTH-VERIFY-EMAIL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/security/https-redirect.spec.ts` - Spec IDs are not sequential (gap between API-SECURITY-REDIRECT-002 and API-SECURITY-REDIRECT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/security/password-hashing.spec.ts` - Spec IDs are not sequential (gap between API-SECURITY-HASH-003 and API-SECURITY-HASH-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/security/secure-headers.spec.ts` - Spec IDs are not sequential (gap between API-SECURITY-HEADERS-006 and API-SECURITY-HEADERS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/security/session-security.spec.ts` - Spec IDs are not sequential (gap between API-SECURITY-SESSION-004 and API-SECURITY-SESSION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/security/session-timeout.spec.ts` - Spec IDs are not sequential (gap between API-SECURITY-TIMEOUT-003 and API-SECURITY-TIMEOUT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/security/sql-injection.spec.ts` - Spec IDs are not sequential (gap between API-SECURITY-SQLI-008 and API-SECURITY-SQLI-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/security/xss-protection.spec.ts` - Spec IDs are not sequential (gap between API-SECURITY-XSS-008 and API-SECURITY-XSS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/disabled-tables.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-DISABLED-004 and API-TABLES-DISABLED-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-LIST-005 and API-TABLES-LIST-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/permissions/api-bulk-operations.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-PERMISSIONS-BULK-007 and API-TABLES-PERMISSIONS-BULK-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/permissions/api-complex-conditions.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-PERMISSIONS-CONDITIONS-007 and API-TABLES-PERMISSIONS-CONDITIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/permissions/api-field-permissions.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-PERMISSIONS-FIELD-005 and API-TABLES-PERMISSIONS-FIELD-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/permissions/api-organization-isolation.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-PERMISSIONS-ORG-007 and API-TABLES-PERMISSIONS-ORG-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/permissions/api-permission-inheritance.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-PERMISSIONS-INHERIT-006 and API-TABLES-PERMISSIONS-INHERIT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/permissions/api-record-permissions.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-PERMISSIONS-RECORD-007 and API-TABLES-PERMISSIONS-RECORD-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/session-context-integration.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-SESSION-CTX-INT-007 and API-TABLES-SESSION-CTX-INT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-GET-005 and API-TABLES-GET-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/permissions/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-PERMISSIONS-CHECK-006 and API-TABLES-PERMISSIONS-CHECK-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/batch/delete.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-BATCH-DELETE-013 and API-TABLES-RECORDS-BATCH-DELETE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/batch/patch.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-BATCH-PATCH-015 and API-TABLES-RECORDS-BATCH-PATCH-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/batch/post.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-BATCH-POST-016 and API-TABLES-RECORDS-BATCH-POST-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/batch/restore/post.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-BATCH-RESTORE-005 and API-TABLES-RECORDS-BATCH-RESTORE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/format.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-FORMAT-024 and API-TABLES-RECORDS-FORMAT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-LIST-028 and API-TABLES-RECORDS-LIST-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/include-deleted.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-INCLUDE-DELETED-004 and API-TABLES-RECORDS-INCLUDE-DELETED-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/post.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-CREATE-018 and API-TABLES-RECORDS-CREATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/upsert/post.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-UPSERT-015 and API-TABLES-RECORDS-UPSERT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/comments/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-COMMENTS-LIST-011 and API-TABLES-RECORDS-COMMENTS-LIST-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/comments/post.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-COMMENTS-CREATE-011 and API-TABLES-RECORDS-COMMENTS-CREATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/comments/{commentId}/delete.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-COMMENTS-DELETE-009 and API-TABLES-RECORDS-COMMENTS-DELETE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/comments/{commentId}/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-COMMENTS-GET-007 and API-TABLES-RECORDS-COMMENTS-GET-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/comments/{commentId}/patch.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-COMMENTS-UPDATE-010 and API-TABLES-RECORDS-COMMENTS-UPDATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/delete.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-DELETE-018 and API-TABLES-RECORDS-DELETE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-GET-012 and API-TABLES-RECORDS-GET-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/history/get.spec.ts` - Spec IDs are not sequential (gap between API-ACTIVITY-RECORD-HISTORY-011 and API-ACTIVITY-RECORD-HISTORY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/patch.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-UPDATE-017 and API-TABLES-RECORDS-UPDATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/restore/post.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-RECORDS-RESTORE-009 and API-TABLES-RECORDS-RESTORE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/trash/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-TRASH-005 and API-TABLES-TRASH-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/views/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-VIEWS-LIST-004 and API-TABLES-VIEWS-LIST-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/views/{viewId}/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-VIEWS-GET-005 and API-TABLES-VIEWS-GET-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/views/{viewId}/records/get.spec.ts` - Spec IDs are not sequential (gap between API-TABLES-VIEW-RECORDS-004 and API-TABLES-VIEW-RECORDS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/blocks/blocks.spec.ts` - Spec IDs are not sequential (gap between APP-BLOCKS-018 and APP-BLOCKS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/blocks/common/block-children.spec.ts` - Spec IDs are not sequential (gap between APP-BLOCKS-CHILDREN-010 and APP-BLOCKS-CHILDREN-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/blocks/common/block-props.spec.ts` - Spec IDs are not sequential (gap between APP-BLOCKS-PROPS-014 and APP-BLOCKS-PROPS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/blocks/common/block-reference.spec.ts` - Spec IDs are not sequential (gap between APP-BLOCKS-REFERENCE-012 and APP-BLOCKS-REFERENCE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/blocks/language-switcher.spec.ts` - Spec IDs are not sequential (gap between APP-BLOCKS-LANGUAGE-SWITCHER-003 and APP-BLOCKS-LANGUAGE-SWITCHER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/description.spec.ts` - Spec IDs are not sequential (gap between APP-DESCRIPTION-015 and APP-DESCRIPTION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/languages/language-config.spec.ts` - Spec IDs are not sequential (gap between APP-LANGUAGES-CONFIG-008 and APP-LANGUAGES-CONFIG-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/languages/languages.spec.ts` - Spec IDs are not sequential (gap between APP-LANGUAGES-029 and APP-LANGUAGES-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/name.spec.ts` - Spec IDs are not sequential (gap between APP-NAME-012 and APP-NAME-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/definitions.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-DEFINITIONS-012 and APP-PAGES-DEFINITIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/interactions/click-interaction.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-INTERACTION-CLICK-012 and APP-PAGES-INTERACTION-CLICK-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/interactions/entrance-animation.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-INTERACTION-ENTRANCE-008 and APP-PAGES-INTERACTION-ENTRANCE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/interactions/hover-interaction.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-INTERACTION-HOVER-010 and APP-PAGES-INTERACTION-HOVER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/interactions/interactions.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-INTERACTION-MAIN-008 and APP-PAGES-INTERACTION-MAIN-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/interactions/scroll-interaction.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-INTERACTION-SCROLL-012 and APP-PAGES-INTERACTION-SCROLL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/props.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-PROPS-010 and APP-PAGES-PROPS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/responsive.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-RESPONSIVE-010 and APP-PAGES-RESPONSIVE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/common/variable-reference.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-VARREF-008 and APP-PAGES-VARREF-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/id.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-ID-006 and APP-PAGES-ID-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/layout/banner.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-BANNER-010 and APP-PAGES-BANNER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/layout/footer.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-FOOTER-014 and APP-PAGES-FOOTER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/layout/layout.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-LAYOUT-008 and APP-PAGES-LAYOUT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/layout/navigation/cta-button.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-CTA-010 and APP-PAGES-CTA-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/layout/navigation/nav-links.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-NAVLINKS-010 and APP-PAGES-NAVLINKS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/layout/navigation/navigation.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-NAV-012 and APP-PAGES-NAV-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/layout/sidebar.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-SIDEBAR-012 and APP-PAGES-SIDEBAR-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/analytics.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-ANALYTICS-012 and APP-PAGES-ANALYTICS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/custom-elements.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-CUSTOM-008 and APP-PAGES-CUSTOM-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/favicons/favicon-set.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-FAVICONSET-007 and APP-PAGES-FAVICONSET-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/favicons/favicon.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-FAVICON-008 and APP-PAGES-FAVICON-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/meta.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-META-012 and APP-PAGES-META-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/performance/dns-prefetch.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-DNS-010 and APP-PAGES-DNS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/performance/preload.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-PRELOAD-010 and APP-PAGES-PRELOAD-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/social/open-graph.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-OG-012 and APP-PAGES-OG-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/social/twitter-card.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-TWITTER-012 and APP-PAGES-TWITTER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/article.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-ARTICLE-014 and APP-PAGES-ARTICLE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/breadcrumb.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-BREADCRUMB-010 and APP-PAGES-BREADCRUMB-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/education-event.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-EDUCATIONEVENT-014 and APP-PAGES-EDUCATIONEVENT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/faq-page.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-FAQPAGE-010 and APP-PAGES-FAQPAGE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/local-business.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-LOCALBUSINESS-014 and APP-PAGES-LOCALBUSINESS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/organization.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-ORGANIZATION-014 and APP-PAGES-ORGANIZATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/person.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-PERSON-012 and APP-PAGES-PERSON-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/postal-address.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-POSTALADDRESS-010 and APP-PAGES-POSTALADDRESS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/product.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-PRODUCT-012 and APP-PAGES-PRODUCT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/meta/structured-data/structured-data.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-STRUCTUREDDATA-010 and APP-PAGES-STRUCTUREDDATA-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/name.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-NAME-008 and APP-PAGES-NAME-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/pages.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-017 and APP-PAGES-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/path.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-PATH-019 and APP-PAGES-PATH-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/scripts/external-scripts.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-EXTERNAL-012 and APP-PAGES-EXTERNAL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/scripts/features.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-FEATURES-010 and APP-PAGES-FEATURES-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/scripts/inline-scripts.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-INLINE-010 and APP-PAGES-INLINE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/scripts/scripts.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-SCRIPTS-010 and APP-PAGES-SCRIPTS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/pages/sections.spec.ts` - Spec IDs are not sequential (gap between APP-PAGES-SECTIONS-013 and APP-PAGES-SECTIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/array-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-ARRAY-005 and APP-TABLES-FIELD-TYPES-ARRAY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/autonumber-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-AUTONUMBER-005 and APP-TABLES-FIELD-TYPES-AUTONUMBER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/barcode-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-BARCODE-005 and APP-TABLES-FIELD-TYPES-BARCODE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/button-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-BUTTON-007 and APP-TABLES-FIELD-TYPES-BUTTON-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/checkbox-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-CHECKBOX-005 and APP-TABLES-FIELD-TYPES-CHECKBOX-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/color-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-COLOR-005 and APP-TABLES-FIELD-TYPES-COLOR-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/common/indexed.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-INDEXED-005 and APP-TABLES-FIELD-INDEXED-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/common/required.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-REQUIRED-004 and APP-TABLES-FIELD-REQUIRED-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/common/unique.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-UNIQUE-005 and APP-TABLES-FIELD-UNIQUE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/count-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-COUNT-007 and APP-TABLES-FIELD-TYPES-COUNT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/created-at-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-CREATED-AT-005 and APP-TABLES-FIELD-TYPES-CREATED-AT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/created-by-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-CREATED-BY-005 and APP-TABLES-FIELD-TYPES-CREATED-BY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/currency-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-CURRENCY-005 and APP-TABLES-FIELD-TYPES-CURRENCY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/date-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DATE-005 and APP-TABLES-FIELD-TYPES-DATE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/datetime-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DATETIME-005 and APP-TABLES-FIELD-TYPES-DATETIME-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/decimal-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DECIMAL-005 and APP-TABLES-FIELD-TYPES-DECIMAL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/deleted-at-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DELETED-AT-005 and APP-TABLES-FIELD-TYPES-DELETED-AT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/deleted-by-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DELETED-BY-005 and APP-TABLES-FIELD-TYPES-DELETED-BY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/duration-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DURATION-005 and APP-TABLES-FIELD-TYPES-DURATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/email-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-EMAIL-005 and APP-TABLES-FIELD-EMAIL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/formula-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-FORMULA-122 and APP-TABLES-FIELD-TYPES-FORMULA-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/geolocation-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-GEOLOCATION-005 and APP-TABLES-FIELD-TYPES-GEOLOCATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/integer-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-INTEGER-005 and APP-TABLES-FIELD-TYPES-INTEGER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/json-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-JSON-005 and APP-TABLES-FIELD-TYPES-JSON-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/long-text-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-LONG-TEXT-005 and APP-TABLES-FIELD-LONG-TEXT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/lookup-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-LOOKUP-011 and APP-TABLES-FIELD-TYPES-LOOKUP-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/multi-select-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-MULTI-SELECT-008 and APP-TABLES-FIELD-TYPES-MULTI-SELECT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/multiple-attachments-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-MULTIPLE-ATTACHMENTS-007 and APP-TABLES-FIELD-TYPES-MULTIPLE-ATTACHMENTS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/percentage-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-PERCENTAGE-005 and APP-TABLES-FIELD-TYPES-PERCENTAGE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/phone-number-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-PHONE-NUMBER-005 and APP-TABLES-FIELD-PHONE-NUMBER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/progress-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-PROGRESS-002 and APP-TABLES-FIELD-TYPES-PROGRESS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/rating-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-RATING-005 and APP-TABLES-FIELD-TYPES-RATING-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/relationship-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-RELATIONSHIP-014 and APP-TABLES-FIELD-TYPES-RELATIONSHIP-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/rich-text-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-RICH-TEXT-005 and APP-TABLES-FIELD-TYPES-RICH-TEXT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/rollup-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-ROLLUP-013 and APP-TABLES-FIELD-TYPES-ROLLUP-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/single-attachment-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-SINGLE-ATTACHMENT-007 and APP-TABLES-FIELD-TYPES-SINGLE-ATTACHMENT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/single-line-text-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-SINGLE-LINE-TEXT-019 and APP-TABLES-FIELD-SINGLE-LINE-TEXT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/single-select-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-SINGLE-SELECT-007 and APP-TABLES-FIELD-TYPES-SINGLE-SELECT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/special-fields-in-formulas.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-SPECIAL-FIELDS-006 and APP-TABLES-SPECIAL-FIELDS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/status-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-STATUS-008 and APP-TABLES-FIELD-TYPES-STATUS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/time-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-TIME-005 and APP-TABLES-FIELD-TYPES-TIME-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/timezone-handling.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-TIMEZONE-009 and APP-TABLES-TIMEZONE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/updated-at-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-UPDATED-AT-005 and APP-TABLES-FIELD-TYPES-UPDATED-AT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/updated-by-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-UPDATED-BY-005 and APP-TABLES-FIELD-TYPES-UPDATED-BY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/url-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-URL-005 and APP-TABLES-FIELD-URL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/user-field.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-USER-005 and APP-TABLES-FIELD-TYPES-USER-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/fields.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELDS-016 and APP-TABLES-FIELDS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/id.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-ID-006 and APP-TABLES-ID-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/indexes.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-INDEXES-010 and APP-TABLES-INDEXES-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/name.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-NAME-002 and APP-TABLES-NAME-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/permissions/field-permissions.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FIELD-PERMISSIONS-009 and APP-TABLES-FIELD-PERMISSIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/permissions/organization-isolation.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-ORG-ISOLATION-011 and APP-TABLES-ORG-ISOLATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/permissions/permissions.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-PERMISSIONS-010 and APP-TABLES-PERMISSIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/permissions/record-permissions.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-RECORD-PERMISSIONS-005 and APP-TABLES-RECORD-PERMISSIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/permissions/rls-enforcement.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-RLS-ENFORCEMENT-014 and APP-TABLES-RLS-ENFORCEMENT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/permissions/session-context.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-SESSION-CTX-005 and APP-TABLES-SESSION-CTX-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/permissions/table-permissions.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-TABLE-PERMISSIONS-005 and APP-TABLES-TABLE-PERMISSIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/primary-key.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-PRIMARYKEY-010 and APP-TABLES-PRIMARYKEY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/relationships/foreign-keys.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-FK-014 and APP-TABLES-FK-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/tables.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-044 and APP-TABLES-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/unique-constraints-null.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-UNIQUECONSTRAINTS-NULL-007 and APP-TABLES-UNIQUECONSTRAINTS-NULL-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/unique-constraints.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-UNIQUECONSTRAINTS-009 and APP-TABLES-UNIQUECONSTRAINTS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/views/view-condition.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-VIEW-CONDITION-005 and APP-TABLES-VIEW-CONDITION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/views/view-fields.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-VIEW-FIELDS-004 and APP-TABLES-VIEW-FIELDS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/views/view-filters.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-VIEW-FILTERS-006 and APP-TABLES-VIEW-FILTERS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/views/view-group-by.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-VIEW-GROUP-BY-004 and APP-TABLES-VIEW-GROUP-BY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/views/view-sorts.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-VIEW-SORTS-004 and APP-TABLES-VIEW-SORTS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/views/view.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-VIEW-004 and APP-TABLES-VIEW-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/tables/views/views.spec.ts` - Spec IDs are not sequential (gap between APP-TABLES-VIEWS-008 and APP-TABLES-VIEWS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/theme/animations.spec.ts` - Spec IDs are not sequential (gap between APP-THEME-ANIMATIONS-023 and APP-THEME-ANIMATIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/theme/border-radius.spec.ts` - Spec IDs are not sequential (gap between APP-THEME-RADIUS-014 and APP-THEME-RADIUS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/theme/breakpoints.spec.ts` - Spec IDs are not sequential (gap between APP-THEME-BREAKPOINTS-009 and APP-THEME-BREAKPOINTS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/theme/colors.spec.ts` - Spec IDs are not sequential (gap between APP-THEME-COLORS-015 and APP-THEME-COLORS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/theme/fonts.spec.ts` - Spec IDs are not sequential (gap between APP-THEME-FONTS-012 and APP-THEME-FONTS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/theme/shadows.spec.ts` - Spec IDs are not sequential (gap between APP-THEME-SHADOWS-016 and APP-THEME-SHADOWS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/theme/spacing.spec.ts` - Spec IDs are not sequential (gap between APP-THEME-SPACING-013 and APP-THEME-SPACING-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/theme/theme.spec.ts` - Spec IDs are not sequential (gap between APP-THEME-012 and APP-THEME-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `app/version.spec.ts` - Spec IDs are not sequential (gap between APP-VERSION-007 and APP-VERSION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/build/assets.spec.ts` - Spec IDs are not sequential (gap between CLI-BUILD-ASSETS-004 and CLI-BUILD-ASSETS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/build/deployment.spec.ts` - Spec IDs are not sequential (gap between CLI-BUILD-DEPLOY-006 and CLI-BUILD-DEPLOY-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/build/generation.spec.ts` - Spec IDs are not sequential (gap between CLI-BUILD-GENERATION-006 and CLI-BUILD-GENERATION-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/build/i18n.spec.ts` - Spec IDs are not sequential (gap between CLI-BUILD-I18N-004 and CLI-BUILD-I18N-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/start/env-schema.spec.ts` - Spec IDs are not sequential (gap between CLI-START-ENV-011 and CLI-START-ENV-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/start/format-detection.spec.ts` - Spec IDs are not sequential (gap between CLI-START-FORMAT-005 and CLI-START-FORMAT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/start/json-config.spec.ts` - Spec IDs are not sequential (gap between CLI-START-JSON-006 and CLI-START-JSON-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/start/watch-mode.spec.ts` - Spec IDs are not sequential (gap between CLI-START-WATCH-007 and CLI-START-WATCH-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `cli/start/yaml-config.spec.ts` - Spec IDs are not sequential (gap between CLI-START-YAML-007 and CLI-START-YAML-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/migration-system/audit-trail.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-AUDIT-006 and MIGRATION-AUDIT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/migration-system/checksum.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-CHECKSUM-004 and MIGRATION-CHECKSUM-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/migration-system/error-handling.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-ERROR-010 and MIGRATION-ERROR-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/migration-system/rollback.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-ROLLBACK-008 and MIGRATION-ROLLBACK-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/add-field.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-ALTER-ADD-006 and MIGRATION-ALTER-ADD-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/modify-field-constraints.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-MODIFY-CONSTRAINTS-004 and MIGRATION-MODIFY-CONSTRAINTS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/modify-field-default.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-MODIFY-DEFAULT-003 and MIGRATION-MODIFY-DEFAULT-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/modify-field-options.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-MODIFY-OPTIONS-004 and MIGRATION-MODIFY-OPTIONS-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/modify-field-required.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-MODIFY-REQUIRED-004 and MIGRATION-MODIFY-REQUIRED-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/modify-field-type.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-MODIFY-TYPE-006 and MIGRATION-MODIFY-TYPE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/modify-field-unique.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-MODIFY-FIELD-UNIQUE-003 and MIGRATION-MODIFY-FIELD-UNIQUE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/modify-indexes.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-MODIFY-INDEX-006 and MIGRATION-MODIFY-INDEX-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/modify-unique-constraints.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-MODIFY-UNIQUE-005 and MIGRATION-MODIFY-UNIQUE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/remove-field.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-ALTER-REMOVE-004 and MIGRATION-ALTER-REMOVE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/rename-field.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-ALTER-RENAME-004 and MIGRATION-ALTER-RENAME-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/rename-table.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-RENAME-TABLE-004 and MIGRATION-RENAME-TABLE-REGRESSION)
- **NON_SEQUENTIAL_IDS** in `migrations/schema-evolution/views.spec.ts` - Spec IDs are not sequential (gap between MIGRATION-VIEW-006 and MIGRATION-VIEW-REGRESSION)
...
🟡 **111 files** | **927 tests** | [██████░░░░░░░░░░░░░░] 28% | Early Stage

<details>
<summary>View API specs (111 files, 264/927 passing)</summary>
...
**2/21** passing | 19 fixme | 20 @spec | 1 @regression
...
⏸️ **API-ACTIVITY-DETAILS-008** `@spec`
...
#### 🚧 auth > admin > create-user > post (27%)
...
⏸️ **API-AUTH-ADMIN-LIST-USERS-REGRESSION** `@regression`
...
#### 🚧 auth > admin > revoke-user-session > post (33%)

📁 `api/auth/admin/revoke-user-session/post.spec.ts`

**Admin: Revoke user session**

**3/9** passing | 6 fixme | 8 @spec | 1 @regression
...
⏸️ **API-AUTH-ADMIN-SET-USER-PASSWORD-REGRESSION** `@regression`
...
#### 🚧 auth > magic-link > send > post (17%)

📁 `api/auth/magic-link/send/post.spec.ts`

**Send Magic Link**

**1/6** passing | 5 fixme | 5 @spec | 1 @regression
...
⏸️ **API-AUTH-MAGIC-LINK-VERIFY-REGRESSION** `@regression`
API-AUTH-MAGIC-LINK-VERIFY-REGRESSION: user can complete full magic link verification workflow
`~G~/~W~/~T~` Line 218

</details>

#### 🚧 auth > organization > accept-invitation > post (33%)
...
⏸️ **API-AUTH-ORG-ACCEPT-INVITATION-REGRESSION** `@regression`
...
⏸️ **API-AUTH-ORG-CANCEL-INVITATION-REGRESSION** `@regression`
API-AUTH-ORG-CANCEL-INVITATION-REGRESSION: user can complete full cancelInvitation workflow
`~G~/W/T` Line 449

</details>

#### ✅ auth > organization > create-organization > post (100%)
...
✅ **API-AUTH-ORG-CREATE-ORGANIZATION-REGRESSION** `@regression`
API-AUTH-ORG-CREATE-ORGANIZATION-REGRESSION: user can complete full createOrganization workflow
`~G~/~W~/~T~` Line 215

</details>

#### 🚧 auth > organization > delete-organization > delete (0%)
...
⏸️ **API-AUTH-ORG-DELETE-ORGANIZATION-REGRESSION** `@regression`
API-AUTH-ORG-DELETE-ORGANIZATION-REGRESSION: user can complete full deleteOrganization workflow
`~G~/W/T` Line 288

</details>

#### 🚧 auth > organization > dynamic-roles > assign-role > post (0%)

📁 `api/auth/organization/dynamic-roles/assign-role/post.spec.ts`
...
✅ **API-AUTH-ORG-GET-ORGANIZATION-001** `@spec`
...
✅ **API-AUTH-ORG-GET-ORGANIZATION-003** `@spec`
...
⏸️ **API-AUTH-ORG-INVITE-MEMBER-REGRESSION** `@regression`
API-AUTH-ORG-INVITE-MEMBER-REGRESSION: user can complete full inviteMember workflow
`~G~/W/T` Line 472

</details>

#### 🚧 auth > organization > list-invitations > get (33%)
...
⏸️ **API-AUTH-ORG-REJECT-INVITATION-REGRESSION** `@regression`
API-AUTH-ORG-REJECT-INVITATION-REGRESSION: user can complete full rejectInvitation workflow
`~G~/W/T` Line 356

</details>

#### 🚧 auth > organization > remove-member > delete (0%)
...
⏸️ **API-AUTH-ORG-REMOVE-MEMBER-REGRESSION** `@regression`
API-AUTH-ORG-REMOVE-MEMBER-REGRESSION: user can complete full removeMember workflow
`~G~/W/T` Line 438

</details>

#### ✅ auth > organization > set-active-organization > post (100%)
...
⏸️ **API-AUTH-ORG-UPDATE-MEMBER-ROLE-REGRESSION** `@regression`
API-AUTH-ORG-UPDATE-MEMBER-ROLE-REGRESSION: user can complete full updateMemberRole workflow
`~G~/W/T` Line 329

</details>

#### 🚧 auth > organization > update-organization > patch (0%)
...
#### 🚧 auth > sign-up > email > post (94%)

📁 `api/auth/sign-up/email/post.spec.ts`

**Sign up with email and password**

**15/16** passing | 1 fixme | 15 @spec | 1 @regression
...
⏸️ **API-AUTH-TWO-FACTOR-ENABLE-REGRESSION** `@regression`
API-AUTH-TWO-FACTOR-ENABLE-REGRESSION: user can complete full 2FA enable workflow
`G/W/T` Line 197

</details>

#### 🚧 auth > two-factor > verify > post (14%)
...
⏸️ **API-AUTH-TWO-FACTOR-VERIFY-REGRESSION** `@regression`
...
#### 🚧 security > https-redirect (0%)

📁 `api/security/https-redirect.spec.ts`
...
**3/6** passing | 3 fixme | 5 @spec | 1 @regression
...
#### ✅ tables > permissions > api-bulk-operations (100%)

📁 `api/tables/permissions/api-bulk-operations.spec.ts`

**API Bulk Operations with Permissions**
...
⏸️ **API-TABLES-PERMISSIONS-FIELD-005** `@spec`
API-TABLES-PERMISSIONS-FIELD-005: should return 403 when filtering by restricted field
`G/W/T` Line 355

⏸️ **API-TABLES-PERMISSIONS-FIELD-REGRESSION** `@regression`
API-TABLES-PERMISSIONS-FIELD-REGRESSION: complete field permission workflow via API
`~G~/~W~/~T~` Line 414

</details>

#### 🚧 tables > permissions > api-organization-isolation (25%)

📁 `api/tables/permissions/api-organization-isolation.spec.ts`
...
#### 🚧 tables > {tableId} > permissions > get (14%)
...
#### 🚧 tables > {tableId} > records > batch > patch (0%)

📁 `api/tables/{tableId}/records/batch/patch.spec.ts`

**Batch update records**

**0/16** passing | 16 fixme | 15 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > batch > post (0%)

📁 `api/tables/{tableId}/records/batch/post.spec.ts`

**Batch create records**

**0/17** passing | 17 fixme | 16 @spec | 1 @regression
...
⏸️ **API-TABLES-RECORDS-BATCH-POST-016** `@spec`
...
#### 🚧 tables > {tableId} > records > format (0%)

📁 `api/tables/{tableId}/records/format.spec.ts`

**Record Display Formatting**

**0/25** passing | 25 fixme | 24 @spec | 1 @regression
...
⏸️ **API-TABLES-RECORDS-LIST-REGRESSION** `@regression`
...
#### 🚧 tables > {tableId} > records > post (5%)

📁 `api/tables/{tableId}/records/post.spec.ts`

**Create new record**

**1/19** passing | 18 fixme | 18 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > get (0%)

📁 `api/tables/{tableId}/records/{recordId}/comments/get.spec.ts`

**List comments on a record**

**0/12** passing | 12 fixme | 11 @spec | 1 @regression
...
⏸️ **API-TABLES-RECORDS-COMMENTS-LIST-003** `@spec`
...
⏸️ **API-TABLES-RECORDS-COMMENTS-LIST-011** `@spec`
...
#### 🚧 tables > {tableId} > records > {recordId} > comments > post (0%)
...
⏸️ **API-TABLES-RECORDS-COMMENTS-CREATE-005** `@spec`
...
⏸️ **API-TABLES-RECORDS-COMMENTS-CREATE-011** `@spec`
...
#### 🚧 tables > {tableId} > records > {recordId} > delete (21%)

📁 `api/tables/{tableId}/records/{recordId}/delete.spec.ts`

**Delete record**

**4/19** passing | 15 fixme | 18 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > {recordId} > get (8%)

📁 `api/tables/{tableId}/records/{recordId}/get.spec.ts`

**Get record by ID**

**1/13** passing | 12 fixme | 12 @spec | 1 @regression
...
⏸️ **API-TABLES-RECORDS-GET-REGRESSION** `@regression`
API-TABLES-RECORDS-GET-REGRESSION: user can complete full get record workflow
`~G~/~W~/~T~` Line 490

</details>

#### 🚧 tables > {tableId} > records > {recordId} > history > get (0%)
...
#### 🚧 tables > {tableId} > records > {recordId} > patch (6%)

📁 `api/tables/{tableId}/records/{recordId}/patch.spec.ts`

**Update record**

**1/18** passing | 17 fixme | 17 @spec | 1 @regression
...
#### 🚧 tables > {tableId} > records > {recordId} > restore > post (10%)

📁 `api/tables/{tableId}/records/{recordId}/restore/post.spec.ts`

**Restore record**

**1/10** passing | 9 fixme | 9 @spec | 1 @regression
...
⏸️ **API-TABLES-RECORDS-RESTORE-009** `@spec`
...
🔴 **131 files** | **1471 tests** | [████████████████████] 100% | Review Needed

<details>
<summary>View APP specs (131 files, 1471/1471 passing)</summary>
...
**11/11** passing | 0 fixme | 9 @spec | 1 @regression
...
#### ✅ tables > permissions > organization-isolation (100%)
...
✅ **APP-TABLES-ORG-ISOLATION-010** `@spec`
...
✅ **APP-TABLES-TABLE-PERMISSIONS-REGRESSION** `@regression`
...
🟢 **9 files** | **65 tests** | [████████████████████] 100% | Review Needed
...
🟢 **17 files** | **104 tests** | [████████████████████] 100% | Review Needed
