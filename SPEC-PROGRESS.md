...
> Generated: 2026-02-02T01:09:31.911Z
>
...
| ------------------------ | -------------------------------------------- | ------------------ |
| **Overall Progress**     | [██████████████████░░] 92% (2075/2244 tests) | 🟡 Needs Attention |
| **Daily Velocity**       | 4.77 specs/day                               | 🔴 Slow            |
...
- **Maintain velocity** - Need 5 specs/day to hit ETA (current: 4.77)
- **169 tests remaining** - TDD automation running
...
| -------------------------------- | ---------------- | --------- | --------- |
| `API-TABLES-RECORDS-UPDATE-007`  | 2026-02-02 02:00 | `fe79f73` | 🤖 TDD    |
...
🟡 **69 files** | **617 tests** | [███████████████░░░░░] 73% | In Progress

<details>
<summary>View API specs (69 files, 448/617 passing)</summary>
...
#### 🚧 tables > {tableId} > records > {recordId} > patch (44%)

📁 `api/tables/{tableId}/records/{recordId}/patch.spec.ts`

**Update record**

**7/16** passing | 9 fixme | 15 @spec | 1 @regression
