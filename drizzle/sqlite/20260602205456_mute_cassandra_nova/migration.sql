...
CREATE TABLE `system_ai_compute_status` (
	...
	`error` text,
	`updated_at` integer NOT NULL,
	PRIMARY KEY(`app_id`, `table_name`, `record_id`, `field_name`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `user_table_preferences_user_table_idx` ON `system_user_table_preferences` (`user_id`,`table_name`);--> statement-breakpoint
