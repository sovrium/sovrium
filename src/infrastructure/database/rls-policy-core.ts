 ...
 *
 * Translates permission condition variables to PostgreSQL current_setting() calls.
 * Supports: {userId}, {organizationId}, {user.property}
 *
 * @param permission - Permission configuration
...
export const generateCustomCheck = (permission?: TablePermission): string | undefined => {
  ...
  // Translate variables like {userId} to current_setting('app.user_id', true)::TEXT
