...
// eslint-disable-next-line complexity, functional/prefer-immutable-types -- Hono Context type is mutable by library design; handler covers all 4xx/5xx code paths in a flat structure
