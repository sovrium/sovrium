...
import type { DataTableRowExpand } from '@/domain/models/app/pages/components/component-types/data/table/schema'
...
function rowExpandDrawerId(component: Component | undefined): string {
  ...
  const base = (comp['id'] as string | undefined) ?? dataSource?.table ?? 'table'
