...
import { substituteRecordInInputData } from '@/presentation/render/resolve/record-template-substitution'
 ...
 * `substituteRecordVars` is injected here — the ONE implementation, which maps
 * a null and a missing field alike to the empty string.
 */
