...
const renderSkeletonBody = ({ placeholder, allowAttachments }: AiChatProps): ReactElement => (
  <>
    ...
    <div
      ...
      aria-live="polite"
      className="chat-messages flex-1 overflow-y-auto p-4 text-sm text-gray-700"
    />
...
export const aiChatComponent: ComponentRenderer = ({ elementProps, rawProps }) => {
  ...
  return (
    <div
      ...
      className="ai-chat-container flex flex-col rounded-lg border border-gray-200 bg-white"
