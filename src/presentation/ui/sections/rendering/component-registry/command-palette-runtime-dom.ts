...
export const COMMAND_PALETTE_RUNTIME_DOM = `
  ...
  function ensureOverlay() {
    ...
    overlay.style.background = 'color-mix(in oklab, var(--color-scrim, #000) 40%, transparent)';

    var panel = document.createElement('div');
    panel.style.width = '100%';
    panel.style.maxWidth = '36rem';
    panel.style.background = 'var(--color-background-raised, #ffffff)';
    panel.style.color = 'var(--color-foreground, #171717)';
    ...
    input.style.borderBottom = '1px solid var(--color-border, #e5e7eb)';
  ...
  function buildCreateDialog(tableName) {
    ...
    dialog.style.background = 'color-mix(in oklab, var(--color-scrim, #000) 40%, transparent)';
