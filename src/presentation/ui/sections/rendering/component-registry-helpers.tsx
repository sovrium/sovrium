 ...
 * - NOTE: For user-generated HTML, use `sanitizeRichTextHTML`
 *   (`@/domain/utils/html-sanitization`) — the canonical project-wide sanitizer.
 */
export function parseHTMLContent(htmlString: string) {
  // eslint-disable-next-line react-perf/jsx-no-new-object-as-prop -- helper invoked from SSR render functions; no client re-render
