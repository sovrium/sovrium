...
/**
 * Convert a field/property name to a human-readable label
 *
 * Transforms a camelCase, snake_case, or kebab-case field identifier into a
 * Title-Cased phrase suitable for use as an HTML form label.
 *
 ...
 *
 * @param fieldName - Raw field/property name
 ...
 * humanizeFieldName('first-name')     // 'First Name'
 * humanizeFieldName('emailAddress')   // 'Email Address'
 * humanizeFieldName('phone')          // 'Phone'
 * ```
 */
