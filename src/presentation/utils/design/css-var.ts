...
export const TOKENS = {
  ...
  borderInverse: 'oklch(0.205 0 0)',

  fg: 'oklch(0.14 0 0)',
  fgMuted: 'oklch(0.445 0 0)',
  fgSubtle: 'oklch(0.54 0 0)',
  fgDisabled: 'oklch(0.71 0 0)',
  fgInverse: 'oklch(0.985 0 0)',
  primary: 'oklch(0.205 0 0)',
  primaryHover: 'oklch(0.272 0 0)',
  primaryActive: 'oklch(0.14 0 0)',
  primaryFg: 'oklch(0.985 0 0)',
  primarySubtle: 'oklch(0.965 0 0)',
  primarySubtleFg: 'oklch(0.205 0 0)',

  focusRing: 'oklch(0.205 0 0)',
