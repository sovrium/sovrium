  ...
  routes: [
    {
      ...
      responses: {
        200: effectJsonResponse(listTablesResponseSchema, 'List of tables'),
...
const routes: readonly RouteSpec[] = [
  {
    ...
    responses: {
      200: effectJsonResponse(getTableResponseSchema, 'Table details'),
      401: errorResponse('Unauthorized'),
  ...
  },
  {
    ...
    responses: {
      200: effectJsonResponse(getTablePermissionsResponseSchema, 'Table permissions'),
      401: errorResponse('Unauthorized'),
      404: errorResponse('Table not found'),
    },
  },
