...
import { type AgentTurnBinding } from '@/presentation/api/ai/agent-chat'
import { recordActivityLogRow, recordChatActivity } from '@/presentation/api/ai/chat-activity-log'
import { completeTriggerTurn } from '@/presentation/api/ai/chat-automation-flow'
 ...
 */
/**
 * S1 anti-enumeration: an authorization denial in chat answers 404, so a caller
