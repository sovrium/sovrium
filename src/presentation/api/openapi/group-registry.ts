...
import { adminGroup } from '../admin/openapi'
import { activeScopeGroup } from '../admin/openapi-active-scope'
import { agentCollectionGroup, agentGroupSpec } from '../agents/openapi'
import { aiChatGroup } from '../ai/openapi-chat'
import { aiConversationGroup } from '../ai/openapi-conversations'
import { aiFactsGroup } from '../ai/openapi-facts'
import { ragGroup } from '../ai/openapi-rag'
...
import { formGroupSpec } from '../forms/openapi'
import { mcpGroup } from '../mcp/openapi'
import { healthGroup } from '../server/openapi'
import { tableCollectionGroup, tableGroupSpec } from '../tables/openapi'
import { activityGroup } from '../tables/openapi-activity'
import { batchGroupSpec } from '../tables/openapi-batch'
import { recordsGroupSpec } from '../tables/openapi-record'
import { viewGroupSpec } from '../tables/openapi-view'
