...
// `help-text`, `form-field-legend`, …) stay so `app.theme`-driven CSS that
 ...
 */
// eslint-disable-next-line max-lines-per-function -- see jsdoc above (Prettier-expanded leaf dispatcher)
