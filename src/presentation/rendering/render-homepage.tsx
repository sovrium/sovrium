 ...
 * For pages with dataSource bindings, fetches records from the database before rendering.
 *
...
export async function renderPageByPath(
  ...
  const page = await resolvePageDataSourcesAsync(rawPage, app)
...
export async function renderPage(
  ...
  const result = await renderPageByPath(app, path, detectedLanguage)
