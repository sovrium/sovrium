...
/**
 * Menu island — wraps Base UI Menu for dropdown menus.
 *
 * Provides a contextual menu with keyboard navigation (arrow keys),
 * item icons, keyboard shortcut hints, separators, and destructive variants.
 * Used for both `dropdown-menu` and can be adapted for `context-menu`.
 */
export default function MenuIsland({
  ...
  return (
    <Menu.Root>
      ...
      >
        {triggerHtml ? (
          // eslint-disable-next-line react-perf/jsx-no-new-object-as-prop -- preserves SSR trigger HTML on initial paint; menu re-render cost dominated by open/close, not this branch
