 ...
 */
// eslint-disable-next-line max-lines-per-function -- 53 lines with 3 branches, further extraction harms readability
      ...
      {rows.map((row, rowIndex) => (
        ...
        >
          {row.getVisibleCells().map((cell) => (
            <td
              key={cell.id}
              className={`${cellClass} ${borderClass} whitespace-nowrap`}
            >
