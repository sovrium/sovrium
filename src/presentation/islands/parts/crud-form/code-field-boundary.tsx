...
function CodeLoading({
  ...
  minLines,
  displayLabel,
}: Pick<CodeEditorFieldProps, 'name' | 'value' | 'minLines' | 'displayLabel'>): ReactElement {
  ...
  return (
    <label>
      ...
      <div
        role="status"
        aria-busy="true"
        className={`${computeCodeEditorFrameClasses()} text-foreground-disabled p-3 font-mono text-sm`}
