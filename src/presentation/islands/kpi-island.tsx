...
import { KpiCard, type KpiTrendConfig } from './kpi/kpi-card'
import {
  aggregateKpi,
...
} from './kpi/kpi-compute'
import { KpiError, KpiLoading, KpiMissingTable } from './kpi/kpi-states'
import { useKpiRecords } from './kpi/use-kpi-records'
...
export default function KpiIsland({
  ...
  if (isError) return <KpiError error={error} />
