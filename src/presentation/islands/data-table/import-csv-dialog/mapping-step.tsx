...
function MappingRow({
  ...
  return (
    <div
      ...
      // eslint-disable-next-line react-perf/jsx-no-new-function-as-prop -- per-row hover handler closes over loop-variable `index`; useCallback inside .map() has equivalent allocation cost. React Compiler will memoize this once enabled in Bun (see docs/infrastructure/ui/react.md).
    ...
    >
      ...
      <ColumnMappingSelect
        ...
        // eslint-disable-next-line react-perf/jsx-no-new-function-as-prop -- per-row change handler closes over loop-variable `index`; useCallback inside .map() has equivalent allocation cost. React Compiler will memoize this once enabled in Bun (see docs/infrastructure/ui/react.md).
