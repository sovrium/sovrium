 ...
 */
// eslint-disable-next-line max-lines-per-function, complexity -- toolbar wires together ~8 conditional button states (search/import/filter/columns/export-selected/export-menu/refresh/density); cluster of inline conditional JSX is intrinsic to the menu UI rather than refactorable into smaller branches
