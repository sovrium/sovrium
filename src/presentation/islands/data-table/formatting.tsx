...
/* eslint-disable react-perf/jsx-no-new-function-as-prop --
   Column-format cell renderers: react-table calls these per row per render;
   a per-cell action handler must close over the row's record. Memoization
   would require lifting state out of the column definition, which is a
   structural change covered by the future data-table split TODO. */
