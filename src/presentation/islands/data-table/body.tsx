...
// eslint-disable-next-line complexity -- Cell content resolution requires checking edit state, editability, and rendering
function renderCellContent({
  ...
  // Render inline editor if this cell is being edited
...
/**
 * Renders grouped table rows with group headers
 */
// eslint-disable-next-line max-lines-per-function -- Complex grouped row rendering with group headers and summaries
...
export function TableBodyRows({
  ...
  // If rowModel is provided (grouping enabled), use grouped rendering
  if (rowModel) {
    return (
...
/**
 * Renders a summary footer row with aggregate computations (count, sum, avg, min, max).
 */
