...
// ---------------------------------------------------------------------------
// Filter operator translation (mirrors useKanbanRecords / useDataTableQuery)
// ---------------------------------------------------------------------------
 ...
 *
 * Galleries display all records up-front as a card grid; we request a large
 * page size rather than paginating client-side. The records API caps `limit`
 * at 100 by default — the foundational spec works within that envelope; the
 * gallery options story (US-002) layers pagination styles on top.
 */
