...
const CLAUDE_MD_BODY = [
  ...
  'config/notifications.yaml             # singleton — notifications',
  ...
  '- **Singletons** (`auth`, `theme`, `analytics`, `languages`, `notifications`,',
  '  `scripts`) → one file per singleton at `config/<singleton>.yaml`. Never split',
  '  these by sub-key.',
