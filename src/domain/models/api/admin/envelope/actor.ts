...
import { email } from '@/domain/models/api/combinators/formats'
 ...
 */
export const actorTypeSchema = Schema.Literals([
  'user',
  'system',
  'api-token',
  'automation',
]).annotate({ description: 'Class of subject that produced the audited action' })
 ...
 */
export const actorRoleSchema = Schema.Literals(['admin', 'operator', 'system']).annotate({
  description:
...
/** @public */
export type ActorType = typeof actorTypeSchema.Type
/** @public */
export type ActorRole = typeof actorRoleSchema.Type
/** @public */
