...
export const searchTermSchema = z
  ...
  .refine((value) => value === undefined || value.length <= SEARCH_TERM_MAX_LENGTH, {
    message: `Search term must be ${SEARCH_TERM_MAX_LENGTH} characters or fewer`,
  })
  .describe(
 ...
 */
export const appliedQuerySchema = z
  .string()
  .nullable()
  .optional()
  .describe(
