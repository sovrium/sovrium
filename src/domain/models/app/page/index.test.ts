...
describe('PageSchema', () => {
  ...
  test('should accept page with access: all', () => {
    // GIVEN: Page with explicit public access
    const page = {
      name: 'public',
      path: '/public',
      meta: { lang: 'en-US', title: 'Public', description: 'Public page' },
      sections: [],
      access: 'all',
    }
  ...
  test('should accept page with access: authenticated', () => {
    // GIVEN: Page requiring authentication
    const page = {
      name: 'dashboard',
      path: '/dashboard',
      meta: { lang: 'en-US', title: 'Dashboard', description: 'Dashboard' },
      sections: [],
  ...
  test('should accept page with role-based access', () => {
    // GIVEN: Page restricted to admin role
    const page = {
      name: 'admin',
      path: '/admin',
      meta: { lang: 'en-US', title: 'Admin', description: 'Admin panel' },
      sections: [],
      access: ['admin'],
    }
    ...
    // THEN: Access should be accepted
    expect(result.access).toEqual(['admin'])
  })

  test('should accept page with extended access and redirect', () => {
    // GIVEN: Page with extended access config
    const page = {
      name: 'profile',
      path: '/profile',
      meta: { lang: 'en-US', title: 'Profile', description: 'User profile' },
      sections: [],
      access: {
    ...
    // THEN: Extended access should be accepted
    expect(result.access).toEqual({ require: 'authenticated', redirectTo: '/login' })
  })

  test('should accept page without access (defaults to public)', () => {
    // GIVEN: Page without access field
    const page = {
      name: 'home',
      path: '/',
      meta: { lang: 'en-US', title: 'Home', description: 'Homepage' },
      sections: [],
    }
    ...
    // THEN: Access should be undefined (treated as public)
