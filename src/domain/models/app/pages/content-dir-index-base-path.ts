 ...
 * base path and 301-redirects its slugged URL. It lives in the `pages` slug,
 * beside the schema whose `path` it reads, and the derivation is a pure
 * function of a plain page-path string with no I/O — so both callers reach it.
 *
