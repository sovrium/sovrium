 ...
 *
 * This validation is used by numeric field types (integer, decimal, etc.) to ensure
 * that range constraints are logically valid. Returns an error message if validation
