 ...
 * The other browser-reachable domain helpers sit in the slug of the feature
 * they serve, or in the kernel when they serve none — `pages/substitute-record-vars`
 * and `kernel/sanitize/email-validation` respectively.
 *
