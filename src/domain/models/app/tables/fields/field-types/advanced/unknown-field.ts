 ...
 *
 * This is an intentional design choice, not a bug. It allows invalid field types
 * to be caught during the migration phase where PostgreSQL transaction rollback
 * can properly handle the error, rather than failing during schema validation
 * before database operations begin.
 *
 * @example
 * ```json
 * {
