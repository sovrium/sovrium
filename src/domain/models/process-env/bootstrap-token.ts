 ...
 *
 * ## Why this sits in `process-env/`
 *
 * This is a Sovrium-internal PERSISTED RECORD living in `pgSchema('system')`,
 * not a process-environment reading, and nothing in `AppSchema` references it —
