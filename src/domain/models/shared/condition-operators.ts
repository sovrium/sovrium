 ...
 * unrelated surfaces now spend it — `data-table` `cellStyle[].when`, a
 * `data-table` action item's `visibleWhen`, and a `button` field's
 ...
 * `data-table` action item, a `button` field. The predicate has no field
