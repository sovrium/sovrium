...
/**
 * Resolve the OTLP metrics-export signal (verbatim `OTEL_EXPORTER_OTLP_METRICS_ENDPOINT`
 * override wins over base + `/v1/metrics`). Same default-OFF gate as log export:
 * armed only when an OTLP endpoint is set.
 */
