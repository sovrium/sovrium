...
import { type PermissionCaller } from '@/domain/models/shared/permission-evaluation'
import { isFieldReadableByCaller } from './field-read-filter'
import { hasReadPermissionForRoles } from './permission-evaluators'
import {
  isPredicateGroup,
