...
import { dataCodewordStream, interleave, selectVersion } from './encode'
import { buildMatrix } from './matrix'
import { matrixToSvg, type QrSvgOptions } from './svg'
import type { EccLevel } from './tables'

export type { EccLevel } from './tables'
export type { QrSvgOptions } from './svg'
export { matrixToSvg } from './svg'
 ...
 * over-capacity case is a VALUE, exactly as `@/domain/services/date-tokens`
