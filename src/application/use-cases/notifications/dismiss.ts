...
/**
 * Dismiss a single notification, scoped to the requesting user.
 *
 * Same authorization model as `markNotificationRead`: re-read the user's
 * inbox and verify ownership before issuing the markDismissed.
 */
