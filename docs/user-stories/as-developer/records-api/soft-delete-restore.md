...
| US-SOFT-DELETE-004 | Restore Deleted Record       | 8                     | Complete |
| US-SOFT-DELETE-005 | Batch Restore Records        | 5                     | Complete |
| US-SOFT-DELETE-006 | List Deleted Records (Trash) | 4                     | Complete |
| US-SOFT-DELETE-007 | Include Deleted in Query     | 4                     | Complete |
