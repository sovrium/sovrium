...
| **Zod**           | 4.3.5   | OpenAPI + client forms    | `src/domain/models/api/` + forms only | OpenAPI tooling compatibility      |
...
// - API schemas and OpenAPI/Hono integration (src/domain/models/api)
