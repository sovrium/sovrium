...
**Real example**: We pinned to SDK 0.2.9 (Claude Code v2.1.9, Jan 16) but used `claude-opus-4-6` (released Feb 5, requires v2.1.32+). Had to downgrade to `claude-opus-4-5`.
...
# BUG: SDK 0.2.22+ has AJV validation crash (maxLength/minLength)
