...
if (!existsSync(join(DIST_DIR, 'client-bundle.js'))) {
  console.error('✗ dist/client-bundle.js not found — run scripts/build-runtime-assets.ts first')
  process.exit(1)
}
...
/* eslint-disable */
// @ts-nocheck
// AUTO-GENERATED by scripts/generate-embedded-runtime-assets.ts — DO NOT EDIT.
