 ...
 *
 * Usage:
 *   bun run scripts/generate-checksums.ts                     # Current directory
 *   bun run scripts/generate-checksums.ts --dir ./release      # Specific directory
 *   bun run scripts/generate-checksums.ts --output checksums.txt
 */
