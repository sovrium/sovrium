...
/**
 * E2E Tests for Language Switcher Component
 *
 * Source: src/domain/models/app/component/language-switcher.ts
 * Spec Count: 3
 *
 * Test Organization:
...
test.describe('Language Switcher Component', () => {
  ...
  // APP-COMPONENTS-LANGUAGE-SWITCHER-001: Dropdown variant
  test(
    'APP-COMPONENTS-LANGUAGE-SWITCHER-001: should render a dropdown menu with all supported languages',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // GIVEN: a language-switcher component with dropdown variant
  ...
  // APP-COMPONENTS-LANGUAGE-SWITCHER-002: ShowFlags enabled
  test(
    'APP-COMPONENTS-LANGUAGE-SWITCHER-002: should display flag emojis next to language labels',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // GIVEN: a language-switcher component with showFlags enabled
      await startServerWithSchema({
        name: 'test-app',
        languages: {
          default: 'en',
  ...
  // APP-COMPONENTS-LANGUAGE-SWITCHER-003: Minimal configuration
  test(
    'APP-COMPONENTS-LANGUAGE-SWITCHER-003: should use default variant (dropdown) and no flags',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // GIVEN: a language-switcher component with minimal configuration
      await startServerWithSchema({
        name: 'test-app',
        languages: {
          default: 'en',
  ...
  test(
    'APP-COMPONENTS-LANGUAGE-SWITCHER-REGRESSION: user can complete full language-switcher workflow',
    { tag: '@regression' },
    async ({ page, startServerWithSchema }) => {
      await test.step('APP-COMPONENTS-LANGUAGE-SWITCHER-001: Render dropdown menu with all supported languages', async () => {
        await startServerWithSchema({
          name: 'test-app',
          languages: {
            default: 'en',
      ...
      await test.step('APP-COMPONENTS-LANGUAGE-SWITCHER-002: Display flag emojis next to language labels', async () => {
        await startServerWithSchema({
          name: 'test-app',
          languages: {
            default: 'en',
      ...
      await test.step('APP-COMPONENTS-LANGUAGE-SWITCHER-003: Use default variant (dropdown) and no flags', async () => {
        await startServerWithSchema({
          name: 'test-app',
          languages: {
            default: 'en',
