...
test.describe('Component Props', () => {
  ...
  test(
    'APP-COMPONENTS-PROPS-001: should validate any valid JavaScript property name at build time',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      await startServerWithSchema({
        ...
        pages: [
          { name: 'Home', path: '/', sections: [{ component: 'props-component', vars: {} }] },
        ],
      })
      ...
      const component = page.locator('[data-testid="component-props-component"]')
      await expect(component).toHaveClass(/text-blue/)
      await expect(component).toHaveAttribute('id', 'main')
      await expect(component).toHaveAttribute('aria-label', 'Main content')
    }
  )

  test(
    'APP-COMPONENTS-PROPS-002: should render as HTML attributes following camelCase convention',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      await startServerWithSchema({
        ...
        pages: [{ name: 'Home', path: '/', sections: [{ component: 'custom-button', vars: {} }] }],
      })
      ...
      const button = page.locator('[data-testid="component-custom-button"]')
  ...
  test(
    'APP-COMPONENTS-PROPS-003: should render string value with variable substitution',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      const div = page.locator('[data-testid="component-styled-div"]')
  ...
  test(
    'APP-COMPONENTS-PROPS-004: should render numeric value as HTML attribute',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      await startServerWithSchema({
        ...
        pages: [{ name: 'Home', path: '/', sections: [{ component: 'grid-layout', vars: {} }] }],
      })
      ...
      const grid = page.locator('[data-testid="component-grid-layout"]')
  ...
  test(
    'APP-COMPONENTS-PROPS-005: should render boolean as HTML boolean attribute',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      await startServerWithSchema({
        ...
        pages: [{ name: 'Home', path: '/', sections: [{ component: 'form-input', vars: {} }] }],
      })
      ...
      const input = page.locator('[data-testid="component-form-input"]')
  ...
  test(
    'APP-COMPONENTS-PROPS-006: should render object as JSON data attribute',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      await startServerWithSchema({
        ...
        pages: [{ name: 'Home', path: '/', sections: [{ component: 'chart-widget', vars: {} }] }],
      })
      ...
      const widget = page.locator('[data-testid="component-chart-widget"]')
  ...
  test(
    'APP-COMPONENTS-PROPS-007: should render array as JSON data attribute',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      await startServerWithSchema({
        ...
        pages: [{ name: 'Home', path: '/', sections: [{ component: 'tag-list', vars: {} }] }],
      })
      ...
      const list = page.locator('[data-testid="component-tag-list"]')
  ...
  test(
    'APP-COMPONENTS-PROPS-008: should render with all variables substituted in className',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      const box = page.locator('[data-testid="component-multi-var-box"]')
  ...
  test(
    'APP-COMPONENTS-PROPS-009: should render combined static and dynamic className parts',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
        ...
        pages: [
          {
            name: 'Home',
            path: '/',
            sections: [{ component: 'container', vars: { width: '7xl', padding: '4' } }],
          },
        ],
      })
  ...
  test(
    'APP-COMPONENTS-PROPS-010: should render complete component with all configuration applied',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      ...
      const button = page.locator('[data-testid="component-action-button"]')
      await expect(button).toHaveClass(/btn-primary/)
  ...
  test(
    'APP-COMPONENTS-PROPS-011: should resolve translation tokens in component props during rendering',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // GIVEN: component props containing translation tokens ($t:)
      await startServerWithSchema({
        name: 'test-app',
        languages: {
          default: 'en',
      ...
      // WHEN: component is rendered with $t: references in props values
      await page.goto('/')
  ...
  test(
    'APP-COMPONENTS-PROPS-012: should resolve translation tokens in component children during rendering',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // GIVEN: component children containing translation tokens ($t:)
      await startServerWithSchema({
        name: 'test-app',
        languages: {
          default: 'en',
      ...
      // WHEN: component is rendered with $t: references in children arrays
      await page.goto('/')
      ...
      const nav = page.locator('[data-testid="component-nav-menu"]')
      // THEN: assertion
  ...
  test(
    'APP-COMPONENTS-PROPS-013: should resolve translation tokens in component content during rendering',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // GIVEN: component content containing translation tokens ($t:)
      await startServerWithSchema({
        name: 'test-app',
        languages: {
          default: 'en',
      ...
      // WHEN: component is rendered with $t: reference in content property
      await page.goto('/')
      ...
      // THEN: assertion
      await expect(page.locator('[data-testid="component-hero-heading"]')).toHaveText(
        'Build your next great app'
      )
      // THEN: assertion
      await expect(page.locator('[data-testid="component-footer-text"]')).toHaveText(
  ...
  test(
    'APP-COMPONENTS-PROPS-014: should work with both translation tokens ($t:) and variable references ($variable)',
    { tag: '@spec' },
    async ({ page, startServerWithSchema }) => {
      // GIVEN: component with both translation tokens ($t:) and variable references ($variable)
      await startServerWithSchema({
        name: 'test-app',
        languages: {
          default: 'en',
      ...
      // WHEN: component uses $t: for translations AND $variable for dynamic data
      await page.goto('/')
      ...
      const card = page.locator('[data-testid="component-product-card"]')
      // THEN: assertion
  ...
  test(
    'APP-COMPONENTS-PROPS-REGRESSION: user can complete full props workflow',
    { tag: '@regression' },
    async ({ page, startServerWithSchema }) => {
      await test.step('APP-COMPONENTS-PROPS-001: Validates any valid JavaScript property name at build time', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-002: Renders as HTML attributes following camelCase convention', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
          ...
          pages: [
            { name: 'Home', path: '/', sections: [{ component: 'custom-button', vars: {} }] },
          ],
        })
        await page.goto('/')
        const button = page.locator('[data-testid="component-custom-button"]')
      ...
      await test.step('APP-COMPONENTS-PROPS-003: Renders string value with variable substitution', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-004: Renders numeric value as HTML attribute', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-005: Renders boolean as HTML boolean attribute', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-006: Renders object as JSON data attribute', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-007: Renders array as JSON data attribute', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-008: Renders with all variables substituted in className', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-009: Renders combined static and dynamic className parts', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-010: Renders complete component with all configuration applied', async () => {
        await startServerWithSchema({
          name: 'test-app',
          components: [
            {
      ...
      await test.step('APP-COMPONENTS-PROPS-011: Resolves translation tokens in component props during rendering', async () => {
        await startServerWithSchema({
          name: 'test-app',
          languages: {
            default: 'en',
          ...
          pages: [
            {
              ...
              path: '/',
              meta: { lang: 'en-US', title: 'Test', description: 'Test page' },
              sections: [{ component: 'action-button', vars: { variant: 'primary' } }],
            },
          ],
        })
        await page.goto('/')
      ...
      await test.step('APP-COMPONENTS-PROPS-012: Resolves translation tokens in component children during rendering', async () => {
        await startServerWithSchema({
          name: 'test-app',
          languages: {
            default: 'en',
      ...
      await test.step('APP-COMPONENTS-PROPS-013: Resolves translation tokens in component content during rendering', async () => {
        await startServerWithSchema({
          name: 'test-app',
          languages: {
            default: 'en',
          ...
          pages: [
            {
              ...
              path: '/',
              meta: { lang: 'en-US', title: 'Test', description: 'Test page' },
              sections: [{ component: 'hero-heading' }, { component: 'footer-text' }],
            },
          ],
        })
        await page.goto('/')
      ...
      await test.step('APP-COMPONENTS-PROPS-014: Works with both translation tokens ($t:) and variable references ($variable)', async () => {
        await startServerWithSchema({
          name: 'test-app',
          languages: {
            default: 'en',
