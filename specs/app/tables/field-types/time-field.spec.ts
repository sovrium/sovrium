...
test.describe('Time Field', () => {
  ...
  test(
    ...
    { tag: '@regression' },
    async ({ startServerWithSchema, executeQuery }) => {
      await test.step('APP-TABLES-FIELD-TYPES-TIME-001: Create PostgreSQL TIME column', async () => {
        await startServerWithSchema({
          name: 'test-app',
          tables: [
            {
      ...
      await test.step('APP-TABLES-FIELD-TYPES-TIME-002: Store time values without date component', async () => {
        await startServerWithSchema({
          name: 'test-app',
          tables: [
            {
      ...
      await test.step('APP-TABLES-FIELD-TYPES-TIME-003: Reject NULL when required', async () => {
        await startServerWithSchema({
          name: 'test-app',
          tables: [
            {
      ...
      await test.step('APP-TABLES-FIELD-TYPES-TIME-005: Create btree index when indexed=true', async () => {
        await startServerWithSchema({
          name: 'test-app',
          tables: [
            {
