...
test.describe('Favicon Set', () => {
  ...
  // Generated from 7 @spec tests - covers: browser icon, Apple touch icon, Safari mask icon,
  // icon dimensions, MIME type, Safari pinned tab color, multi-device support
  // ============================================================================
