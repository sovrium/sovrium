...
test.describe('Page Metadata', () => {
  ...
  // Generated from 12 @spec tests - covers: minimal config, title/description length,
  // keywords, canonical, favicons, CSS/fonts, social sharing, structured data, performance, analytics
  // ============================================================================
