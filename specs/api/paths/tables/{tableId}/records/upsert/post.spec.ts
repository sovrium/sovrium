...
test.describe('Upsert records (create or update)', () => {
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE users (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE NOT NULL, name VARCHAR(255), status VARCHAR(50))
      // TODO: INSERT INTO users (email, name, status) VALUES ('john@example.com', 'John', 'active')
      ...
      // TODO: Verify database contains both records with correct data
      // SELECT COUNT(*) FROM users → count=2
    }
  )
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: Verify database contains both new records
      // SELECT COUNT(*) FROM users → count=2
    }
  )
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE employees (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE, name VARCHAR(255), organization_id VARCHAR(255))
      // TODO: INSERT INTO employees (email, name, organization_id) VALUES ('alice@example.com', 'Alice Cooper', 'org_123')
      ...
      // TODO: Verify no records created or updated in database
      // SELECT name FROM employees WHERE email='alice@example.com' → name='Alice Cooper'
    }
  )
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE projects (id SERIAL PRIMARY KEY, name VARCHAR(255) UNIQUE, organization_id VARCHAR(255))
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE employees (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE, name VARCHAR(255), organization_id VARCHAR(255))
      // TODO: INSERT INTO employees (email, name, organization_id) VALUES ('alice@example.com', 'Alice', 'org_123')
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE employees (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE, name VARCHAR(255), salary DECIMAL(10,2), organization_id VARCHAR(255))
      ...
      const response = await request.post('/api/tables/1/records/upsert', {
        ...
        data: {
          records: [{ email: 'alice@example.com', name: 'Alice Cooper', salary: 85000 }],
          fieldsToMergeOn: ['email'],
        },
      })
  ...
  test.fixme(
    ...
    async ({ request }) => {
      // GIVEN: A member user with field-level write restrictions (salary protected)
      // TODO: CREATE TABLE employees (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE, name VARCHAR(255), salary DECIMAL(10,2), organization_id VARCHAR(255))
      // TODO: INSERT INTO employees (email, name, salary, organization_id) VALUES ('alice@example.com', 'Alice Cooper', 75000, 'org_123')
      // TODO: Setup member permissions: salary.read=false, salary.write=false
      ...
      const response = await request.post('/api/tables/1/records/upsert', {
        ...
        data: {
          records: [{ email: 'alice@example.com', name: 'Updated Alice', salary: 90000 }],
          fieldsToMergeOn: ['email'],
        },
      })
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE employees (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE, name VARCHAR(255), created_at TIMESTAMP DEFAULT NOW(), organization_id VARCHAR(255))
      // TODO: Setup admin user with organizationId='org_123'
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE employees (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE, name VARCHAR(255), salary DECIMAL(10,2), organization_id VARCHAR(255))
      // TODO: INSERT INTO employees (email, name, salary, organization_id) VALUES ('alice@example.com', 'Alice', 75000, 'org_123')
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE employees (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE, name VARCHAR(255), salary DECIMAL(10,2), organization_id VARCHAR(255))
      // TODO: INSERT INTO employees (email, name, salary, organization_id) VALUES ('charlie@example.com', 'Charlie', 120000, 'org_789')
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      // TODO: CREATE TABLE employees (id SERIAL PRIMARY KEY, email VARCHAR(255) UNIQUE, name VARCHAR(255), salary DECIMAL(10,2), organization_id VARCHAR(255))
      // TODO: INSERT INTO employees (email, name, salary, organization_id) VALUES ('alice@example.com', 'Alice', 75000, 'org_123'), ('bob@example.com', 'Bob', 85000, 'org_123')
      // TODO: Setup member permissions: salary.read=false, salary.write=true
  ...
  test.fixme(
    ...
    async ({ request }) => {
      ...
      const fieldForbiddenResponse = await request.post('/api/tables/1/records/upsert', {
        ...
        data: {
          records: [{ email: 'test@example.com', name: 'Test', salary: 99999 }],
          fieldsToMergeOn: ['email'],
        },
      })
