...
test.describe('Admin: List users', () => {
  ...
  test.fixme(
    ...
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (2, 'user1@example.com', '\$2a\$10\$YourHashedPasswordHere', 'User One', true, NOW() - INTERVAL '1 day', NOW())`)
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (3, 'user2@example.com', '\$2a\$10\$YourHashedPasswordHere', 'User Two', false, NOW() - INTERVAL '2 days', NOW())`)
  ...
  test.fixme(
    ...
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (2, 'user1@example.com', '\$2a\$10\$YourHashedPasswordHere', 'User One', true, NOW() - INTERVAL '1 day', NOW())`)
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (3, 'user2@example.com', '\$2a\$10\$YourHashedPasswordHere', 'User Two', false, NOW() - INTERVAL '2 days', NOW())`)
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (4, 'user3@example.com', '\$2a\$10\$YourHashedPasswordHere', 'User Three', true, NOW() - INTERVAL '3 days', NOW())`)
    await executeQuery(`INSERT INTO sessions (id, user_id, token, expires_at, created_at) VALUES (1, 1, 'admin_token', NOW() + INTERVAL '7 days', NOW())`)
  ...
  test.fixme(
    ...
    // Database setup
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, role, created_at, updated_at) VALUES (1, 'admin@example.com', '\$2a\$10\$YourHashedPasswordHere', 'Admin User', true, 'admin', NOW(), NOW())`)
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (2, 'charlie@example.com', '\$2a\$10\$YourHashedPasswordHere', 'Charlie', true, NOW(), NOW())`)
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (3, 'alice@example.com', '\$2a\$10\$YourHashedPasswordHere', 'Alice', true, NOW(), NOW())`)
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (4, 'bob@example.com', '\$2a\$10\$YourHashedPasswordHere', 'Bob', true, NOW(), NOW())`)
    await executeQuery(`INSERT INTO sessions (id, user_id, token, expires_at, created_at) VALUES (1, 1, 'admin_token', NOW() + INTERVAL '7 days', NOW())`)

      // WHEN: Admin requests users sorted by email ascending
    const response = await page.request.get('/api/auth/admin/list-users?sortBy=email&sortOrder=asc', {
      headers: {
      },
    })
  ...
  test.fixme(
    ...
    // Database setup
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, role, created_at, updated_at) VALUES (1, 'admin@example.com', '\$2a\$10\$YourHashedPasswordHere', 'Admin User', true, 'admin', NOW(), NOW())`)
    await executeQuery(`INSERT INTO users (id, email, password_hash, name, email_verified, created_at, updated_at) VALUES (2, 'user@example.com', '\$2a\$10\$YourHashedPasswordHere', 'Regular User', true, 'member', NOW(), NOW())`)
    await executeQuery(`INSERT INTO sessions (id, user_id, token, expires_at, created_at) VALUES (1, 1, 'admin_token', NOW() + INTERVAL '7 days', NOW())`)
