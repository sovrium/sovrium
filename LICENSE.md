...
**Change Date**: 2030-07-17 (Four years from this version's release date)
...
On **July 17, 2030** (four years after this version's release), Sovrium automatically converts to **Apache License 2.0**. After that date, all restrictions are lifted.

### Can I fork Sovrium and compete with it?

You can fork Sovrium for **non-competing purposes**. If your fork becomes a commercial hosted service competing with Sovrium, you need a commercial license or must wait until the Change Date (2030-07-17).
