...
**Change Date**: 2030-05-24 (Four years from this version's release date)
...
On **May 24, 2030** (four years after this version's release), Sovrium automatically converts to **Apache License 2.0**. After that date, all restrictions are lifted.

### Can I fork Sovrium and compete with it?

You can fork Sovrium for **non-competing purposes**. If your fork becomes a commercial hosted service competing with Sovrium, you need a commercial license or must wait until the Change Date (2030-05-24).
