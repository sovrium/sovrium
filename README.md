...
<p align="center">
  <a href="https://git.sovrium.com/sovrium/sovrium/blob/main/LICENSE.md"><img src="https://img.shields.io/badge/license-BSL--1.1-blue" alt="License" /></a>
...
<p align="center">
  ...
  <a href="https://git.sovrium.com/sovrium/sovrium/issues">Issues</a>
</p>
...
| ⌨️  | **CLI**            | `sovrium start` to run your app. `sovrium build` to export a static site. Supports YAML and JSON configs.                               |
...
Sovrium is under **active development**. The core feature set — tables, API, authentication, pages, theming, and i18n — is defined and tested across 331 user stories. Implementation is ongoing with automated pipelines.
