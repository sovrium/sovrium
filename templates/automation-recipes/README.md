...
[![Deploy on Scalingo](https://cdn.scalingo.com/deploy/button.svg)](https://dashboard.scalingo.com/create/app?source=https://github.com/sovrium/automation-recipes)
...
sovrium init my-automation-recipes --template automation-recipes
```

## What's inside

A cookbook of automation patterns: a webhook captures leads, a record trigger notifies and logs, a cron sends the daily digest, and a failure path demonstrates recovery.
