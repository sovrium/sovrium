...
[![Deploy on Scalingo](https://cdn.scalingo.com/deploy/button.svg)](https://dashboard.scalingo.com/create/app?source=https://github.com/sovrium/knowledge-base)
...
The markdown pages feature behind sign-in — company handbook articles live as plain `.md` files under `content/kb/`.
