...
An Airtable/Baserow-style database workspace — manage Companies, Contacts, Deals, and Tasks through interactive grids, a kanban pipeline, a task calendar, and a contact gallery. Built on Sovrium's default theming.

## This app at a glance

- **Tables** (4): companies, contacts, deals, tasks
- **Pages** (6): sign-in, companies, contacts, deals, tasks, assistant
