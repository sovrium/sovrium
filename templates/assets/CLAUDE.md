...
Asset tracker — laptops, monitors, vehicles, and everything else the company owns: barcoded, photographed, valued, assigned to a person, and grouped by location. A quarterly cron nudges the team to run an inventory check.

## This app at a glance

- **Tables** (2): locations, assets
- **Pages** (4): sign-in, inventory, gallery, board
- **Automations** (1): quarterly-inventory-check
