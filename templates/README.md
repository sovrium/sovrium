...
| **inventory**          | Products, stock, and orders as a self-hosted **Airtable alternative**: six linked tables behind spreadsheet-style grids with grouping, saved views, filters and footer summaries. Stock movements drive per-product counts and rollups; line totals are computed in the database. |
