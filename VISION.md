...
> **Vision Document**: This document describes the **purpose, vision, and target state** for Sovrium. Most features described here are **not yet implemented**. For current capabilities, see [SPEC-PROGRESS.md](SPEC-PROGRESS.md). For detailed feature requirements, see [docs/user-stories/](docs/user-stories/).
...
2. **Admin Space**: A comprehensive management interface for configuration, data, users, and analytics

Think of it like **WordPress for business applications**—WordPress has an admin panel for managing content, themes, and plugins. Sovrium has an admin space for managing Tables, Pages, Automations, Users, Permissions, Theme, and more.
...
│  │                     │       │                                     │  │
│  │  • JSON/YAML/TS     │◄─────►│  • App Editor (JSON/Form/AI)       │  │
│  │  • Version Control  │       │  • Schema Versioning & Rollback    │  │
│  │  • CI/CD Friendly   │       │  • Test Environment (Staging)       │  │
│  │  • Code Review      │       │  • Data Manager & Analytics        │  │
│  └─────────────────────┘       └─────────────────────────────────────┘  │
│           │                                      │                      │
│           ▼                                      ▼                      │
│    ┌─────────────────────────────────────────────────────────────┐     │
...
**Key Insight**: The Admin Space and configuration files are **two views of the same data**. Changes in one are reflected in the other. Configuration remains the **single source of truth**.
...
- **Format flexibility** — choose what fits your team
...
| **Customization**   | Unlimited (source access)   | Limited to vendor features |
| **Version Control** | Git-native config files     | Limited or none            |
...
| **Flexibility**      | Config-limited        | Unlimited            |
...
- Enhanced Admin Space features

**Phase 3**: Advanced capabilities

- AI Agent Editor for natural language configuration
- Advanced analytics and user journey tracking
- Publishing workflow with staging environments
...
> For detailed feature requirements, see [docs/user-stories/](docs/user-stories/).
...
**The Approach**: Like WordPress revolutionized content management with self-hosted software and an admin panel, Sovrium revolutionizes business applications with self-hosted configuration and a visual Admin Space.
