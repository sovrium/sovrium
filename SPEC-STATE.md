...
> Generated: 2025-11-27T18:29:25.726Z
>
...
| Warnings | 0 |
| Suggestions | 0 |
| Duplicate Spec IDs | 9 |

**Progress:** [█████████░░░░░░░░░░░] 45% (829/1835)
...
> **CRITICAL**: Each spec ID must be unique across the entire test suite.
> Duplicate IDs will cause issues in the TDD automation queue.

### `API-AUTH-REVOKE-OTHER-SESSIONS-005` (2 occurrences)

- `api/auth/revoke-other-sessions/post.spec.ts:205`
  API-AUTH-REVOKE-OTHER-SESSIONS-005: should returns 200 OK and only revokes User ...
- `api/auth/revoke-other-sessions/post.spec.ts:269`
  API-AUTH-REVOKE-OTHER-SESSIONS-005: user can complete full revokeOtherSessions w...

### `APP-TABLES-VIEW-001` (2 occurrences)

- `app/tables/views/view-fields.spec.ts:27`
  APP-TABLES-VIEW-001: should show only configured fields when a view has specific...
- `app/tables/views/view.spec.ts:27`
  APP-TABLES-VIEW-001: should be valid when validating view schema with id, name, ...

### `APP-TABLES-VIEW-002` (2 occurrences)

- `app/tables/views/view-fields.spec.ts:82`
  APP-TABLES-VIEW-002: should display fields in the specified order when a view ha...
- `app/tables/views/view.spec.ts:68`
  APP-TABLES-VIEW-002: should fail with pattern mismatch error when validating vie...

### `APP-TABLES-VIEW-003` (2 occurrences)

- `app/tables/views/view-fields.spec.ts:131`
  APP-TABLES-VIEW-003: should not show field when it is not included in the view f...
- `app/tables/views/view.spec.ts:104`
  APP-TABLES-VIEW-003: should be applied automatically when view marked as isDefau...

### `APP-TABLES-VIEW-004` (2 occurrences)

- `app/tables/views/view-fields.spec.ts:187`
  APP-TABLES-VIEW-004: user can complete full view-fields workflow
- `app/tables/views/view.spec.ts:163`
  APP-TABLES-VIEW-004: user can complete full view workflow

### `MIGRATION-MODIFY-UNIQUE-001` (2 occurrences)

- `migrations/schema-evolution/modify-field-unique.spec.ts:27`
  MIGRATION-MODIFY-UNIQUE-001: should alter table add constraint unique_users_user...
- `migrations/schema-evolution/modify-unique-constraints.spec.ts:27`
  MIGRATION-MODIFY-UNIQUE-001: should alter table add constraint unique creates co...

### `MIGRATION-MODIFY-UNIQUE-002` (2 occurrences)

- `migrations/schema-evolution/modify-field-unique.spec.ts:74`
  MIGRATION-MODIFY-UNIQUE-002: should migration fails with unique violation error,...
- `migrations/schema-evolution/modify-unique-constraints.spec.ts:76`
  MIGRATION-MODIFY-UNIQUE-002: should alter table drop constraint removes constrai...

### `MIGRATION-MODIFY-UNIQUE-003` (2 occurrences)

- `migrations/schema-evolution/modify-field-unique.spec.ts:117`
  MIGRATION-MODIFY-UNIQUE-003: should alter table drop constraint unique_orders_or...
- `migrations/schema-evolution/modify-unique-constraints.spec.ts:118`
  MIGRATION-MODIFY-UNIQUE-003: should alter table add constraint unique (col1, col...

### `MIGRATION-MODIFY-UNIQUE-004` (2 occurrences)

- `migrations/schema-evolution/modify-field-unique.spec.ts:168`
  MIGRATION-MODIFY-UNIQUE-004: user can complete full modify-field-unique workflow
- `migrations/schema-evolution/modify-unique-constraints.spec.ts:164`
  MIGRATION-MODIFY-UNIQUE-004: should migration fails with data validation error a...
...
⏸️ **API-AUTH-ENFORCE-ADMIN-006** `@spec`
...
⏸️ **API-ORG-LIST-ORGANIZATIONS-001** `@spec`
   API-ORG-LIST-ORGANIZATIONS-001: should returns 200 OK with all organizations and user
   `G/W/T` Line 32
...
⏸️ **API-ORG-LIST-ORGANIZATIONS-004** `@spec`
   API-ORG-LIST-ORGANIZATIONS-004: should returns 200 OK with only User A
   `G/W/T` Line 144
...
⏸️ **API-AUTH-SIGN-IN-SOCIAL-003** `@regression`
...
⏸️ **API-AUTH-VERIFY-EMAIL-006** `@spec`
   API-AUTH-VERIFY-EMAIL-006: should  or 400 (implementation-dependent)
   `G/W/T` Line 196

⏸️ **API-AUTH-VERIFY-EMAIL-007** `@regression`
...
⏸️ **APP-TABLES-FIELD-REQUIRED-005** `@regression`
...
⏸️ **APP-TABLES-FIELD-TYPES-CURRENCY-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-CURRENCY-002** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-CURRENCY-003** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-DATETIME-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-DECIMAL-003** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-GEOLOCATION-004** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-GEOLOCATION-006** `@regression`
...
⏸️ **APP-TABLES-FIELD-TYPES-INTEGER-003** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-INTEGER-004** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-INTEGER-006** `@regression`
...
⏸️ **APP-TABLES-FIELD-TYPES-JSON-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-LONG-TEXT-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-LONG-TEXT-002** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-MULTI-SELECT-006** `@regression`
...
⏸️ **APP-TABLES-FIELD-TYPES-MULTIPLE-ATTACHMENTS-002** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-PERCENTAGE-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-PERCENTAGE-002** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-PERCENTAGE-003** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-PERCENTAGE-004** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-PERCENTAGE-006** `@regression`
...
⏸️ **APP-TABLES-FIELD-PHONE-NUMBER-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-PHONE-NUMBER-002** `@spec`
...
⏸️ **APP-TABLES-FIELD-PHONE-NUMBER-003** `@spec`
...
⏸️ **APP-TABLES-FIELD-PHONE-NUMBER-006** `@regression`
...
⏸️ **APP-TABLES-FIELD-TYPES-RATING-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-TIME-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-TYPES-UPDATED-AT-001** `@spec`
...
⏸️ **APP-TABLES-FIELD-URL-001** `@spec`
...
⏸️ **APP-TABLES-FIELDS-003** `@regression`
...
⏸️ **APP-TABLES-INDEXES-009** `@regression`
...
⏸️ **APP-TABLES-NAME-003** `@regression`
...
⏸️ **APP-TABLES-PRIMARYKEY-009** `@regression`
...
⏸️ **MIGRATION-MODIFY-UNIQUE-004** `@regression`
   MIGRATION-MODIFY-UNIQUE-004: user can complete full modify-field-unique workflow
   `G/W/T` Line 168
