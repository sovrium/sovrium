...
> Generated: 2025-12-16T17:05:13.630Z
>
...
- **NON_SEQUENTIAL_IDS** in `api/tables/get.spec.ts`
  Spec IDs are not sequential (gap between API-TABLES-LIST-003 and API-TABLES-LIST-005)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/get.spec.ts`
  Spec IDs are not sequential (gap between API-TABLES-GET-003 and API-TABLES-GET-005)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/batch/post.spec.ts`
  Spec IDs are not sequential (gap between API-TABLES-RECORDS-BATCH-POST-015 and API-TABLES-RECORDS-BATCH-POST-017)
...
⏸️ **API-ACTIVITY-LIST-018** `@regression`
...
⏸️ **API-TABLES-RECORDS-BATCH-POST-017** `@spec`
...
⏸️ **API-TABLES-RECORDS-DELETE-016** `@regression`
...
#### 🚧 users > {userId} > activity > get

📁 `api/users/{userId}/activity/get.spec.ts`
