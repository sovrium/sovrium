...
> Generated: 2025-12-01T22:27:01.142Z
>
...
- **MISSING_REGRESSION** in `app/email/config.spec.ts`
  File has @spec tests but no @regression test for consolidated workflow
- **MISSING_REGRESSION** in `app/email/connection.spec.ts`
  File has @spec tests but no @regression test for consolidated workflow
...
📁 `app/email/config.spec.ts`

**Email Configuration - Schema Properties**
...
⏸️ **APP-EMAIL-001** `@spec`
APP-EMAIL-001: should accept valid email config with required fields only
`G/W/T` Line 27

⏸️ **APP-EMAIL-002** `@spec`
APP-EMAIL-002: should accept email config with fromName
`G/W/T` Line 49

⏸️ **APP-EMAIL-003** `@spec`
APP-EMAIL-003: should accept email config with replyTo
`G/W/T` Line 72

⏸️ **APP-EMAIL-004** `@spec`
APP-EMAIL-004: should accept email config with secure flag
`G/W/T` Line 95

⏸️ **APP-EMAIL-005** `@spec`
APP-EMAIL-005: should accept email config with preview mode
`G/W/T` Line 118

⏸️ **APP-EMAIL-006** `@spec`
APP-EMAIL-006: should validate port range (1-65535)
`G/W/T` Line 141

⏸️ **APP-EMAIL-007** `@spec`
APP-EMAIL-007: should validate from email format
`G/W/T` Line 194

⏸️ **APP-EMAIL-008** `@spec`
APP-EMAIL-008: should accept environment variable references for credentials
`G/W/T` Line 247

⏸️ **APP-EMAIL-009** `@spec`
APP-EMAIL-009: should accept email config with templates configuration
`G/W/T` Line 272
...
📁 `app/email/connection.spec.ts`

**Email Configuration - SMTP Connection**
...
⏸️ **APP-EMAIL-CONN-001** `@spec`
APP-EMAIL-CONN-001: should connect to Mailpit SMTP server
`G/W/T` Line 31

⏸️ **APP-EMAIL-CONN-002** `@spec`
APP-EMAIL-CONN-002: should send email and receive in Mailpit
`G/W/T` Line 51

⏸️ **APP-EMAIL-CONN-003** `@spec`
APP-EMAIL-CONN-003: should preserve from address in sent email
`G/W/T` Line 88

⏸️ **APP-EMAIL-CONN-004** `@spec`
APP-EMAIL-CONN-004: should preserve fromName as sender display name
`G/W/T` Line 122

⏸️ **APP-EMAIL-CONN-005** `@spec`
APP-EMAIL-CONN-005: should preserve replyTo header
`G/W/T` Line 158

⏸️ **APP-EMAIL-CONN-006** `@spec`
APP-EMAIL-CONN-006: should handle preview mode (no actual sending)
`G/W/T` Line 194
...
⏸️ **APP-EMAIL-016** `@regression`
APP-EMAIL-016: user can configure and use email system with complete workflow
`G/W/T` Line 32
