...
> Generated: 2025-12-13T00:13:35.573Z
>
...
| Spec ID                                   | Date       | Commit    |
| ----------------------------------------- | ---------- | --------- |
| `APP-TABLES-FIELD-TYPES-ROLLUP-012`       | 2025-12-12 | `a9ed82a` |
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/get.spec.ts`
  Spec IDs are not sequential (gap between API-TABLES-RECORDS-LIST-026 and API-TABLES-RECORDS-LIST-028)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/delete.spec.ts`
  Spec IDs are not sequential (gap between API-TABLES-RECORDS-DELETE-010 and API-TABLES-RECORDS-DELETE-012)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/currency-field.spec.ts`
  Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-CURRENCY-005 and APP-TABLES-FIELD-TYPES-CURRENCY-012)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/date-field.spec.ts`
  Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DATE-005 and APP-TABLES-FIELD-TYPES-DATE-011)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/datetime-field.spec.ts`
  Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DATETIME-005 and APP-TABLES-FIELD-TYPES-DATETIME-010)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/duration-field.spec.ts`
  Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-DURATION-005 and APP-TABLES-FIELD-TYPES-DURATION-010)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/multiple-attachments-field.spec.ts`
  Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-MULTIPLE-ATTACHMENTS-005 and APP-TABLES-FIELD-TYPES-MULTIPLE-ATTACHMENTS-008)
- **NON_SEQUENTIAL_IDS** in `app/tables/field-types/single-attachment-field.spec.ts`
  Spec IDs are not sequential (gap between APP-TABLES-FIELD-TYPES-SINGLE-ATTACHMENT-005 and APP-TABLES-FIELD-TYPES-SINGLE-ATTACHMENT-009)
