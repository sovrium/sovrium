...
> Generated: 2025-11-26T18:15:53.186Z
>
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/ban-user/post.spec.ts`
  Spec IDs are not sequential (gap between API-ADMIN-BAN-USER-SUCCESS-001 and API-ADMIN-BAN-USER-SUCCESS-WITH-REASON-001)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/create-user/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/get-user/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/impersonate-user/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/list-user-sessions/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/list-users/get.spec.ts`
  Spec IDs are not sequential (gap between API-ADMIN-LIST-USERS-SUCCESS-001 and API-ADMIN-LIST-USERS-SUCCESS-PAGINATION-001)
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/revoke-user-session/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/set-role/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/set-user-password/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/admin/unban-user/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/change-email/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/change-password/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/get-session/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/list-sessions/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/accept-invitation/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/add-member/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/cancel-invitation/delete.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/create-organization/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/delete-organization/delete.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/get-organization/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/invite-member/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/list-invitations/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/list-members/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/list-organizations/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/reject-invitation/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/remove-member/delete.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/set-active-organization/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/update-member-role/patch.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/organization/update-organization/patch.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/refresh-session/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/request-password-reset/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/reset-password/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/revoke-other-sessions/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/revoke-session/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/send-verification-email/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/sign-in/email/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/sign-out/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/sign-up/email/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/update-user/patch.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/auth/verify-email/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/batch/delete.spec.ts`
  Spec IDs are not sequential (gap between API-RECORDS-BATCH-011 and API-RECORDS-BATCH-DELETE-PERMISSIONS-UNAUTHORIZED-001)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/batch/patch.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/post.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/upsert/post.spec.ts`
  Spec IDs are not sequential (gap between API-RECORDS-UPSERT-003 and API-RECORDS-UPSERT-PERMISSIONS-UNAUTHORIZED-001)
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/delete.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/get.spec.ts`
...
- **NON_SEQUENTIAL_IDS** in `api/tables/{tableId}/records/{recordId}/patch.spec.ts`
...
✅ **STATIC-I18N-REGRESSION-001** `@regression`
