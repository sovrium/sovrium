...
> Generated: 2025-12-02T02:17:43.301Z
>
...
📁 `api/auth/api-keys/delete.spec.ts`
...
📁 `api/auth/api-keys/post.spec.ts`
...
📁 `api/auth/bearer/authenticate.spec.ts`
...
#### 🚧 auth > passkey > authenticate > post

📁 `api/auth/passkey/authenticate/post.spec.ts`
...
📁 `api/auth/passkey/register/post.spec.ts`
...
⏸️ **API-AUTH-REVOKE-OTHER-SESSIONS-006** `@regression`
