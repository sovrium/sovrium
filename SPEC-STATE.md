...
> Generated: 2025-12-16T16:14:39.524Z
>
...
#### 🚧 activity > details > get

📁 `api/activity/details/get.spec.ts`
...
⏸️ **API-ACTIVITY-DETAILS-008** `@regression`
API-ACTIVITY-DETAILS-008: user can retrieve specific activity with full metadata
`~G~/~W~/~T~` Line 274
...
⏸️ **API-ACTIVITY-LIST-016** `@regression`
API-ACTIVITY-LIST-016: user can retrieve and filter activity logs
`~G~/~W~/~T~` Line 601

</details>

#### 🚧 activity > record-history > get

📁 `api/activity/record-history/get.spec.ts`
...
⏸️ **API-ACTIVITY-RECORD-HISTORY-011** `@regression`
API-ACTIVITY-RECORD-HISTORY-011: user can view complete change history for a record
`~G~/~W~/~T~` Line 436

</details>

#### 🚧 activity > user-activity > get

📁 `api/activity/user-activity/get.spec.ts`
