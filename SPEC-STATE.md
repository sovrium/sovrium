...
> Generated: 2025-12-07T20:49:26.306Z
>
...
| Spec ID                              | Date       | Commit    |
| ------------------------------------ | ---------- | --------- |
| `APP-TABLES-FIELD-TYPES-FORMULA-076` | 2025-12-07 | `fc3bbbf` |
| `APP-TABLES-FIELD-TYPES-FORMULA-075` | 2025-12-07 | `d6ddc8a` |
...
- **MISSING_THEN** in `app/tables/field-types/formula-field.spec.ts:2896`
  Test missing THEN comment (assertion)
- **TODO_IN_TEST** in `app/tables/field-types/formula-field.spec.ts:2927`
  TODO: Deferred - requires lookup fields for array values
- **TODO_IN_TEST** in `app/tables/field-types/formula-field.spec.ts:2992`
